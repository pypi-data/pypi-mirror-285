...
class PostScriptDeviceSettingData(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, PostScriptDeviceSettingData, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, PostScriptDeviceSettingData, name)
    __repr__ = _swig_repr
    e_Portrait = _fsdk.PostScriptDeviceSettingData_e_Portrait
    e_Landscape = _fsdk.PostScriptDeviceSettingData_e_Landscape

    def __init__(self, *args):
        this = _fsdk.new_PostScriptDeviceSettingData(*args)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    ...
    def Set(self, *args):
        return _fsdk.PostScriptDeviceSettingData_Set(self, *args)
    __swig_setmethods__["device_width"] = _fsdk.PostScriptDeviceSettingData_device_width_set
    __swig_getmethods__["device_width"] = _fsdk.PostScriptDeviceSettingData_device_width_get
    if _newclass:
    ...
    __swig_setmethods__["device_height"] = _fsdk.PostScriptDeviceSettingData_device_height_set
    __swig_getmethods__["device_height"] = _fsdk.PostScriptDeviceSettingData_device_height_get
    if _newclass:
    ...
    __swig_setmethods__["device_margin"] = _fsdk.PostScriptDeviceSettingData_device_margin_set
    __swig_getmethods__["device_margin"] = _fsdk.PostScriptDeviceSettingData_device_margin_get
    if _newclass:
    ...
    __swig_setmethods__["orientation"] = _fsdk.PostScriptDeviceSettingData_orientation_set
    __swig_getmethods__["orientation"] = _fsdk.PostScriptDeviceSettingData_orientation_get
    if _newclass:
    ...
    __swig_setmethods__["resolution"] = _fsdk.PostScriptDeviceSettingData_resolution_set
    __swig_getmethods__["resolution"] = _fsdk.PostScriptDeviceSettingData_resolution_get
    if _newclass:
    ...
    __swig_setmethods__["copies"] = _fsdk.PostScriptDeviceSettingData_copies_set
    __swig_getmethods__["copies"] = _fsdk.PostScriptDeviceSettingData_copies_get
    if _newclass:
        copies = _swig_property(_fsdk.PostScriptDeviceSettingData_copies_get, _fsdk.PostScriptDeviceSettingData_copies_set)
    __swig_destroy__ = _fsdk.delete_PostScriptDeviceSettingData
    __del__ = lambda self: None
PostScriptDeviceSettingData_swigregister = _fsdk.PostScriptDeviceSettingData_swigregister
PostScriptDeviceSettingData_swigregister(PostScriptDeviceSettingData)
