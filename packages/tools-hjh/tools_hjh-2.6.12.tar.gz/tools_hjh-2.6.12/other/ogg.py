...
tables = '''
YCMGR.CS_ORDER_MODIFY_RECORD
PSBCAP.RONGDAN_ADVANCE_TRADE_RECORD
UPMP_DATA.UPMP_BRBY_CUST_SCORE
PSBCAP.EX_HUANBEI_USE_RISK_INFO
PSBCAP.EX_HUANBEI_APPLY_RISK_INFO
PSBCAP.JC_SERVICE_DELEGATE_RECORD
PSBCAP.RONGDAN_ACCOUNTING_RESULT
PSBCAP.RONGDAN_ACCESS_RESULT
PSBCAP.RONGDAN_APPLY_TRADE_RECORD
PSBCAP.LOAN_FACTOR_ADJUSTMENT_INFO
acct_facade.MTYF_CUSTOMER_BAK
acct_facade.MTYF_BANK_LOAN_INIT_BAK
acct_facade.MTYF_BANK_INSTMNT_INIT_BAK
acct_facade.MTYF_BANK_LOAN_CREATE_BAK
acct_facade.MTYF_BANK_PERIOD_CREATE_BAK
acct_facade.MTYF_BANK_REPAY_LOAN_BAK
acct_facade.MTYF_BANK_REPAY_PERIOD_BAK
acct_facade.MTYF_BANK_LOAN_CALC_BAK
acct_facade.MTYF_BANK_EXEMPT_PERIOD_BAK
acct_facade.MTYF_BANK_FUND_FEE_BAK
acct_facade.MTYF_BANK_REPAY_CHANGE_BAK
acct_facade.MTYF_BANK_ACCOUNTING_BAK
acct_facade.MTYF_BANK_RAISE_LIMIT_BAK
acct_facade.MTYF_ACCOUNT_INFO_DAILY
acct_facade.MTYF_LOAN_BASE_INFO_DAILY
acct_facade.MTYF_LOAN_PRIN_INT_BAL_DAILY
acct_facade.MTYF_LOAN_REPAY_SCHED_DAILY
acct_facade.RD360_FUND_RPY_PLAN_BAK
acct_facade.RD360_FUND_LOAN_CHECK_BAK
acct_facade.RD360_REPAY_BAK
acct_facade.RD360_PAYOUT_DETAIL_BAK
acct_facade.RD360_CUST_RPY_PLAN_BAK
acct_facade.RD360_CUST_LOAN_CHECK_BAK
acct_facade.RD360_COMP_REPAY_BAK
acct_facade.RD360_LOAN_BASE_INFO_DAILY
acct_facade.RD360_LOAN_REPAY_SCHED_DAILY
acct_facade.RD360_LOAN_PRIN_INT_BAL_DAILY
acct_facade.RD360_ACCOUNT_INFO_DAILY
'''
