        ...
        while True:
            try:
                ...
                try:
                    ...
                    sleep(1)
                    self.wait.until(EC.any_of(EC.presence_of_element_located((By.CSS_SELECTOR, MAIN_PAGE_HEADER_CSS_SELECTOR)),
                                              EC.presence_of_element_located((By.CSS_SELECTOR, LOGIN_CONTINUE_BUTTON_CSS_SELECTOR))))
                    sleep(1)
                except NoSuchElementException:
                    sleep(1)
                else:
