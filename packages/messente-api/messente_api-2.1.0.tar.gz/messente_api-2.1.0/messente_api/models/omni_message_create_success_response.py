...
class OmniMessageCreateSuccessResponse(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "messages": [MessageResult.from_dict(_item) for _item in obj["messages"]] if obj.get("messages") is not None else None,
            "to": obj.get("to"),
