...
class NumbersToInvestigate(BaseModel):
    """
    A container for phone numbers
    """ # noqa: E501
    numbers: Annotated[List[StrictStr], Field(min_length=1, max_length=10)] = Field(description="A list of phone numbers. Max 10 numbers per request")
