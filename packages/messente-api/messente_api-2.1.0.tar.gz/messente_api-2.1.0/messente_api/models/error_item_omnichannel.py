...
class ErrorItemOmnichannel(BaseModel):
    """
    A container for Omnichannel API error
    """ # noqa: E501
    title: ErrorTitleOmnichannel
    detail: StrictStr = Field(description="Free form more detailed description of the error")
    code: ErrorCodeOmnichannel
    source: Optional[StrictStr] = Field(description="Describes which field is causing the issue in the payload, null for non 400 status code responses")
    __properties: ClassVar[List[str]] = ["title", "detail", "code", "source"]
