...
class GroupResponseFields(BaseModel):
    """
    A container for fields of a group
    """ # noqa: E501
    id: StrictStr = Field(description="Id string in UUID format")
    name: StrictStr = Field(description="The name of the group")
    created_on: Optional[StrictStr] = Field(default=None, description="When the group was created", alias="createdOn")
    contacts_count: StrictInt = Field(description="The count of contacts in the group", alias="contactsCount")
    __properties: ClassVar[List[str]] = ["id", "name", "createdOn", "contactsCount"]
