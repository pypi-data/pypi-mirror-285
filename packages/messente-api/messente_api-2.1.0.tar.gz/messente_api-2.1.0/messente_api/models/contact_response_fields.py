...
class ContactResponseFields(BaseModel):
    """
    A container for response fields of a contact
    """ # noqa: E501
    phone_number: Optional[StrictStr] = Field(default=None, description="Phone number in e.164 format", alias="phoneNumber")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if scheduled_deletion_date (nullable) is None
        # and model_fields_set contains the field
        if self.scheduled_deletion_date is None and "scheduled_deletion_date" in self.model_fields_set:
            _dict['scheduledDeletionDate'] = None
