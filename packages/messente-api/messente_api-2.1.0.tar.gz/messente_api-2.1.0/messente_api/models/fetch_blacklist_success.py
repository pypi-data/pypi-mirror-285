...
class FetchBlacklistSuccess(BaseModel):
    """
    A container for blacklisted numbers
    """ # noqa: E501
    phone_numbers: Optional[List[StrictStr]] = Field(default=None, description="Array of unique phone numbers", alias="phoneNumbers")
