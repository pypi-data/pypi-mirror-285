...
class ErrorNumberLookup(BaseModel):
    """
    A container for errors
    """ # noqa: E501
    errors: List[ErrorItemNumberLookup] = Field(description="An array of errors")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "errors": [ErrorItemNumberLookup.from_dict(_item) for _item in obj["errors"]] if obj.get("errors") is not None else None
        })
        return _obj
