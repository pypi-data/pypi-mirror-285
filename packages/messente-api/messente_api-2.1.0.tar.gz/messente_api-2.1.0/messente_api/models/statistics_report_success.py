...
class StatisticsReportSuccess(BaseModel):
    """
    A container for statistics reports
    """ # noqa: E501
    reports: List[StatisticsReport] = Field(description="Array of report objects")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "reports": [StatisticsReport.from_dict(_item) for _item in obj["reports"]] if obj.get("reports") is not None else None
        })
        return _obj
