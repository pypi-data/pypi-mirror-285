...
def date_str(date_object: Union[str, datetime.datetime, datetime.date]) -> str:
    """
    Convert a date/datetime object to a date string.

    :param Union[str, datetime.datetime, datetime.date] date_object: The date/datetime object to convert.
...
def datetime_str(date_object: Union[str, datetime.datetime, datetime.date]) -> str:
    """
    ...
    if isinstance(date_object, datetime.datetime):
        return date_object.strftime(default_date_format)
    if isinstance(date_object, datetime.date):
        return date_object.strftime(default_date_format)
    return ""


def date_obj(date_str: Union[str, datetime.datetime, datetime.date]) -> Optional[datetime.date]:
    """
    Convert a string to a date object.

    :param Union[str, datetime.datetime, datetime.date] date_str: The string to convert.
...
def datetime_obj(date_str: Union[str, datetime.datetime, datetime.date]) -> Optional[datetime.datetime]:
    """
