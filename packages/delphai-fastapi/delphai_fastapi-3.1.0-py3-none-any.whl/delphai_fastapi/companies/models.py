...
class CompanyCreate(CamelModel):
    ...
    url: Optional[str] = Field(
        default=None, description="Webpage of the company", examples=["delphai.com"]
    )
    founded: Optional[int] = Field(
        None, description="Founding year", examples=[2020], alias="foundingYear"
    )
    headquarters: Optional[Location] = Field(None, description="Company address")
    n_employees: Optional[str] = Field(
        None, description="Number of employees", alias="employeeCount"
    )
    ...
    social_media: Optional[Dict[str, str]] = Field(
        ...
        examples=[
            {
                "linkedin": "https://www.linkedin.com/company/the-calvander-group",
                "facebook": "https://www.facebook.com/the-calvander-group",
            }
        ],
    )
    ...
    source_link: Optional[str] = Field(
        ...
        examples=["https://www.linkedin.com/company/the-calvander-group"],
    )
