...
class JobClassification(CamelModel):
    ...
    delphai_label: str = Field(
        ..., description="Delphai label of the position", examples=["R&D"]
    )
...
class JobPostCreate(JobPostMinimal):
    ...
    company_url: Optional[str] = Field(
        ...
        examples=["delphai.com"],
    )
    country: Optional[str] = Field(
        None, description="Country of the position", examples=["Germany"]
    )
    state: Optional[str] = Field(
        None, description="State of the position", examples=["Bavaria"]
    )
    city: Optional[str] = Field(
        None, description="City of the position", examples=["Munich"]
    )
