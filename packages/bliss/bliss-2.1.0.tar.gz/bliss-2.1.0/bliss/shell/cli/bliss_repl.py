...
class BlissRepl(NoThreadPythonRepl):
    ...
    def __init__(
        self,
        get_globals: typing.Callable[[], dict[str, typing.Any]] | None = None,
        get_locals: typing.Callable[[], dict[str, typing.Any]] | None = None,
        style: str | None = None,
    ...
    def initialize_session(self, early_log_info=None):
        ...
        print("")
        print(f"Welcome to BLISS {version} running on {hostname} {conda_env}")
