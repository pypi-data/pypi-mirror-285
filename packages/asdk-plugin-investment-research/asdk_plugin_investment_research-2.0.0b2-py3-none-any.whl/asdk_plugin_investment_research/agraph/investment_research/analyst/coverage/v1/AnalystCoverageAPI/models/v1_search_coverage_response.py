...
class V1SearchCoverageResponse(BaseModel):
    """
    V1SearchCoverageResponse
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1SearchCoverageResponse:
        """Create an instance of V1SearchCoverageResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1SearchCoverageResponse:
        """Create an instance of V1SearchCoverageResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1SearchCoverageResponse.parse_obj(obj)

        _obj = V1SearchCoverageResponse.parse_obj({
