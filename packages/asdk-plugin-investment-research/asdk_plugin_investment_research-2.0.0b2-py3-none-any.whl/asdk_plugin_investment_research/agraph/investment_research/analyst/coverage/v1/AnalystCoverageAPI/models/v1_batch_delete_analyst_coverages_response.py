...
class V1BatchDeleteAnalystCoveragesResponse(BaseModel):
    """
    The response message for AnalystCoverageAPI.BatchDeleteAnalystCoverage.
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1BatchDeleteAnalystCoveragesResponse:
        """Create an instance of V1BatchDeleteAnalystCoveragesResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1BatchDeleteAnalystCoveragesResponse:
        """Create an instance of V1BatchDeleteAnalystCoveragesResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1BatchDeleteAnalystCoveragesResponse.parse_obj(obj)

        _obj = V1BatchDeleteAnalystCoveragesResponse.parse_obj({
