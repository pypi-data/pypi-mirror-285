...
class V1TransferAnalystCoverageRequest(BaseModel):
    """
    The request message for AnalystCoverageAPI.TransferAnalystCoverage.
    """
    ...
    __properties = ["analystCoverage", "analystId", "analystRole"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1TransferAnalystCoverageRequest:
        """Create an instance of V1TransferAnalystCoverageRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1TransferAnalystCoverageRequest:
        """Create an instance of V1TransferAnalystCoverageRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1TransferAnalystCoverageRequest.parse_obj(obj)

        _obj = V1TransferAnalystCoverageRequest.parse_obj({
