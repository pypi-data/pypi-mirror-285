...
class V1BatchCreateAnalystCoveragesResponse(BaseModel):
    """
    The response message for AnalystCoverageAPI.BatchCreateAnalystCoverage.
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1BatchCreateAnalystCoveragesResponse:
        """Create an instance of V1BatchCreateAnalystCoveragesResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1BatchCreateAnalystCoveragesResponse:
        """Create an instance of V1BatchCreateAnalystCoveragesResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1BatchCreateAnalystCoveragesResponse.parse_obj(obj)

        _obj = V1BatchCreateAnalystCoveragesResponse.parse_obj({
