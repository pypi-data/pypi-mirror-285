...
class V1BatchDeleteAnalystCoveragesRequest(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1BatchDeleteAnalystCoveragesRequest:
        """Create an instance of V1BatchDeleteAnalystCoveragesRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1BatchDeleteAnalystCoveragesRequest:
        """Create an instance of V1BatchDeleteAnalystCoveragesRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1BatchDeleteAnalystCoveragesRequest.parse_obj(obj)

        _obj = V1BatchDeleteAnalystCoveragesRequest.parse_obj({
