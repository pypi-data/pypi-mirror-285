...
def runfit():
	...
	parser.add_argument('filenames', type=str, nargs='+', help='Filenames to pass to SPFIT')
...
def runpredictions():
	...
	parser.add_argument('filenames', type=str, nargs='+', help='Filenames to pass to SPCAT')
	args = parser.parse_args()
