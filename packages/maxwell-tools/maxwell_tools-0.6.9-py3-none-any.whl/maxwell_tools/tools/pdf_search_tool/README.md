...
## Installation
To get started with the PDFSearchTool, first, ensure the maxwell_tools package is installed with the following command:
...
```python
from maxwell_tools import PDFSearchTool
