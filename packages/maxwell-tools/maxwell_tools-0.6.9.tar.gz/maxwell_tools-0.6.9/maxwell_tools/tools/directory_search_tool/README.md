...
## Installation
To start using the DirectorySearchTool, you need to install the maxwell_tools package. Execute the following command in your terminal:
...
```python
from maxwell_tools import DirectorySearchTool
