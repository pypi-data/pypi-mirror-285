...
## Installation
To utilize the YoutubeChannelSearchTool, the `maxwell_tools` package must be installed. Execute the following command in your shell to install:
...
```python
from maxwell_tools import YoutubeChannelSearchTool
