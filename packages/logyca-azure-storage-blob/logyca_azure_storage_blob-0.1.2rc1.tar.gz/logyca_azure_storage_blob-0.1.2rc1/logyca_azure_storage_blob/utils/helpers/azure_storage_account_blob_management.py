...
class AzureStorageAccountBlobManagement:
    ...
    def container_blob_list(self,container_name:str,container_folders:list[str]=[],modified_hours_ago:int=None)->list[BlobProperties]:
        '''Description
        Lists the files in a container and its subfolders, returning their properties.
        :param container_name:str       : Name of container.
        :param modified_hours_ago:int   : If it is not null but a number, files modified more than x hours ago will be returned..
        ...
        try:            
            ...
            if modified_hours_ago is None:
                ...
                for blob in blob_list:
                    ...
                    if time_diff > timedelta(hours=modified_hours_ago):
