...
apk_path = os.path.join(ex_asset_path, "another-notes-app.apk")
cl_path = os.path.join(ex_asset_path, "NOTES_CreateLabel.java")
sls_path = os.path.join(ex_asset_path, "NOTES_SetLeftSwipeToDelete.java")
