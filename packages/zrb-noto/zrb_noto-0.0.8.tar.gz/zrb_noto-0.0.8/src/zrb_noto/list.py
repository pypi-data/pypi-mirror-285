...
from ._config import IS_AUTO_SYNC, CURRENT_TIME, TODO_ABS_FILE_PATH
from ._group import noto_group
from .log._helper import get_pretty_log_lines, get_log_file_name
...
def list_noto(*args: Any, **kwargs: Any):
    ...
    show_lines(
        task,
        *get_pretty_log_lines(file_name),
        "",
