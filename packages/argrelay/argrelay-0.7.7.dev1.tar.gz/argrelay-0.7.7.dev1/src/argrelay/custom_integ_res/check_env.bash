...
########################################################################################################################
# Report server URL:
server_host_name="$( jq --raw-output ".redundant_connections[0].server_host_name" "${argrelay_dir}/conf/argrelay_client.json" )"
server_port_number="$( jq --raw-output ".redundant_connections[0].server_port_number" "${argrelay_dir}/conf/argrelay_client.json" )"
echo -e "${success_color}INFO:${reset_style} ${field_color}server_url[0]:${reset_style} http://${server_host_name}:${server_port_number}"
