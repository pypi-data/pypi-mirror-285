...
def client_config_dict_to_object(client_config_dict):
    ...
    for redundant_connection in client_config_dict["redundant_connections"]:
        redundant_connections.append(ConnectionConfig(
            server_host_name = redundant_connection["server_host_name"],
            server_port_number = redundant_connection["server_port_number"],
        ))
