...
class DetectionInstanceMetadataApiStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ListAllDetectionInstanceMetadata = channel.unary_unary(
                '/DetectionInstanceMetadataApi/ListAllDetectionInstanceMetadata',
                request_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
                response_deserializer=global__vo__grpc__service_dot_protos_dot_detection__instance__metadata__api__pb2.ListAllDetectionInstanceMetadataResponse.FromString,
                )
...
class DetectionInstanceMetadataApiServicer(object):
    ...
    def ListAllDetectionInstanceMetadata(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_DetectionInstanceMetadataApiServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'ListAllDetectionInstanceMetadata': grpc.unary_unary_rpc_method_handler(
                    servicer.ListAllDetectionInstanceMetadata,
                    request_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString,
                    response_serializer=global__vo__grpc__service_dot_protos_dot_detection__instance__metadata__api__pb2.ListAllDetectionInstanceMetadataResponse.SerializeToString,
            ),
...
class DetectionInstanceMetadataApi(object):
    ...
    @staticmethod
    def ListAllDetectionInstanceMetadata(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/DetectionInstanceMetadataApi/ListAllDetectionInstanceMetadata',
            google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
            global__vo__grpc__service_dot_protos_dot_detection__instance__metadata__api__pb2.ListAllDetectionInstanceMetadataResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
