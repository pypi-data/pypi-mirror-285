...
class UserRunner(
    ...
    def __init__(
        ...
        *,
        ...
        :param runner_type: The scope of the runner. Valid values are: ``instance_type``, ``group_type``, ``project_type``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.2.0/docs/resources/user_runner#runner_type UserRunner#runner_type}
        :param access_level: The access level of the runner. Valid values are: ``not_protected``, ``ref_protected``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.2.0/docs/resources/user_runner#access_level UserRunner#access_level}
        :param description: Description of the runner. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.2.0/docs/resources/user_runner#description UserRunner#description}
        :param group_id: The ID of the group that the runner is created in. Required if runner_type is group_type. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.2.0/docs/resources/user_runner#group_id UserRunner#group_id}
        :param locked: Specifies if the runner should be locked for the current project. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.2.0/docs/resources/user_runner#locked UserRunner#locked}
        :param maximum_timeout: Maximum timeout that limits the amount of time (in seconds) that runners can run jobs. Must be at least 600 (10 minutes). Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.2.0/docs/resources/user_runner#maximum_timeout UserRunner#maximum_timeout}
        :param paused: Specifies if the runner should ignore new jobs. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.2.0/docs/resources/user_runner#paused UserRunner#paused}
        :param project_id: The ID of the project that the runner is created in. Required if runner_type is project_type. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.2.0/docs/resources/user_runner#project_id UserRunner#project_id}
        :param tag_list: A list of runner tags. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.2.0/docs/resources/user_runner#tag_list UserRunner#tag_list}
        :param untagged: Specifies if the runner should handle untagged jobs. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.2.0/docs/resources/user_runner#untagged UserRunner#untagged}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing UserRunner that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.2.0/docs/resources/user_runner#import import section} in the documentation of this resource for the id to use
