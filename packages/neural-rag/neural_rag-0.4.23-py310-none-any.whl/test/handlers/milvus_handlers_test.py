...
from nn_rag.handlers.milvus_handlers import MilvusSourceHandler, MilvusPersistHandler
...
class MilvusTest(unittest.TestCase):
    ...
    def test_for_smoke(self):
        ...
        kn.set_persist_uri("milvus://localhost:19530/rai?collection=demo&reference=call_center")
