...
class AmazonAdsAPIConnector:
    ...
    def list_campaigns(
        ...
        Args:
            ...
            name_contains (list | str, optional): The strings the campaign names should contain. Defaults to [""].

        Returns:
            list: The list of campaigns.
        """
        name_contains = (
            [name_contains] if isinstance(name_contains, str) else name_contains
        )
    ...
    def create_campaigns(
        ...
        Args:
            campaigns (list | dict): The campaigns to be created.
        ...
        Returns:
            dict: The response from the API.
        """
        campaigns = [campaigns] if isinstance(campaigns, dict) else campaigns
    ...
    def update_campaigns(
        ...
        Args:
            campaigns (list | dict): The campaigns to be updated.
            For more information on the structure of the campaigns, see
    ...
    def delete_campaigns(
        ...
        Args:
            campaign_ids (list | dict): The ids of the campaigns to be deleted.
    ...
    def list_ad_groups(
        ...
        Args:
            campaign_ids (list | str, optional): The ids of the campaigns the ad groups belong to. Defaults to [].
            states (list, optional): The states of the ad groups to be listed. Defaults to ["ENABLED", "PAUSED", "ARCHIVED"].
            include_extended_data_fields (bool, optional): Whether to include extended data fields. Defaults to False.
            name_contains (list | str, optional): The strings the ad group names should contain. Defaults to [""].
    ...
    def create_ad_groups(
        ...
        Args:
            ad_groups (list | dict): The ad groups to be created.
        ...
        Returns:
            dict: The response from the API.
        """
        ad_groups = [ad_groups] if isinstance(ad_groups, dict) else ad_groups
    ...
    def update_ad_groups(
        ...
        Args:
            ad_groups (list | dict): The ad groups to be updated.
            For more information on the structure of the ad groups, see
    ...
    def delete_ad_groups(
        ...
        Args:
            ad_group_ids (list | str): The ids of the ad groups to be deleted.

        Returns:
            dict: The response from the API.
        """
        ad_group_ids = [ad_group_ids] if isinstance(ad_group_ids, str) else ad_group_ids
    ...
    def list_product_ads(
        ...
        Args:
            campaign_ids (list | str, optional): The ids of the campaigns the product ads belong to. Defaults to [].
            ad_group_ids (list | str, optional): The ids of the ad groups the product ads belong to. Defaults to [].
    ...
    def create_product_ads(
        self,
        product_ads: list | dict,
    ) -> dict:
        """
        Method to create product ads.

        Args:
            product_ads (list | dict): The product ads to be created.
        ...
        Returns:
            dict: The response from the API.
        """
        product_ads = [product_ads] if isinstance(product_ads, dict) else product_ads
    ...
    def update_product_ads(
        ...
        Args:
            product_ads (list | dict): The product ads to be updated.
            For more information on the structure of the product ads, see
    ...
    def delete_product_ads(
        ...
        Args:
            product_ad_ids (list | dict): The ids of the product ads to be deleted.

        Returns:
            dict: The response from the API.
        """
        product_ad_ids = (
            [product_ad_ids] if isinstance(product_ad_ids, str) else product_ad_ids
        )
    ...
    def list_keywords(
        ...
        Args:
            campaign_ids (list | str, optional): The ids of the campaigns the keywords belong to. Defaults to [].
            ad_group_ids (list | str, optional): The ids of the ad groups the keywords belong to. Defaults to [].
    ...
    def create_keywords(
        ...
        Args:
            keywords (list | dict): The keywords to be created.
        ...
        Returns:
            dict: The response from the API.
        """
        keywords = [keywords] if isinstance(keywords, dict) else keywords
    ...
    def update_keywords(
        ...
        Args:
            keywords (list | dict): The keywords to be updated.
            For more information on the structure of the keywords, see
    ...
    def delete_keywords(
        ...
        Args:
            keyword_ids (list | dict): The ids of the keywords to be deleted.

        Returns:
            dict: The response from the API.
        """
        keyword_ids = [keyword_ids] if isinstance(keyword_ids, str) else keyword_ids
    ...
    def list_negative_keywords(
        ...
        Args:
            campaign_ids (list | str, optional): The ids of the campaigns the negative keywords belong to. Defaults to [].
            ad_group_ids (list | str, optional): The ids of the ad groups the negative keywords belong to. Defaults to [].
    ...
    def create_negative_keywords(
        ...
        Args:
            negative_keywords (list | dict): The negative keywords to be created.
    ...
    def update_negative_keywords(
        ...
        Args:
            negative_keywords (list | dict): The negative keywords to be updated.
            For more information on the structure of the negative keywords, see
    ...
    def delete_negative_keywords(
        self,
        negative_keyword_ids: list | str,
    ) -> dict:
        """
        Method to delete negative keywords.

        Args:
            negative_keyword_ids (list | dict): The ids of the negative keywords to be deleted.
        ...
        negative_keyword_ids = (
            [negative_keyword_ids]
            if isinstance(negative_keyword_ids, str)
            else negative_keyword_ids
        )
    ...
    def list_targeting_clauses(
        ...
        Args:
            campaign_ids (list | str, optional): The ids of the campaigns the targeting clauses belong to. Defaults to [].
            ad_group_ids (list | str, optional): The ids of the ad groups the targeting clauses belong to. Defaults to [].
    ...
    def create_targeting_clauses(
        self,
        targeting_clauses: list | dict,
    ) -> dict:
        """
        Method to create targeting clauses.

        Args:
            targeting_clauses (list | dict): The targeting clauses to be created.
        ...
        targeting_clauses = (
            [targeting_clauses]
            if isinstance(targeting_clauses, dict)
            else targeting_clauses
        )
    ...
    def update_targeting_clauses(
        ...
        Args:
            targeting_clauses (list | dict): The targeting clauses to be updated.
            For more information on the structure of the targeting clauses, see
    ...
    def delete_targeting_clauses(
        self,
        targeting_clause_ids: list | str,
    ) -> dict:
        """
        Method to delete targeting clauses.

        Args:
            targeting_clause_ids (list | dict): The ids of the targeting clauses to be deleted.

        Returns:
            dict: The response from the API.
        """
        targeting_clause_ids = (
            [targeting_clause_ids]
            if isinstance(targeting_clause_ids, str)
            else targeting_clause_ids
        )
