...
@click.option('--name', prompt='Your name', help='The name of the feedback submitter.')
@click.option('--email', prompt='Your email', help='The email of the feedback submitter.')
@click.option('--feedback', prompt='Your feedback', help='The feedback to submit.')
