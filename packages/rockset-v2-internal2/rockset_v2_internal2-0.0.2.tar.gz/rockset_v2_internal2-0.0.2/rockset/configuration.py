...
class Configuration(object):
    ...
    def __init__(self, host: str=None,
        ...
        """Constructor
        """
        self._base_path = "https://staging-api.rockset-0s.internal.api.openai.org" if host is None else host
        """Default Base url
        """
    ...
    def get_host_settings(self):
        ...
        return [
            {
                'url': "https://staging-api.rockset-0s.internal.api.openai.org",
