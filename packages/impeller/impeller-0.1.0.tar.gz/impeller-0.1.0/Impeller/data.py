...
def load_and_process_example_data():
    
    spatial_graph_radius_cutoff = 150
    gene_graph_knn_cutoff = 5
    gene_graph_pca_num = 50

    adata = sc.read_h5ad("./example_data/filtered_adata.h5ad")
    # with open("./example_data/ground_truth_layer.pkl", 'rb') as file:
    #     ground_truth_layer = pickle.load(file)
    val_mask = np.load("./example_data/split_0_val_mask.npz")['arr_0']
    test_mask = np.load("./example_data/split_0_test_mask.npz")['arr_0']
