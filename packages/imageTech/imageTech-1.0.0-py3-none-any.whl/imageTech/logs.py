...
from imageTech.utils import LOGLEVEL
...
class LoggerConfig(logging.Logger):
    ...
    """
    def __init__(self, app_name, streams=('console',), file_name='ImageProcessor.log'):
        """
        Initialize LoggerConfig with given parameters.

        Args:
            app_name (str): Name of the application.
            streams (tuple, optional): List of streams to log to. Options are ('file', ) or ('console', 'file')
            Default is ('console', ).
            file_name (str, optional): Name of the log file, default is 'ImageProcessor.log'.
        """
...
#     logger_config = LoggerConfig('ImageProcessor')
