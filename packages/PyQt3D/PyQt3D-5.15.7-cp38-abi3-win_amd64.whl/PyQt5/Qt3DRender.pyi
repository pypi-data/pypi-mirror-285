...
class QAttribute(Qt3DCore.QNode):
    ...
    def __init__(self, parent: typing.Optional[Qt3DCore.QNode] = ...) -> None: ...
    @typing.overload
    def __init__(self, buf: typing.Optional['QBuffer'], vertexBaseType: 'QAttribute.VertexBaseType', vertexSize: int, count: int, offset: int = ..., stride: int = ..., parent: typing.Optional[Qt3DCore.QNode] = ...) -> None: ...
    @typing.overload
    def __init__(self, buf: typing.Optional['QBuffer'], name: typing.Optional[str], vertexBaseType: 'QAttribute.VertexBaseType', vertexSize: int, count: int, offset: int = ..., stride: int = ..., parent: typing.Optional[Qt3DCore.QNode] = ...) -> None: ...
...
class QGeometryFactory('QAbstractFunctor'):
    ...
    def __eq__(self, other: object): ...
    def __call__(self) -> typing.Optional['QGeometry']: ...
...
class QRenderCaptureReply(QtCore.QObject):
    ...
    def saveToFile(self, fileName: typing.Optional[str]) -> None: ...
