...
class QConeGeometry(Qt3DRender.QGeometry):
    ...
    def indexAttribute(self) -> typing.Optional[Qt3DRender.QAttribute]: ...
    def texCoordAttribute(self) -> typing.Optional[Qt3DRender.QAttribute]: ...
    def normalAttribute(self) -> typing.Optional[Qt3DRender.QAttribute]: ...
    def positionAttribute(self) -> typing.Optional[Qt3DRender.QAttribute]: ...
...
class QCuboidGeometry(Qt3DRender.QGeometry):
    ...
    def indexAttribute(self) -> typing.Optional[Qt3DRender.QAttribute]: ...
    def tangentAttribute(self) -> typing.Optional[Qt3DRender.QAttribute]: ...
    def texCoordAttribute(self) -> typing.Optional[Qt3DRender.QAttribute]: ...
    def normalAttribute(self) -> typing.Optional[Qt3DRender.QAttribute]: ...
    def positionAttribute(self) -> typing.Optional[Qt3DRender.QAttribute]: ...
