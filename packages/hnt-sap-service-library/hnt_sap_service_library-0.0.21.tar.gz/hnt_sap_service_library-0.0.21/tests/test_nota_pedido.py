...
def test_create_pedido_1532():
    with open("./devdata/json/nota_pedido_GHN-1532.json", "r", encoding="utf-8") as nota_pedido_arquivo_json: nota_pedido = json.load(nota_pedido_arquivo_json)
    with open("./devdata/json/miro_GHN-1532.json", "r", encoding="utf-8") as miro_arquivo_json: miro = json.load(miro_arquivo_json)
