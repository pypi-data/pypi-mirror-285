...
from ..data.ls_dyna import DEForc, Elout, EloutObject, Glstat, Matsum, Nodout, RCForc, SBTout, SlipringOut, Secforc, \
                           Disbout, PartDisbout, Abstat, AbstatCPM, JointForc, Sleout, RigidBody, BoundaryCondition, \
                           JointType, RetractorOut
...
class DataContainer:
    ...
    def get_data(name):
        ...
        elif name == ObjectConstantsForData.ELEMENTOBJECT:
        ...
        elif name == ObjectConstantsForData.RETRACTOR:
            return DataContainer._retractorout
    ...
    def init_all_data_sources(binout, logger, dynasaur_def, volume_path):
        ...
        DataContainer._retractorout = RetractorOut(binout, logger, dynasaur_def)
