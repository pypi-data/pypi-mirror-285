...
class NrlMsise00Atmosphere(AtmosphereModel):
    ...
    """ # noqa: E501
    solar_activity_type: Optional[StrictStr] = Field(default=None, description="Can be from CSSI space weather data or MSAFE predictions (weak, average or strong)", alias="solarActivityType")
