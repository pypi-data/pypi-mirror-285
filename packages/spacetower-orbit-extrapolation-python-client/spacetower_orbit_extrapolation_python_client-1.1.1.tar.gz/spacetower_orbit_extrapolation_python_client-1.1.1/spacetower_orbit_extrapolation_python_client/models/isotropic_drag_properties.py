...
class IsotropicDragProperties(DragProperties):
    """
    Drag properties independent of the direction with drag and lift coefficient
    """ # noqa: E501
    ...
    lift_coefficient: Optional[Union[StrictFloat, StrictInt]] = Field(default=0.0, description="Dimensionless coefficient. Units [-]", alias="liftCoefficient")
    drag_cross_section: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Units [m^2]", alias="dragCrossSection")
    __properties: ClassVar[List[str]] = ["dragPropertyType", "dragCoefficient", "liftCoefficient", "dragCrossSection"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IsotropicDragProperties from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IsotropicDragProperties from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "liftCoefficient": obj.get("liftCoefficient") if obj.get("liftCoefficient") is not None else 0.0,
