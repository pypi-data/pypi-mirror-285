...
class NumericalExtrapolationResult(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["attitudeEphemeris", "batteryPowerEphemeris", "thrustVectorEphemeris", "massEphemeris", "osculatingOrbitEphemeris", "meanOrbitEphemeris", "geodeticEphemeris", "positionVelocityEphemeris", "cartesianCovarianceEphemeris", "orbitalEventLogs", "stationEventLogs", "fieldOfViewEventLogs"]
