...
class EphemerisGenerationRequest(BaseModel):
    ...
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {
        'ATTITUDE': 'AttitudeEphemerisRequest','BATTERY_POWER': 'BatteryPowerEphemerisRequest','GEODETIC': 'GeodeticEphemerisRequest','MASS': 'MassEphemerisRequest','MEAN_ORBIT': 'MeanOrbitEphemerisRequest','ORBIT_COVARIANCE': 'OrbitCovarianceRequest','OSCULATING_ORBIT': 'OsculatingOrbitEphemerisRequest','POSITION_VELOCITY': 'PositionVelocityEphemerisRequest','POSITION_VELOCITY_COVARIANCE': 'PositionVelocityCovarianceEphemerisRequest','THRUST_VECTOR': 'ThrustVectorEphemerisRequest'
    }
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[Union[AttitudeEphemerisRequest, BatteryPowerEphemerisRequest, GeodeticEphemerisRequest, MassEphemerisRequest, MeanOrbitEphemerisRequest, OrbitCovarianceRequest, OsculatingOrbitEphemerisRequest, PositionVelocityEphemerisRequest, PositionVelocityCovarianceEphemerisRequest, ThrustVectorEphemerisRequest]]:
    ...
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[AttitudeEphemerisRequest, BatteryPowerEphemerisRequest, GeodeticEphemerisRequest, MassEphemerisRequest, MeanOrbitEphemerisRequest, OrbitCovarianceRequest, OsculatingOrbitEphemerisRequest, PositionVelocityEphemerisRequest, PositionVelocityCovarianceEphemerisRequest, ThrustVectorEphemerisRequest]]:
        ...
        if object_type ==  'OrbitCovarianceRequest':
            return import_module("spacetower_orbit_extrapolation_python_client.models.orbit_covariance_request").OrbitCovarianceRequest.from_dict(obj)
