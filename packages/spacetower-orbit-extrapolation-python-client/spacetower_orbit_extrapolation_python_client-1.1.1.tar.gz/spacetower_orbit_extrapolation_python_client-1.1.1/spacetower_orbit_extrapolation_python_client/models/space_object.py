...
class SpaceObject(BaseModel):
    ...
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {
        'BOX_SPACECRAFT': 'BoxSpacecraft','POINT_SPACECRAFT': 'PointSpacecraft'
    }
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[Union[BoxSpacecraft, PointSpacecraft]]:
    ...
    @classmethod
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[BoxSpacecraft, PointSpacecraft]]:
        """Create an instance of SpaceObject from a dict"""
        # look up the object type based on discriminator mapping
        object_type = cls.get_discriminator_value(obj)
        if object_type ==  'BoxSpacecraft':
            return import_module("spacetower_orbit_extrapolation_python_client.models.box_spacecraft").BoxSpacecraft.from_dict(obj)
        if object_type ==  'PointSpacecraft':
            return import_module("spacetower_orbit_extrapolation_python_client.models.point_spacecraft").PointSpacecraft.from_dict(obj)
