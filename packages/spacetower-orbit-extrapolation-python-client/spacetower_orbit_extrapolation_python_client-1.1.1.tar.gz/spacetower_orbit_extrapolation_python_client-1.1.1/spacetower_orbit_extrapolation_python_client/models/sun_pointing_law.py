...
class SunPointingLaw(AttitudeLaw):
    """
    Attitude pointing the solar array normal towards the Sun (applies to box spacecraft only), with the last degree of freedom of the rotation set arbitrarily
    """ # noqa: E501
