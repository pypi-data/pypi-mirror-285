...
def get_error_report(data:DataFrame, invalid_data:DataFrame, errors:list,name:str, is_empty:bool, minimal:bool)-> BaseRenderer:
    """
    Generates an error report
    """

    content = [render_error(data, invalid_data, errors, name, is_empty, minimal)]
