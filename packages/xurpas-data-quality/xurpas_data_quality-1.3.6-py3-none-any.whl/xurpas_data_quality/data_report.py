...
from xurpas_data_quality.data import check_dtypes, describe, load_dataframe,validate_dataframe ,check_col_names, describe_invalid, check_data
...
class DataReport:
    ...
    def describe_invalid_dataframe(self):
        self.description_invalid = describe_invalid(df=self.df_invalid)
    ...
    def _render_error_report(self, name=None):
        ...
        report = get_error_report(df=self.description,
                                  invalid_df=self.description_invalid,
                                  errors=self.errors, 
