    ...
    def _update_resource_by_alias(
        ...
        for a, res_dict in morph_yaml.resources.items():
            if a == alias:
                ...
                # Sync new resource to SQLite
                db_manager.replace_resource_record(a, abs_path, morph_yaml.resources[a])
                ...
                return Resource(
                    ...
                    output_paths=morph_yaml.resources[a]["output_paths"],
        ...
        for alias, res_dict in morph_yaml.resources.items():
            if res_dict["path"] == abs_path:
                ...
                return Resource(
                    ...
                    output_paths=morph_yaml.resources[alias]["output_paths"],
