"""
@Time    : 2024/7/16 18:51
@Author  : white.tie
@File    : transfer_phone.py
@Desc    : 
"""
...
import json
# path = r"F:\gitee\spider\defect_test\transfer_phone\pjtTransferDictionary.pkl"
path = "transfer_phone\pjtTransferDictionary.pkl"
