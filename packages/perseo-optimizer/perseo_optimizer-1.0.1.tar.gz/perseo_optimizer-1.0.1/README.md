...
## **What's included**
1. ### **Version: v1.0.1**
-   Corrections to the package description
...
The order of arguments in the init_system method is as follows:
    ...
    |     7    |       max      |    list[float  |  int]    | List of numbers with the maximum values that the PSO can take to modify the model's dimensions |
    |     8    |       min      |    list[float  |  int]    | List of numbers with the minimum values the PSO can take to modify the model's dimensions. |
    |     9    |     nominals    |    list[float  |  int]    | List of numbers with the nominal or default values that the model has in its dimensions. |
