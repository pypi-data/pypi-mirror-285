...
NAME_TO_IMAGES = {
    ...
    TransformEval.name():
        [
            Image(kind=Accelerator.NVIDIA,
                  name="iregistry.baidu-int.com/windmill-public/inference/nvidia:20240717_1721187781885"),
            Image(kind=Accelerator.KUNLUN,
                  name="iregistry.baidu-int.com/windmill-public/inference/kunlun:20240717_1721187781771")
        ],
    Package.name():
        [
            Image(kind=Accelerator.NVIDIA,
