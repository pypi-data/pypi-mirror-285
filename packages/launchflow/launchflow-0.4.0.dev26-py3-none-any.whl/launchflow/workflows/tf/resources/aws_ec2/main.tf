...
resource "aws_security_group" "docker_sg" {
  name        = "${var.launchflow_project}-${var.launchflow_environment}-${var.resource_id}-docker-sg"
...
resource "aws_key_pair" "generated_key" {
  key_name   = "${var.launchflow_project}-${var.launchflow_environment}-${var.resource_id}-key"
