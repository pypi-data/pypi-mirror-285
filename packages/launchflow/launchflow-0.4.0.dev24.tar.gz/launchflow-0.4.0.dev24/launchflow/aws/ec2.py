...
class EC2(AWSResource[T]):
    ...
    def _get_host(self, outputs: EC2BaseOutputs):
        # The public_ip will be an empty string if associate_public_ip_address is False
        if outputs.public_ip:
    ...
    **Example usage:**
    ...
    def inputs(self, environment_type: EnvironmentType):
        ...
        **Returns:**
        ...
        if environment_type == EnvironmentType.PRODUCTION:
            # TODO: verify its okay to expose these ports since not public ip is associated
            expose_ports = [5432]
