    ...
    **NOTE:** This will create the following infrastructure in your AWS account:
    ...
    def __init__(
        ...
        **Args:**
        ...
        - `cpu (int)`: The CPU units to allocate to the container.
        - `memory (int)`: The memory to allocate to the container.
        - `port (int)`: The port the container listens on.
        - `desired_count (int)`: The number of tasks to run.
        ...
        resource_id_with_launchflow_prefix = f"{lf.project}-{lf.environment}-{name}"
        ...
        self._code_build_project.depends_on.append(self._ecr)
