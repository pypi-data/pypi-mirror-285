...
class DestroyServicePlan:
    ...
    @property
    def ref(self) -> str:
        service_cls = SERVICE_PRODUCTS_TO_SERVICES.get(self.existing_service.product, Service)
...
class DestroyResourcePlan:
    ...
    @property
    def ref(self) -> str:
        resource_cls = RESOURCE_PRODUCTS_TO_RESOURCES.get(self.resource.product, Resource)
