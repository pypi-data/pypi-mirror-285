...
def get_chapter_info(soup):
    chapter_span = soup.find('span', class_='styled__SummaryTitle-sc-18yti3s-0')
    if chapter_span:
        chapter_number = chapter_span.find('span', class_='os-number').text.strip()
        chapter_name = chapter_span.find('span', class_='os-text').text.strip()
...
def scrape_url_data(url):
    ...
    chapter_number, chapter_name = get_chapter_info(soup)
