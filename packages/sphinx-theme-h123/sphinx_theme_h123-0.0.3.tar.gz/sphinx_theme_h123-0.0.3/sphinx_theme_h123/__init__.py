...
def _get_full_toctree(context: Ctx) -> str:
    ...
    if "toctree" in context:
        ...
        titles_only = _get_theme_var_bool(context, 'theme_h123_navtree_titlesonly', False)
        maxdepth = _get_theme_var_int(context, 'theme_h123_navtree_maxdepth', -1)
...
def setup(app: Sphinx) -> Dict[str, Any]:
    app.add_html_theme("sphinx_theme_h123", path.abspath(path.dirname(__file__)))
