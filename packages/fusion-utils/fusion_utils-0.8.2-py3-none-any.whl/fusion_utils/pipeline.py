...
class Pipeline:
    ...
    def send_email(self, subject, body, recipients=None):
        ...
        try:
            ...
            self.dual_logger.logger.error(f"Failed to send email: {str(e)}")
        ...
        try:
            ...
            if not task.query_definition:
                if not task.optional:
                    ...
                    self.dual_logger.logger.info(f'WARNING: {task.name} does not have a defined query. Skipping optional task...')
    ...
    def send_completion_email(self):
        ...
        try:
            ...
            self.dual_logger.logger.error(f"Failed to send completion email: {e}")
