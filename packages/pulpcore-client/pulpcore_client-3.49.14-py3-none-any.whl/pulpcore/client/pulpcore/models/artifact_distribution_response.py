...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, base_path=None, pulp_labels=None, pulp_last_updated=None, content_guard=None, pulp_href=None, hidden=False, name=None, base_url=None, pulp_created=None, local_vars_configuration=None):  # noqa: E501
