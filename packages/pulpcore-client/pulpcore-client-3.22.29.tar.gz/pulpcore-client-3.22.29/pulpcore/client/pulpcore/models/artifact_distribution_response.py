...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, content_guard=None, base_url=None, pulp_href=None, name=None, pulp_labels=None, base_path=None, pulp_created=None, local_vars_configuration=None):  # noqa: E501
