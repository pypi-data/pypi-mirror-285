...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, hidden=False, pulp_labels=None, pulp_created=None, name=None, content_guard=None, base_url=None, base_path=None, pulp_href=None, local_vars_configuration=None):  # noqa: E501
