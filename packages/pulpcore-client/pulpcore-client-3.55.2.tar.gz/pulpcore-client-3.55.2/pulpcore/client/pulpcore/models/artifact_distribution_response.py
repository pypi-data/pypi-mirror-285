...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, pulp_last_updated=None, content_guard=None, base_path=None, hidden=False, pulp_href=None, pulp_labels=None, name=None, pulp_created=None, base_url=None, local_vars_configuration=None):  # noqa: E501
