...
_QUATERNION = _descriptor.Descriptor(
  name='Quaternion',
  full_name='synapse.msgs.Quaternion',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='x', full_name='synapse.msgs.Quaternion.x', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='y', full_name='synapse.msgs.Quaternion.y', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='z', full_name='synapse.msgs.Quaternion.z', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='w', full_name='synapse.msgs.Quaternion.w', index=3,
