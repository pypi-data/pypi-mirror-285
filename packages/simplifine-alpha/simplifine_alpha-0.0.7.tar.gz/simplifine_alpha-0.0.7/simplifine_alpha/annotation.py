...
if __name__ == '__main__':
    syn = synthetic()
    # syn.clf_gen_batch(['I love this movie', 'I hate this movie'], ['Positive', 'Negative'], description='testing', example='I love this movie, your response: Positive')
    update_batch_status(syn.client)
    # syn.create_clf_annotation_file('batch_8sEKDRv3E1hnyY24bFHQDT3C', '/Users/alikavoosi/Desktop/COMPSOFT/Src/clfAnot_v3.jsonl')
    # print('\n-------------------\n',syn.parse_response_clf('batch_8sEKDRv3E1hnyY24bFHQDT3C'), '\n-------------------\n')
    # syn.summarization_gen_batch(['We are going to the beach today', 'I am going to the store'], description='testing')
    # syn.create_summarization_annotation_file('batch_7v4IQT0P1paGPPC1xGH3JSoK', '/Users/alikavoosi/Desktop/COMPSOFT/Src/sumAnot.jsonl')
    # syn.clf_gen_batch(['I love this movie', 'I hate this movie'], ['Positive', 'Negative'], description='testing', give_explanation=True)