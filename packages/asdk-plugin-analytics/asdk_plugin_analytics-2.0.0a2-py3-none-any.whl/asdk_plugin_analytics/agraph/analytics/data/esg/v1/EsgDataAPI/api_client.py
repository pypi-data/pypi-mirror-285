...
import asdk_plugin_analytics.agraph.analytics.data.esg.v1.EsgDataAPI.models
from asdk_plugin_analytics.agraph.analytics.data.esg.v1.EsgDataAPI import rest
from asdk_plugin_analytics.agraph.analytics.data.esg.v1.EsgDataAPI.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(asdk_plugin_analytics.agraph.analytics.data.esg.v1.EsgDataAPI.models, klass)
