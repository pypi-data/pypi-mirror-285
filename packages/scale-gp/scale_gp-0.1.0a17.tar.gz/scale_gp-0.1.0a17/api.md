...
- <code title="post /v4/application-test-case-outputs">client.application_test_case_outputs.<a href="./src/scale_gp/resources/application_test_case_outputs.py">create</a>(\*\*<a href="src/scale_gp/types/application_test_case_output_create_params.py">params</a>) -> <a href="./src/scale_gp/types/application_test_case_output_create_response.py">ApplicationTestCaseOutputCreateResponse</a></code>
