...
import pyconverters_ocrmypdf


# -- Project information -----------------------------------------------------

project = "pyconverters_ocrmypdf"
copyright = "2021, Olivier Terrier"
author = "Olivier Terrier"
version = pyconverters_ocrmypdf.__version__
release = pyconverters_ocrmypdf.__version__
...
apidoc_module_dir = os.path.dirname(pyconverters_ocrmypdf.__file__)
