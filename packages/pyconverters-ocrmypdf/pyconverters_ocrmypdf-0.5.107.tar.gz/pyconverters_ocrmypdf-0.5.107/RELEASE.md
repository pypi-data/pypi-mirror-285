...
This document guides a contributor through creating a release of pyconverters_ocrmypdf.
...
[GitHub actions](https://github.com/oterrier/pyconverters_ocrmypdf/actions?query=branch%3Amaster+workflow%3Atests).
