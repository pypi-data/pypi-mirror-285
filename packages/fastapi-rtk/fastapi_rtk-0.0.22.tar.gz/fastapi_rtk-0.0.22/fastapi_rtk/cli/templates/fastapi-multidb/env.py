...
from fastapi_rtk import DatabaseSessionManager, g, metadatas
...
async def run_async_migrations() -> None:
    ...
    alembic_session_manager.init_db(MAIN_DATABASE, BINDS)
    ...
    for name, metadata in target_metadata.items():
        logger.info("Migrating database %s" % name)
        async with alembic_session_manager.connect(
