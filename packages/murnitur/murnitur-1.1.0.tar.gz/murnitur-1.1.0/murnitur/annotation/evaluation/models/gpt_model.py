...
from murnitur.annotation.evaluation.key_handler import KeyValues, KEY_FILE_HANDLER
...
class GPTModel(DeepEvalBaseLLM):
    ...
    def load_model(self):
        if self.should_use_azure_openai():
            openai_api_key = KEY_FILE_HANDLER.fetch_data(KeyValues.AZURE_OPENAI_API_KEY)
            ...
            model_version = KEY_FILE_HANDLER.fetch_data(KeyValues.AZURE_MODEL_VERSION)
