...
class SamplingConfiguration:
    def __init__(self, *, t_min: float, t_max: float, dt: float, d_delta: float, sampling_level: int, time_based_lateral_delta_scaling: bool = True, enforce_time_bounds: bool = True, strict_velocity_sampling: bool = True) -> None: ...
