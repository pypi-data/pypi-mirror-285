...
def bug_analysis(JIRA_BASE_URL, JIRA_API_TOKEN, JIRA_USERNAME, PROJECT_KEY, EXEC_KEY, RELATE_TYPE, XRAY_TEST_TYPE, ASSIGNEE, DEFAULT_STATUS, latest, mostfailedNames, failed_df):
