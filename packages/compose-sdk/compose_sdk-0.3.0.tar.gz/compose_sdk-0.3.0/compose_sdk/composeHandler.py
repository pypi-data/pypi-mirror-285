...
class ComposeHandler:
    def __init__(
        ...
        *,
        ...
        theme: Theme = None,
        DANGEROUS_is_development_mode: bool = False,
    ):
        if api_key is None:
        ...
        self.is_development = DANGEROUS_is_development_mode
        ...
        self.api = ApiHandler(self.scheduler, self.is_development, self.api_key)
