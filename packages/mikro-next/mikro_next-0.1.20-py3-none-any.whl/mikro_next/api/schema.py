...
class PartialRGBViewInput(BaseModel):
    ...
    base_color: Optional[RGBAColor] = Field(alias="baseColor", default=None)
...
class BaseRoiBaseImage(HasZarrStoreTrait, BaseModel):
    typename: Optional[Literal["Image"]] = Field(alias="__typename", exclude=True)
    id: ID
...
class BaseRoiBase(BaseModel, IsVectorizableTrait, HasFromNumpyArrayTrait):
    id: ID
    image: BaseRoiBaseImage
    vectors: FiveDVector


class ROIBase(BaseModel, IsVectorizableTrait, HasFromNumpyArrayTrait):
    id: ID


class ROIBaseBaseRoi(BaseRoiBase, ROIBase):
    pass


ROI = Union[ROIBaseBaseRoi, ROIBase]
...
async def acreate_rgb_view(
    ...
    base_color: Optional[RGBAColor] = None,
    rath: Optional[MikroNextRath] = None,
    ...
    Arguments:
        ...
        base_color (Optional[RGBAColor], optional): baseColor.
        rath (mikro_next.rath.MikroNextRath, optional): The mikro rath client
