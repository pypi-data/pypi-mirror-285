...
class CreateRGBContextInput(BaseModel):
    ...
    image: ID
    views: Optional[Tuple["RGBContextViewInput", ...]] = None
    z: Optional[int] = None
    t: Optional[int] = None
    c: Optional[int] = None
...
class RGBContextViewInput(BaseModel):
    c_max: int = Field(alias="cMax")
    c_min: int = Field(alias="cMin")
...
CreateRGBContextInput.update_forward_refs()
