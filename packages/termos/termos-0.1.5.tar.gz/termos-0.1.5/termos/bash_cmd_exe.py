...
class BashCommandExecutor:
    ...
    def __init__(self):
        ...
        # path of the project outside the virtual environment 
        self.project_path = Path(__file__).resolve().parent.parent.parent.parent.parent.parent
    ...
    def execute_commands(self, json_input: str = None) -> str:
        ...
        for cmd in self.commands:
            try:
                result = subprocess.run(cmd, shell=True, check=True, text=True, capture_output=True, cwd=self.project_path)
