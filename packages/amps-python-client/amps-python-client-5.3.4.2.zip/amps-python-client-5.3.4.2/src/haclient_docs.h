...
static const char* class_doc = R"docstring(
...
static const char* set_reconnect_delay_doc = R"docstring(set_reconnect_delay(reconnectDelay)
...
static const char* set_reconnect_delay_strategy_doc = R"docstring(set_reconnect_delay_strategy(reconnectDelayStrategy)
Sets the reconnect delay strategy object used to control delay behavior
when connecting and reconnecting to servers.

:param strategy: The reconnect delay strategy object to use when connecting
