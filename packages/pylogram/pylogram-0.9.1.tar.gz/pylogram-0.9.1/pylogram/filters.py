...
def create(func: Callable, name: str = None, **kwargs) -> Filter:
    ...
    Parameters:
        func (``Callable``):
            ...
            The *client* argument refers to the :obj:`~pylogram.Client` that received the update.
            The *update* argument type will vary depending on which `Handler <handlers>`_ is coming from.
            For example, in a :obj:`~pylogram.handlers.MessageHandler` the *update* argument will be a :obj:`~pylogram.types.Message`; in a :obj:`~pylogram.handlers.CallbackQueryHandler` the *update* will be a :obj:`~pylogram.types.CallbackQuery`.
        ...
        **kwargs (``any``, *optional*):
            ...
            :meth:`~pylogram.filters.command` or :meth:`~pylogram.filters.regex`.
    """
    return type(
...
"""Filter messages that contain :obj:`~pylogram.types.Audio` objects."""
...
"""Filter messages that contain :obj:`~pylogram.types.Document` objects."""
...
"""Filter messages that contain :obj:`~pylogram.types.Photo` objects."""
...
"""Filter messages that contain :obj:`~pylogram.types.Sticker` objects."""
...
"""Filter messages that contain :obj:`~pylogram.types.Animation` objects."""
...
"""Filter messages that contain :obj:`~pylogram.types.Game` objects."""
...
"""Filter messages that contain :obj:`~pylogram.types.Video` objects."""
...
"""Filter messages that contain :obj:`~pylogram.types.Voice` note objects."""
...
"""Filter messages that contain :obj:`~pylogram.types.VideoNote` objects."""
...
"""Filter messages that contain :obj:`~pylogram.types.Contact` objects."""
...
"""Filter messages that contain :obj:`~pylogram.types.Location` objects."""
...
"""Filter messages that contain :obj:`~pylogram.types.Venue` objects."""
...
"""Filter messages that contain :obj:`~pylogram.types.Poll` objects."""
...
"""Filter messages that contain :obj:`~pylogram.types.Dice` objects."""
...
def command(commands: Union[str, List[str]], prefixes: Union[str, List[str]] = "/", case_sensitive: bool = False):
    ...
    Parameters:
        commands (``str`` | ``list``):
            ...
            field of the :obj:`~pylogram.types.Message`.
    ...
    async def func(flt, client: pylogram.Client, message: Message):
...
def regex(pattern: Union[str, Pattern], flags: int = 0):
    ...
    - :obj:`~pylogram.types.Message`: The filter will match ``text`` or ``caption``.
    - :obj:`~pylogram.types.CallbackQuery`: The filter will match ``data``.
    - :obj:`~pylogram.types.InlineQuery`: The filter will match ``query``.
