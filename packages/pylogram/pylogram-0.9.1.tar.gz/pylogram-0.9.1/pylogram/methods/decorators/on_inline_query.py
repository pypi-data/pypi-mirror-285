...
class OnInlineQuery:
    def on_inline_query(
        ...
        :obj:`~pylogram.handlers.InlineQueryHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, pylogram.Client):
                self.add_handler(pylogram.handlers.InlineQueryHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        pylogram.handlers.InlineQueryHandler(func, self),
