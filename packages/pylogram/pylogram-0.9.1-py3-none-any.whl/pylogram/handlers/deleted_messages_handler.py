...
class DeletedMessagesHandler(Handler):
    ...
    (private, group, channel). It is intended to be used with :meth:`~pylogram.Client.add_handler`

    For a nicer way to register this handler, have a look at the
    :meth:`~pylogram.Client.on_deleted_messages` decorator.
    ...
    Other parameters:
        ...
        messages (List of :obj:`~pylogram.types.Message`):
