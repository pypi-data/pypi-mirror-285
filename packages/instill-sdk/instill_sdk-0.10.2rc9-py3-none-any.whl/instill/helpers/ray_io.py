...
def protobuf_to_struct(pb_msg):
    ...
    dict_data = json_format.MessageToDict(pb_msg, preserving_proto_field_name=True)
...
def struct_to_protobuf(struct_pb, pb_message_type):
    ...
    dict_data = json_format.MessageToDict(struct_pb, preserving_proto_field_name=True)
