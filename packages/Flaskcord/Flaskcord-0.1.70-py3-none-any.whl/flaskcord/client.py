...
class DiscordOAuth2Session(_http.DiscordOAuth2HttpClient):
    ...
    def create_session(
        ...
        data : dict, optional
            ...
            `:py:meth:flaskcord.DiscordOAuth2Session.callback` to retrieve this data in your callback view.
    ...
    def save_authorization_token(token: dict):
        ...
        you must also override :py:meth:`flaskcord.DiscordOAuth2Session.get_authorization_token`.
    ...
    def get_authorization_token() -> dict:
        ...
        previously by `:py:meth:`flaskcord.DiscordOAuth2Session.save_authorization_token` from user's cookies.
    ...
    def fetch_guilds() -> list:
        ...
        -------
        list
            List of :py:class:`flaskcord.models.Guild` objects.
