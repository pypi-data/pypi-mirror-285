...
from ccxt_zagrava.abstract.coinmetro import ImplicitAPI
from ccxt_zagrava.base.types import Balances, Currencies, Currency, IndexType, Int, Market, Num, Order, OrderBook, OrderSide, OrderType, Str, Strings, Ticker, Tickers, Trade
...
class coinmetro(Exchange, ImplicitAPI):
    ...
    def describe(self):
        return self.deep_extend(super(coinmetro, self).describe(), {
            ...
            'urls': {
                'logo': 'https://github.com/ccxt_zagrava/ccxt_zagrava/assets/43336371/e86f87ec-6ba3-4410-962b-f7988c5db539',
                'api': {
