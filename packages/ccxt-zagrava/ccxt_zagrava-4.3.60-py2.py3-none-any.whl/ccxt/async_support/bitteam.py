...
from ccxt_zagrava.abstract.bitteam import ImplicitAPI
from ccxt_zagrava.base.types import Balances, Currencies, Currency, Int, Market, Num, Order, OrderBook, OrderSide, OrderType, Str, Strings, Ticker, Tickers, Trade, Transaction
...
class bitteam(Exchange, ImplicitAPI):
    ...
    def describe(self):
        return self.deep_extend(super(bitteam, self).describe(), {
            ...
            'urls': {
                'logo': 'https://github.com/ccxt_zagrava/ccxt_zagrava/assets/43336371/cf71fe3d-b8b4-40f2-a906-907661b28793',
                'api': {
            ...
            'api': {
                ...
                'public': {
                    'get': {
                        ...
                        'trade/api/ccxt_zagrava/pairs': 1,
                ...
                'private': {
                    'get': {
                        'trade/api/ccxt_zagrava/balance': 1,
                        'trade/api/ccxt_zagrava/order/{id}': 1,
                        'trade/api/ccxt_zagrava/ordersOfUser': 1,
                        'trade/api/ccxt_zagrava/tradesOfUser': 1,
                        'trade/api/transactionsOfUser': 1,
                    },
                    'post': {
                        'trade/api/ccxt_zagrava/cancel-all-order': 1,
                        'trade/api/ccxt_zagrava/cancelorder': 1,
                        'trade/api/ccxt_zagrava/ordercreate': 1,
                    },
                },
            },
            'fees': {
    ...
    async def fetch_markets(self, params={}) -> List[Market]:
        ...
        :see: https://bit.team/trade/api/documentation#/ccxt_zagrava/getTradeApiccxt_zagravaPairs
        :param dict [params]: extra parameters specific to the exchange api endpoint
        :returns dict[]: an array of objects representing market data
        """
        response = await self.publicGetTradeApiccxt_zagravaPairs(params)
        #
        #     {
        #         "ok": True,
        #         "result": {
    ...
    async def fetch_order_book(self, symbol: str, limit: Int = None, params={}) -> OrderBook:
        ...
        :param dict [params]: extra parameters specific to the bitteam api endpoint
        :returns dict: A dictionary of `order book structures <https://github.com/ccxt_zagrava/ccxt_zagrava/wiki/Manual#order-book-structure>` indexed by market symbols
        """
        await self.load_markets()
        market = self.market(symbol)
        request: dict = {
    ...
    async def fetch_orders(self, symbol: Str = None, since: Int = None, limit: Int = None, params={}) -> List[Order]:
        ...
        :see: https://bit.team/trade/api/documentation#/PRIVATE/getTradeApiccxt_zagravaOrdersofuser
        ...
        :returns Order[]: a list of `order structures <https://github.com/ccxt_zagrava/ccxt_zagrava/wiki/Manual#order-structure>`
        """
        await self.load_markets()
        ...
        if limit is not None:
            request['limit'] = limit
        response = await self.privateGetTradeApiccxt_zagravaOrdersOfUser(self.extend(request, params))
        #
        #     {
        #         "ok": True,
        #         "result": {
    ...
    async def fetch_order(self, id: str, symbol: Str = None, params={}) -> Order:
        ...
        :see: https://bit.team/trade/api/documentation#/PRIVATE/getTradeApiccxt_zagravaOrderId
        ...
        if symbol is not None:
            market = self.market(symbol)
        response = await self.privateGetTradeApiccxt_zagravaOrderId(self.extend(request, params))
        #
        #     {
        #         "ok": True,
        #         "result": {
    ...
    async def fetch_canceled_orders(self, symbol: Str = None, since: Int = None, limit: Int = None, params={}):
        ...
        :param dict [params]: extra parameters specific to the bitteam api endpoint
        :returns dict: a list of `order structures <https://github.com/ccxt_zagrava/ccxt_zagrava/wiki/Manual#order-structure>`
        """
        await self.load_markets()
        request: dict = {
            'type': 'cancelled',
    ...
    async def create_order(self, symbol: str, type: OrderType, side: OrderSide, amount: float, price: Num = None, params={}):
        ...
        :see: https://bit.team/trade/api/documentation#/PRIVATE/postTradeApiccxt_zagravaOrdercreate
        ...
        response = await self.privatePostTradeApiccxt_zagravaOrdercreate(self.extend(request, params))
        #
        #     {
        #         "ok": True,
        #         "result": {
    ...
    async def cancel_order(self, id: str, symbol: Str = None, params={}):
        ...
        :see: https://bit.team/trade/api/documentation#/PRIVATE/postTradeApiccxt_zagravaCancelorder
        ...
        response = await self.privatePostTradeApiccxt_zagravaCancelorder(self.extend(request, params))
        #
        #     {
        #         "ok": True,
        #         "result": {
    ...
    async def cancel_all_orders(self, symbol: Str = None, params={}):
        ...
        :see: https://bit.team/trade/api/documentation#/PRIVATE/postTradeApiccxt_zagravaCancelallorder
        :param str symbol: unified market symbol
        :param dict [params]: extra parameters specific to the bitteam api endpoint
        :returns dict[]: a list of `order structures <https://github.com/ccxt_zagrava/ccxt_zagrava/wiki/Manual#order-structure>`
        """
        ...
        response = await self.privatePostTradeApiccxt_zagravaCancelAllOrder(self.extend(request, params))
        #
        #     {
        #         "ok": True,
        #         "result": {
    ...
    async def fetch_tickers(self, symbols: Strings = None, params={}) -> Tickers:
        ...
        :param dict [params]: extra parameters specific to the bitteam api endpoint
        :returns dict: a dictionary of `ticker structures <https://github.com/ccxt_zagrava/ccxt_zagrava/wiki/Manual#ticker-structure>`
        """
        await self.load_markets()
    ...
    async def fetch_ticker(self, symbol: str, params={}) -> Ticker:
        ...
        :param dict [params]: extra parameters specific to the bitteam api endpoint
        :returns dict: a `ticker structure <https://github.com/ccxt_zagrava/ccxt_zagrava/wiki/Manual#ticker-structure>`
        """
        await self.load_markets()
        market = self.market(symbol)
        request: dict = {
    ...
    async def fetch_trades(self, symbol: str, since: Int = None, limit: Int = None, params={}) -> List[Trade]:
        ...
        :param dict [params]: extra parameters specific to the bitteam api endpoint
        :returns Trade[]: a list of `trade structures <https://github.com/ccxt_zagrava/ccxt_zagrava/wiki/Manual#public-trades>`
        """
        await self.load_markets()
        market = self.market(symbol)
        request: dict = {
    ...
    async def fetch_my_trades(self, symbol: Str = None, since: Int = None, limit: Int = None, params={}):
        ...
        :see: https://bit.team/trade/api/documentation#/PRIVATE/getTradeApiccxt_zagravaTradesofuser
        :param str symbol: unified market symbol
        :param int [since]: the earliest time in ms to fetch trades for
        :param int [limit]: the maximum number of trades structures to retrieve(default 10)
        :param dict [params]: extra parameters specific to the bitteam api endpoint
        :returns Trade[]: a list of `trade structures <https://github.com/ccxt_zagrava/ccxt_zagrava/wiki/Manual#trade-structure>`
        """
        await self.load_markets()
        request: dict = {}
        market = None
        ...
        if limit is not None:
            request['limit'] = limit
        response = await self.privateGetTradeApiccxt_zagravaTradesOfUser(self.extend(request, params))
        #
        #     {
        #         "ok": True,
        #         "result": {
    ...
    async def fetch_balance(self, params={}) -> Balances:
        ...
        :see: https://bit.team/trade/api/documentation#/PRIVATE/getTradeApiccxt_zagravaBalance
        :param dict [params]: extra parameters specific to the betteam api endpoint
        :returns dict: a `balance structure <https://github.com/ccxt_zagrava/ccxt_zagrava/wiki/Manual#balance-structure>`
        """
        await self.load_markets()
        response = await self.privateGetTradeApiccxt_zagravaBalance(params)
    ...
    async def fetch_deposits_withdrawals(self, code: Str = None, since: Int = None, limit: Int = None, params={}) -> List[Transaction]:
        ...
        :param dict [params]: extra parameters specific to the bitteam api endpoint
        :returns dict: a list of `transaction structure <https://github.com/ccxt_zagrava/ccxt_zagrava/wiki/Manual#transaction-structure>`
        """
        await self.load_markets()
        currency = None
        request: dict = {}
    ...
    def handle_errors(self, code: int, reason: str, url: str, method: str, headers: dict, body: str, response, requestHeaders, requestBody):
        ...
        if code != 200:
            if code == 404:
                if (url.find('/ccxt_zagrava/order/') >= 0) and (method == 'GET'):
