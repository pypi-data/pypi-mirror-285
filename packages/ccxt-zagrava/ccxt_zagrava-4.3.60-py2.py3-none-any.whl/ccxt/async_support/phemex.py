...
from ccxt_zagrava.abstract.phemex import ImplicitAPI
import hashlib
import numbers
from ccxt_zagrava.base.types import Balances, Currencies, Currency, Int, LeverageTier, LeverageTiers, MarginModification, Market, Num, Order, OrderBook, OrderSide, OrderType, Str, Strings, Ticker, Tickers, Trade, Transaction, TransferEntry, TransferEntries
...
from ccxt_zagrava.base.errors import DuplicateOrderId
...
class phemex(Exchange, ImplicitAPI):
    ...
    def describe(self):
        return self.deep_extend(super(phemex, self).describe(), {
            ...
            'options': {
                'brokerId': 'ccxt_zagrava123456',  # updated from ccxt_zagrava to ccxt_zagrava123456
    ...
    def parse_swap_order(self, order, market: Market = None):
        ...
        #        "clOrdID":"ccxt_zagrava2022843dffac9477b497",
        #        "symbol":"LTCUSDT",
        #        "side":"Buy",
    ...
    async def create_order(self, symbol: str, type: OrderType, side: OrderSide, amount: float, price: Num = None, params={}):
        ...
        if clientOrderId is None:
            brokerId = self.safe_string(self.options, 'brokerId', 'ccxt_zagrava123456')
            ...
            if method == 'POST':
                ...
                if isOrderPlacement:
                    if self.safe_string(params, 'clOrdID') is None:
                        id = self.safe_string(self.options, 'brokerId', 'ccxt_zagrava123456')
    ...
    async def withdraw(self, code: str, amount: float, address: str, tag=None, params={}):
        ...
        :returns dict: a `transaction structure <https://github.com/ccxt_zagrava/ccxt_zagrava/wiki/Manual#transaction-structure>`
        """
