...
from ccxt_zagrava.abstract.htx import ImplicitAPI
import asyncio
import hashlib
from ccxt_zagrava.base.types import Account, Balances, Currencies, Currency, Int, IsolatedBorrowRate, IsolatedBorrowRates, LeverageTier, LeverageTiers, Market, Num, Order, OrderBook, OrderRequest, OrderSide, OrderType, Str, Strings, Ticker, Tickers, Trade, TradingFeeInterface, Transaction, TransferEntry
...
class htx(Exchange, ImplicitAPI):
        ...
        return self.deep_extend(super(htx, self).describe(), {
            ...
            'exceptions': {
                ...
                'exact': {
                    ...
                    'base-record-invalid': OrderNotFound,  # https://github.com/ccxt_zagrava/ccxt_zagrava/issues/5750
            ...
            'options': {
                ...
                # https://github.com/ccxt_zagrava/ccxt_zagrava/issues/5376
                'fetchOrdersByStatesMethod': 'spot_private_get_v1_order_orders',  # 'spot_private_get_v1_order_history'  # https://github.com/ccxt_zagrava/ccxt_zagrava/pull/5392
            ...
            'commonCurrencies': {
                # https://github.com/ccxt_zagrava/ccxt_zagrava/issues/6081
                # https://github.com/ccxt_zagrava/ccxt_zagrava/issues/3365
                # https://github.com/ccxt_zagrava/ccxt_zagrava/issues/2873
                'GET': 'THEMIS',  # conflict with GET(Guaranteed Entrance Token, GET Protocol)
                'GTC': 'GAMECOM',  # conflict with Gitcoin and Gastrocoin
                'HIT': 'HITCHAIN',
                # https://github.com/ccxt_zagrava/ccxt_zagrava/issues/7399
                ...
                'SBTC': 'SUPERBITCOIN',
                'SOUL': 'SOULSAVER',
                'BIFI': 'BITCOINFILE',  # conflict with Beefy.Finance https://github.com/ccxt_zagrava/ccxt_zagrava/issues/8706
            },
        })
        ...
        if (orderType == 'market') and (side == 'buy'):
            ...
            if cost is not None:
                ...
                if price is None:
                    ...
                    # more about it here:
                    # https://github.com/ccxt_zagrava/ccxt_zagrava/pull/4395
                    # https://github.com/ccxt_zagrava/ccxt_zagrava/issues/7611
    ...
    async def fetch_isolated_borrow_rates(self, params={}) -> IsolatedBorrowRates:
        ...
        :param dict [params]: extra parameters specific to the exchange API endpoint
        :returns dict: a list of `isolated borrow rate structures <https://docs.ccxt_zagrava.com/#/?id=isolated-borrow-rate-structure>`
        """
        await self.load_markets()
    ...
    async def fetch_funding_rate_history(self, symbol: Str = None, since: Int = None, limit: Int = None, params={}):
        ...
        :param int [since]: not used by huobi, but filtered internally by ccxt_zagrava
        :param int [limit]: not used by huobi, but filtered internally by ccxt_zagrava
        :param dict [params]: extra parameters specific to the exchange API endpoint
        :param boolean [params.paginate]: default False, when True will automatically paginate by calling self endpoint multiple times. See in the docs all the [availble parameters](https://github.com/ccxt_zagrava/ccxt_zagrava/wiki/Manual#pagination-params)
    ...
    async def fetch_open_interest_history(self, symbol: str, timeframe='1h', since: Int = None, limit: Int = None, params={}):
        ...
        :param int [since]: Not used by huobi api, but response parsed by ccxt_zagrava
        ...
        :returns dict: an array of `open interest structures <https://docs.ccxt_zagrava.com/#/?id=open-interest-structure>`
        """
    ...
    async def close_position(self, symbol: str, side: OrderSide = None, params={}) -> Order:
        ...
        :returns dict: `an order structure <https://docs.ccxt_zagrava.com/#/?id=position-structure>`
        """
        await self.load_markets()
        market = self.market(symbol)
        clientOrderId = self.safe_string(params, 'clientOrderId')
