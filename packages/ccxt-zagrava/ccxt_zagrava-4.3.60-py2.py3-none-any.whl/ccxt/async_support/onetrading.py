...
from ccxt_zagrava.abstract.onetrading import ImplicitAPI
...
class onetrading(Exchange, ImplicitAPI):
    ...
    def describe(self):
        return self.deep_extend(super(onetrading, self).describe(), {
            ...
            'urls': {
                'logo': 'https://github.com/ccxt_zagrava/ccxt_zagrava/assets/43336371/bdbc26fd-02f2-4ca7-9f1e-17333690bb1c',
                'api': {
