...
from ccxt_zagrava.abstract.huobijp import ImplicitAPI
import hashlib
from ccxt_zagrava.base.types import Account, Balances, Currencies, Currency, Int, Market, Num, Order, OrderBook, OrderSide, OrderType, Str, Strings, Ticker, Tickers, Trade, Transaction
    ...
    def describe(self):
        return self.deep_extend(super(huobijp, self).describe(), {
            ...
            'options': {
                ...
                'fetchOrdersByStatesMethod': 'private_get_order_orders',  # 'private_get_order_history'  # https://github.com/ccxt_zagrava/ccxt_zagrava/pull/5392
                'fetchOpenOrdersMethod': 'fetch_open_orders_v1',  # 'fetch_open_orders_v2'  # https://github.com/ccxt_zagrava/ccxt_zagrava/issues/5388
            ...
            'commonCurrencies': {
                ...
                'PNT': 'Penta',
                'SBTC': 'Super Bitcoin',
                'BIFI': 'Bitcoin File',  # conflict with Beefy.Finance https://github.com/ccxt_zagrava/ccxt_zagrava/issues/8706
            },
        })
