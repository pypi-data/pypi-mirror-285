...
from ccxt_zagrava.abstract.bitfinex import ImplicitAPI
import hashlib
from ccxt_zagrava.base.types import Balances, Currency, Int, Market, Num, Order, OrderBook, OrderSide, OrderType, Str, Strings, Ticker, Tickers, Trade, TradingFees, Transaction, TransferEntry
    ...
    def describe(self):
        return self.deep_extend(super(bitfinex, self).describe(), {
            ...
            'urls': {
                ...
                'api': {
                    'v2': 'https://api-pub.bitfinex.com',  # https://github.com/ccxt_zagrava/ccxt_zagrava/issues/5109
            ...
            'options': {
                'currencyNames': {
                    ...
                    'AVT': 'aventus',  # #1811
                    'BAT': 'bat',
                    # https://github.com/ccxt_zagrava/ccxt_zagrava/issues/5833
                    ...
                    'TUSD': 'tsd',
                    'USD': 'wire',
                    'USDC': 'udc',  # https://github.com/ccxt_zagrava/ccxt_zagrava/issues/5833
                    'UTK': 'utk',
    ...
    async def fetch_balance(self, params={}) -> Balances:
        ...
        for i in range(0, len(response)):
            ...
            if (accountType == type) and derivativeCondition:
                ...
                # https://github.com/ccxt_zagrava/ccxt_zagrava/issues/4989
