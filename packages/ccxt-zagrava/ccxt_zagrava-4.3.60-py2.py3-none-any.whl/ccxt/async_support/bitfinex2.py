...
from ccxt_zagrava.abstract.bitfinex2 import ImplicitAPI
import hashlib
from ccxt_zagrava.base.types import Balances, Currencies, Currency, Int, MarginModification, Market, Num, Order, OrderBook, OrderRequest, OrderSide, OrderType, Str, Strings, Ticker, Tickers, Trade, TradingFees, Transaction, TransferEntry
...
from ccxt_zagrava.base.decimal_to_precision import ROUND
from ccxt_zagrava.base.decimal_to_precision import TRUNCATE
from ccxt_zagrava.base.decimal_to_precision import DECIMAL_PLACES
from ccxt_zagrava.base.decimal_to_precision import SIGNIFICANT_DIGITS
...
class bitfinex2(Exchange, ImplicitAPI):
    ...
    def describe(self):
        return self.deep_extend(super(bitfinex2, self).describe(), {
            ...
            'api': {
                'public': {
                    'get': {
                        ...
                        'conf/pub:map:currency:tx:fee': 2.7,  # maps currencies to their withdrawal fees https://github.com/ccxt_zagrava/ccxt_zagrava/issues/7745
            ...
            'commonCurrencies': {
                ...
                'EUTF0': 'EURT',
                'USTF0': 'USDT',
                'ALG': 'ALGO',  # https://github.com/ccxt_zagrava/ccxt_zagrava/issues/6034
                'AMP': 'AMPL',
                'ATO': 'ATOM',  # https://github.com/ccxt_zagrava/ccxt_zagrava/issues/5118
                'BCHABC': 'XEC',
                'BCHN': 'BCH',
                'DAT': 'DATA',
                'DOG': 'MDOGE',
    ...
    async def fetch_markets(self, params={}) -> List[Market]:
        ...
        for i in range(0, len(markets)):
            ...
            result.append({
                ...
                'optionType': None,
                'precision': {
                    'amount': int('8'),  # https://github.com/ccxt_zagrava/ccxt_zagrava/issues/7310
                    'price': int('5'),
                },
                'limits': {
                    'leverage': {
    ...
    async def fetch_currencies(self, params={}) -> Currencies:
        ...
        labels = [
            ...
            'pub:map:currency:tx:fee',  # maps currencies to their withdrawal fees https://github.com/ccxt_zagrava/ccxt_zagrava/issues/7745,
    ...
    async def transfer(self, code: str, amount: float, fromAccount: str, toAccount: str, params={}) -> TransferEntry:
        ...
        # however we support it in ccxt_zagrava(from just looking at web inspector)
        await self.load_markets()
        accountsByType = self.safe_value(self.options, 'v2AccountsByType', {})
    ...
    def parse_order(self, order: dict, market: Market = None) -> Order:
        ...
        symbol = self.safe_symbol(marketId)
        # https://github.com/ccxt_zagrava/ccxt_zagrava/issues/6686
    ...
    def create_order_request(self, symbol: str, type: OrderType, side: OrderSide, amount: float, price: Num = None, params={}):
        ...
        :returns dict: an `order structure <https://github.com/ccxt_zagrava/ccxt_zagrava/wiki/Manual#order-structure>`
        """
        market = self.market(symbol)
    ...
    async def fetch_deposits_withdrawals(self, code: Str = None, since: Int = None, limit: Int = None, params={}) -> List[Transaction]:
        ...
        :param dict [params]: extra parameters specific to the exchange API endpoint
        :returns dict: a list of `transaction structure <https://docs.ccxt_zagrava.com/#/?id=transaction-structure>`
        """
        await self.load_markets()
        currency = None
        request: dict = {}
    ...
    async def fetch_open_interest(self, symbol: str, params={}):
        ...
        :returns dict: an `open interest structure <https://docs.ccxt_zagrava.com/#/?id=open-interest-structure>`
        """
        await self.load_markets()
        market = self.market(symbol)
        request: dict = {
    ...
    async def set_margin(self, symbol: str, amount: float, params={}) -> MarginModification:
        ...
        :returns dict: A `margin structure <https://github.com/ccxt_zagrava/ccxt_zagrava/wiki/Manual#add-margin-structure>`
        """
        await self.load_markets()
        market = self.market(symbol)
        if not market['swap']:
