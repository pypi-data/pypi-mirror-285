...
from ccxt_zagrava.abstract.blockchaincom import ImplicitAPI
from ccxt_zagrava.base.types import Balances, Currency, Int, Market, Num, Order, OrderBook, OrderSide, OrderType, Str, Strings, Ticker, Tickers, Trade, TradingFees, Transaction
    ...
    def describe(self):
        return self.deep_extend(super(blockchaincom, self).describe(), {
            ...
            'has': {
                'CORS': False,
                'spot': True,
                'margin': None,  # on exchange but not implemented in ccxt_zagrava
                'swap': False,
                'future': False,
                'option': False,
