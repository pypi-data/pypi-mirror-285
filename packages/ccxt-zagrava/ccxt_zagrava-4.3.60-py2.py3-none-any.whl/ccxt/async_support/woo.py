...
from ccxt_zagrava.abstract.woo import ImplicitAPI
import hashlib
from ccxt_zagrava.base.types import Account, Balances, Bool, Conversion, Currencies, Currency, Int, Leverage, Market, MarketType, Num, Order, OrderBook, OrderSide, OrderType, Str, Strings, Trade, TradingFees, Transaction, TransferEntry, TransferEntries
    ...
    def describe(self):
        return self.deep_extend(super(woo, self).describe(), {
            ...
            'has': {
                ...
                'cancelOrder': True,
                'cancelWithdraw': False,  # exchange have that endpoint disabled atm, but was once implemented in ccxt_zagrava per old docs: https://kronosresearch.github.io/wootrade-documents/#cancel-withdraw-request
                ...
                'transfer': True,
                'withdraw': True,  # exchange have that endpoint disabled atm, but was once implemented in ccxt_zagrava per old docs: https://kronosresearch.github.io/wootrade-documents/#token-withdraw
            },
            'timeframes': {
                '1m': '1m',
                '5m': '5m',
                ...
                'v1': {
                    ...
                    'private': {
                        ...
                        'post': {
                            ...
                            'asset/ltv': 30,
                            'asset/withdraw': 30,  # implemented in ccxt_zagrava, disabled on the exchange side https://kronosresearch.github.io/wootrade-documents/#token-withdraw
                        ...
                        'delete': {
                            ...
                            'client/order': 1,
                            'orders': 1,
                            'asset/withdraw': 120,  # implemented in ccxt_zagrava, disabled on the exchange side https://kronosresearch.github.io/wootrade-documents/#cancel-withdraw-request
                        },
                    },
                },
                'v2': {
