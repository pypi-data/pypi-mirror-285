...
from ccxt_zagrava.async_support.base.ws.cache import ArrayCache, ArrayCacheBySymbolById
import hashlib
...
class krakenfutures(ccxt_zagrava.async_support.krakenfutures):
    ...
    async def subscribe_public(self, name: str, symbols: List[str], params={}):
        ...
        :param str[] symbols: ccxt_zagrava market symbols
    ...
    async def watch_balance(self, params={}) -> Balances:
        ...
        :returns dict} a object of wallet types each with a balance structure {@link https://docs.ccxt_zagrava.com/#/?id=balance-structure:
        """
        await self.load_markets()
        name = 'balances'
        messageHash = name
