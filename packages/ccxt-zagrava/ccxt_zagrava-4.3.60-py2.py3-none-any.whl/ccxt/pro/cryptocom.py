...
import hashlib
from ccxt_zagrava.base.types import Balances, Int, Num, Order, OrderBook, OrderSide, OrderType, Position, Str, Strings, Ticker, Trade
...
class cryptocom(ccxt_zagrava.async_support.cryptocom):
