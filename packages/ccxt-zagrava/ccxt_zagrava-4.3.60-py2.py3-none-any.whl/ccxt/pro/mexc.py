...
import hashlib
from ccxt_zagrava.base.types import Balances, Int, Order, OrderBook, Str, Ticker, Trade
from ccxt_zagrava.async_support.base.ws.client import Client
from typing import List
from ccxt_zagrava.base.errors import AuthenticationError


class mexc(ccxt_zagrava.async_support.mexc):
    ...
    def handle_delta(self, orderbook, delta):
        ...
        if deltaNonce < existingNonce:
            # even when doing < comparison, self happens: https://app.travis-ci.com/github/ccxt_zagrava/ccxt_zagrava/builds/269234741#L1809
    ...
    async def authenticate(self, subscriptionHash, params={}):
        # we only need one listenKey since ccxt_zagrava shares connections
