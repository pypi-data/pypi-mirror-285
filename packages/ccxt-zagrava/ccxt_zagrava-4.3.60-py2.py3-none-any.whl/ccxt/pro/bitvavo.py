...
import hashlib
from ccxt_zagrava.base.types import Balances, Int, Num, Order, OrderBook, OrderSide, OrderType, Str, Ticker, Trade, TradingFees
...
class bitvavo(ccxt_zagrava.async_support.bitvavo):
    ...
    async def watch_my_trades(self, symbol: Str = None, since: Int = None, limit: Int = None, params={}) -> List[Trade]:
        ...
        :param dict [params]: extra parameters specific to the exchange API endpoint
        :returns dict[]: a list of [trade structures]{@link https://docs.ccxt_zagrava.com/#/?id=ortradeder-structure
        """
        if symbol is None:
