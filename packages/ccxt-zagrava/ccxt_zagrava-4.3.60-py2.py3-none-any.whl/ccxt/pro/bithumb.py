...
from ccxt_zagrava.base.types import Int, OrderBook, Strings, Ticker, Tickers, Trade
from ccxt_zagrava.async_support.base.ws.client import Client
from typing import List
from ccxt_zagrava.base.errors import ExchangeError


class bithumb(ccxt_zagrava.async_support.bithumb):
    ...
    async def watch_trades(self, symbol: str, since: Int = None, limit: Int = None, params={}) -> List[Trade]:
        ...
        :param dict [params]: extra parameters specific to the exchange API endpoint
        :returns dict[]: a list of `trade structures <https://github.com/ccxt_zagrava/ccxt_zagrava/wiki/Manual#public-trades>`
        """
        await self.load_markets()
        url = self.urls['api']['ws']
        market = self.market(symbol)
