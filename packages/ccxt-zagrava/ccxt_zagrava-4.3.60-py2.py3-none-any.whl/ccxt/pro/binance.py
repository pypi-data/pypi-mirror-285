...
import ccxt_zagrava.async_support
from ccxt_zagrava.async_support.base.ws.cache import ArrayCache, ArrayCacheBySymbolById, ArrayCacheBySymbolBySide, ArrayCacheByTimestamp
import hashlib
from ccxt_zagrava.base.types import Balances, Int, Liquidation, Num, Order, OrderBook, OrderSide, OrderType, Position, Str, Strings, Ticker, Tickers, Trade
...
class binance(ccxt_zagrava.async_support.binance):
    ...
    async def watch_liquidations(self, symbol: str, since: Int = None, limit: Int = None, params={}) -> List[Liquidation]:
        ...
        :returns dict: an array of `liquidation structures <https://github.com/ccxt_zagrava/ccxt_zagrava/wiki/Manual#liquidation-structure>`
        """
    ...
    def handle_order_book(self, client: Client, message):
        #
        # initial snapshot is fetched with ccxt_zagrava's fetchOrderBook
        ...
        if not (symbol in self.orderbooks):
            #
            # https://github.com/ccxt_zagrava/ccxt_zagrava/issues/6672
            #
    ...
    async def watch_positions(self, symbols: Strings = None, since: Int = None, limit: Int = None, params={}) -> List[Position]:
        ...
        :returns dict[]: a list of `position structure <https://docs.ccxt_zagrava.com/en/latest/manual.html#position-structure>`
        """
        await self.load_markets()
        market = None
        messageHash = ''
