...
import hashlib
from ccxt_zagrava.base.types import Int, Order, OrderBook, Str, Strings, Ticker, Tickers, Trade
...
class coinbaseexchange(ccxt_zagrava.async_support.coinbaseexchange):
