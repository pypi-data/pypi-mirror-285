...
from ccxt_zagrava.base.errors import ExchangeError
from ccxt_zagrava.base.errors import NetworkError
from ccxt_zagrava.base.errors import NotSupported
from ccxt_zagrava.base.errors import AuthenticationError
from ccxt_zagrava.base.errors import DDoSProtection
from ccxt_zagrava.base.errors import RequestTimeout
from ccxt_zagrava.base.errors import ExchangeNotAvailable
from ccxt_zagrava.base.errors import InvalidAddress
from ccxt_zagrava.base.errors import InvalidOrder
from ccxt_zagrava.base.errors import ArgumentsRequired
from ccxt_zagrava.base.errors import BadSymbol
from ccxt_zagrava.base.errors import NullResponse
from ccxt_zagrava.base.errors import RateLimitExceeded
from ccxt_zagrava.base.errors import BadRequest
from ccxt_zagrava.base.errors import BadResponse
from ccxt_zagrava.base.errors import InvalidProxySettings

# -----------------------------------------------------------------------------

from ccxt_zagrava.base.decimal_to_precision import decimal_to_precision
from ccxt_zagrava.base.decimal_to_precision import DECIMAL_PLACES, TICK_SIZE, NO_PADDING, TRUNCATE, ROUND, ROUND_UP, ROUND_DOWN, SIGNIFICANT_DIGITS
from ccxt_zagrava.base.decimal_to_precision import number_to_string
from ccxt_zagrava.base.precise import Precise
from ccxt_zagrava.base.types import BalanceAccount, Currency, IndexType, OrderSide, OrderType, Trade, OrderRequest, Market, MarketType, Str, Num, Strings, CancellationRequest, Bool
...
# ecdsa signing
from ccxt_zagrava.static_dependencies import ecdsa
from ccxt_zagrava.static_dependencies import keccak
...
# eth signing
from ccxt_zagrava.static_dependencies.ethereum import abi
from ccxt_zagrava.static_dependencies.ethereum import account
from ccxt_zagrava.static_dependencies.msgpack import packb
...
from ccxt_zagrava.base.types import Int
...
class Exchange(object):
    ...
    name = None
    version = None
    certified = False  # if certified by the ccxt_zagrava dev team
    pro = False  # if it is integrated with ccxt_zagrava Pro for WebSocket support
    ...
    def __init__(self, config={}):
        ...
        # self.userAgent = {
        #     'User-Agent': 'ccxt_zagrava/' + __version__ + ' (+https://github.com/ccxt_zagrava/ccxt_zagrava) Python/' + version
        # }
    ...
    def __repr__(self):
        return 'ccxt_zagrava.' + ('async_support.' if self.asyncio_loop else '') + self.id + '()'
    ...
    def fetch(self, url, method='GET', headers=None, body=None):
        ...
        try:
            ...
            if ('Missing dependencies for SOCKS support' in error_string):
                raise NotSupported(self.id + ' - to use SOCKS proxy with ccxt_zagrava, you might need "pysocks" module that can be installed by "pip install pysocks"')
            details = ' '.join([self.id, method, url])
    ...
    def is_text_response(self, headers):
        # https://github.com/ccxt_zagrava/ccxt_zagrava/issues/5302
    ...
    def check_required_version(required_version, error=True):
        ...
        if not result:
            if error:
                raise NotSupported('Your current version of ccxt_zagrava is ' + __version__ + ', a newer version ' + required_version + ' is required, please, upgrade your version of ccxt_zagrava')
            else:
                return error
        return result
    ...
    def fetch_margin_adjustment_history(self, symbol: Str = None, type: Str = None, since: Num = None, limit: Num = None, params={}):
        ...
        :returns dict[]: a list of `margin structures <https://docs.ccxt_zagrava.com/#/?id=margin-loan-structure>`
        """
    ...
    def fetch_ohlcv(self, symbol: str, timeframe='1m', since: Int = None, limit: Int = None, params={}):
        ...
        if self.has['fetchTrades']:
            message = '. If you want to build OHLCV candles from trade executions data, visit https://github.com/ccxt_zagrava/ccxt_zagrava/tree/master/examples/ and see "build-ohlcv-bars" file'
    ...
    def fetch_positions_for_symbol(self, symbol: str, params={}):
        ...
        :returns dict[]: a list of `position structure <https://docs.ccxt_zagrava.com/#/?id=position-structure>` with maximum 3 items - possible one position for "one-way" mode, and possible two positions(long & short) for "two-way"(a.k.a. hedge) mode
        """
    ...
    def create_trailing_amount_order(self, symbol: str, type: OrderType, side: OrderSide, amount: float, price: Num = None, trailingAmount=None, trailingTriggerPrice=None, params={}):
        ...
        :param dict [params]: extra parameters specific to the exchange API endpoint
        :returns dict: an `order structure <https://docs.ccxt_zagrava.com/#/?id=order-structure>`
        """
    ...
    def fetch_deposits_withdrawals(self, code: Str = None, since: Int = None, limit: Int = None, params={}):
        ...
        :param dict [params]: extra parameters specific to the exchange API endpoint
        :returns dict: a list of `transaction structures <https://docs.ccxt_zagrava.com/#/?id=transaction-structure>`
        """
    ...
    def parse_incomes(self, incomes, market=None, since: Int = None, limit: Int = None):
        ...
        :param dict market: ccxt_zagrava market
        :param int [since]: when defined, the response items are filtered to only include items after self timestamp
        :param int [limit]: limits the number of items in the response
        :returns dict[]: an array of `funding history structures <https://docs.ccxt_zagrava.com/#/?id=funding-history-structure>`
        """
        result = []
    ...
    def parse_liquidations(self, liquidations: List[dict], market: Market = None, since: Int = None, limit: Int = None):
        ...
        :param int [since]: when defined, the response items are filtered to only include items after self timestamp
        :param int [limit]: limits the number of items in the response
        :returns dict[]: an array of `liquidation structures <https://docs.ccxt_zagrava.com/#/?id=liquidation-structure>`
        """
        result = []
    ...
    def fetch_position_history(self, symbol: str, since: Int = None, limit: Int = None, params={}):
        ...
        :param dict params: extra parameters specific to the exchange api endpoint
        :returns dict[]: a list of `position structures <https://docs.ccxt_zagrava.com/#/?id=position-structure>`
        """
    ...
    def fetch_transfer(self, id: str, code: Str = None, params={}):
        ...
        :param dict params: extra parameters specific to the exchange api endpoint
        :returns dict: a `transfer structure <https://docs.ccxt_zagrava.com/#/?id=transfer-structure>`
        """
