...
from ccxt_zagrava.abstract.ascendex import ImplicitAPI
import hashlib
from ccxt_zagrava.base.types import Account, Balances, Currencies, Currency, Int, Leverage, Leverages, LeverageTier, LeverageTiers, MarginMode, MarginModes, MarginModification, Market, Num, Order, OrderBook, OrderRequest, OrderSide, OrderType, Str, Strings, Ticker, Tickers, Trade, TradingFees, Transaction, TransferEntry
...
class ascendex(Exchange, ImplicitAPI):
    ...
    async def fetch_open_orders(self, symbol: Str = None, since: Int = None, limit: Int = None, params={}) -> List[Order]:
        ...
        # a workaround for https://github.com/ccxt_zagrava/ccxt_zagrava/issues/7187
        orders = []
    ...
    async def cancel_all_orders(self, symbol: Str = None, params={}):
        ...
        :param dict [params]: extra parameters specific to the exchange API endpoint
        :returns dict[]: a list with a single `order structure <https://docs.ccxt_zagrava.com/#/?id=order-structure>` with the response assigned to the info property
        """
        await self.load_markets()
        await self.load_accounts()
        market = None
