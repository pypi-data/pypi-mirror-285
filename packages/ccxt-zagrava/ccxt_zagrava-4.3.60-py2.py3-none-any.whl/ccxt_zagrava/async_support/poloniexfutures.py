...
from ccxt_zagrava.abstract.poloniexfutures import ImplicitAPI
import hashlib
from ccxt_zagrava.base.types import Balances, Int, Market, Num, Order, OrderBook, OrderSide, OrderType, Str, Strings, Ticker, Tickers, Trade
...
class poloniexfutures(Exchange, ImplicitAPI):
    ...
    def parse_ticker(self, ticker: dict, market: Market = None) -> Ticker:
        ...
        if len(timestampString) == 16:
            # 16 digits: https://app.travis-ci.com/github/ccxt_zagrava/ccxt_zagrava/builds/270587157#L5454
            multiplier = 0.001
        elif len(timestampString) == 17:
            # 17 digits: https://app.travis-ci.com/github/ccxt_zagrava/ccxt_zagrava/builds/269959181#L4011
            multiplier = 0.0001
    ...
    async def fetch_l3_order_book(self, symbol: str, limit: Int = None, params={}):
        ...
        :param dict [params]: extra parameters specific to the exchange API endpoint
        :returns dict: an `order book structure <https://docs.ccxt_zagrava.com/#/?id=order-book-structure>`
        """
        await self.load_markets()
        market = self.market(symbol)
