...
from ccxt_zagrava.abstract.bingx import ImplicitAPI
import asyncio
import hashlib
import numbers
from ccxt_zagrava.base.types import Balances, Currencies, Currency, Int, Leverage, MarginMode, MarginModification, Market, Num, Order, OrderBook, OrderRequest, OrderSide, OrderType, Position, Str, Strings, Ticker, Tickers, Trade, Transaction, TransferEntry, TransferEntries
...
class bingx(Exchange, ImplicitAPI):
    ...
    async def fetch_trades(self, symbol: str, since: Int = None, limit: Int = None, params={}) -> List[Trade]:
        ...
        :param dict [params]: extra parameters specific to the exchange API endpoint
        :returns dict[]: a list of `trade structures <https://docs.ccxt_zagrava.com/#/?id=public-trades>`
        """
        await self.load_markets()
        market = self.market(symbol)
        request: dict = {
    ...
    async def fetch_deposit_addresses_by_network(self, code: str, params={}):
        ...
        :param str code: unified currency code
        :param dict [params]: extra parameters specific to the exchange API endpoint
        :returns dict: a dictionary `address structures <https://docs.ccxt_zagrava.com/#/?id=address-structure>`, indexed by the network
        """
        await self.load_markets()
        currency = self.currency(code)
    ...
    def sign(self, path, section='public', method='GET', params={}, headers=None, body=None):
        ...
        if access == 'public':
            ...
            headers = {
                ...
                'X-SOURCE-KEY': self.safe_string(self.options, 'broker', 'ccxt_zagrava'),
            }
            url += query
