...
from ccxt_zagrava.abstract.gate import ImplicitAPI
import asyncio
import hashlib
from ccxt_zagrava.base.types import Balances, Currencies, Currency, FundingHistory, Greeks, Int, Leverage, Leverages, LeverageTier, LeverageTiers, MarginModification, Market, MarketInterface, Num, Option, OptionChain, Order, OrderBook, OrderRequest, CancellationRequest, OrderSide, OrderType, Position, Str, Strings, Ticker, Tickers, Trade, TradingFeeInterface, TradingFees, Transaction, TransferEntry
...
class gate(Exchange, ImplicitAPI):
    ...
    def describe(self):
        return self.deep_extend(super(gate, self).describe(), {
            ...
            'headers': {
                'X-Gate-Channel-Id': 'ccxt_zagrava',
            },
            'options': {
                'sandboxMode': False,
                'createOrder': {
    ...
    def prepare_request(self, market=None, type=None, params={}):
        ...
        :param dict market: ccxt_zagrava market, required when type is None
    ...
    async def fetch_deposit_address(self, code: str, params={}):
        ...
        :param dict [params]: extra parameters specific to the exchange API endpoint
        :param str [params.network]: unified network code(not used directly by gate.io but used by ccxt_zagrava to filter the response)
    ...
    async def fetch_balance(self, params={}) -> Balances:
        ...
        :param str [params.symbol]: margin only - unified ccxt_zagrava symbol
        """
        await self.load_markets()
    ...
    async def create_order(self, symbol: str, type: OrderType, side: OrderSide, amount: float, price: Num = None, params={}):
        ...
        :returns dict|None: `An order structure <https://docs.ccxt_zagrava.com/#/?id=order-structure>`
        """
        await self.load_markets()
        market = self.market(symbol)
    ...
    async def transfer(self, code: str, amount: float, fromAccount: str, toAccount: str, params={}) -> TransferEntry:
        ...
        :returns: A `transfer structure <https://docs.ccxt_zagrava.com/#/?id=transfer-structure>`
        """
        await self.load_markets()
        currency = self.currency(code)
    ...
    async def fetch_positions(self, symbols: Strings = None, params={}):
        ...
        :param str[]|None symbols: Not used by gate, but parsed internally by ccxt_zagrava
        :param dict [params]: extra parameters specific to the exchange API endpoint
        :param str [params.settle]: 'btc' or 'usdt' - settle currency for perpetual swap and future - default="usdt" for swap and "btc" for future
