...
from ccxt_zagrava.abstract.woofipro import ImplicitAPI
from ccxt_zagrava.base.types import Balances, Currencies, Currency, Int, Leverage, Market, Num, Order, OrderBook, OrderRequest, OrderSide, OrderType, Str, Strings, Trade, TradingFees, Transaction
...
class woofipro(Exchange, ImplicitAPI):
    ...
    def describe(self):
        return self.deep_extend(super(woofipro, self).describe(), {
            ...
            'urls': {
                'logo': 'https://github.com/ccxt_zagrava/ccxt_zagrava/assets/43336371/b1e7b348-a0fc-4605-8b7f-91176958fd69',
                'api': {
                ...
                'referral': {
                    'url': 'https://dex.woo.org/en/trade?ref=ccxt_zagrava',
                    'discount': 0.05,
                },
            },
            'api': {
