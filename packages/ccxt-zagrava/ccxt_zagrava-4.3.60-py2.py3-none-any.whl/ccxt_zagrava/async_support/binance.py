...
from ccxt_zagrava.async_support.base.exchange import Exchange
from ccxt_zagrava.abstract.binance import ImplicitAPI
import asyncio
import hashlib
import json
from ccxt_zagrava.base.types import Balances, Conversion, CrossBorrowRate, Currencies, Currency, Greeks, Int, IsolatedBorrowRate, IsolatedBorrowRates, Leverage, Leverages, LeverageTier, LeverageTiers, MarginMode, MarginModes, MarginModification, Market, MarketInterface, Num, Option, Order, OrderBook, OrderRequest, OrderSide, OrderType, Str, Strings, Ticker, Tickers, Trade, TradingFeeInterface, TradingFees, Transaction, TransferEntry, TransferEntries
from typing import List
from ccxt_zagrava.base.errors import ExchangeError
from ccxt_zagrava.base.errors import AuthenticationError
from ccxt_zagrava.base.errors import PermissionDenied
from ccxt_zagrava.base.errors import AccountSuspended
...
from ccxt_zagrava.base.errors import OperationRejected
from ccxt_zagrava.base.errors import MarginModeAlreadySet
from ccxt_zagrava.base.errors import MarketClosed
from ccxt_zagrava.base.errors import InsufficientFunds
from ccxt_zagrava.base.errors import InvalidOrder
from ccxt_zagrava.base.errors import OrderNotFound
from ccxt_zagrava.base.errors import OrderImmediatelyFillable
from ccxt_zagrava.base.errors import OrderNotFillable
from ccxt_zagrava.base.errors import NotSupported
from ccxt_zagrava.base.errors import OperationFailed
from ccxt_zagrava.base.errors import DDoSProtection
from ccxt_zagrava.base.errors import RateLimitExceeded
from ccxt_zagrava.base.errors import OnMaintenance
from ccxt_zagrava.base.errors import InvalidNonce
from ccxt_zagrava.base.errors import RequestTimeout
from ccxt_zagrava.base.errors import BadResponse
from ccxt_zagrava.base.decimal_to_precision import TRUNCATE
from ccxt_zagrava.base.decimal_to_precision import TICK_SIZE
...
class binance(Exchange, ImplicitAPI):
    ...
    def describe(self):
        return self.deep_extend(super(binance, self).describe(), {
            ...
            'has': {
                ...
                'closePosition': False,  # exchange specific closePosition parameter for binance createOrder is not synonymous with how ccxt_zagrava uses closePositions
            ...
            'commonCurrencies': {
                'BCC': 'BCC',  # kept for backward-compatibility https://github.com/ccxt_zagrava/ccxt_zagrava/issues/4848
                'YOYO': 'YOYOW',
            },
            ...
            'options': {
                ...
                # not an error
                # https://github.com/ccxt_zagrava/ccxt_zagrava/issues/11268
                # https://github.com/ccxt_zagrava/ccxt_zagrava/pull/11624
    ...
    async def fetch_currencies(self, params={}) -> Currencies:
        ...
        for i in range(0, len(response)):
            ...
            for j in range(0, len(networkList)):
                ...
                # avoid zero values, which are mostly from fiat or leveraged tokens : https://github.com/ccxt_zagrava/ccxt_zagrava/pull/14902#issuecomment-1271636731
    ...
    def parse_market(self, market: dict) -> Market:
        ...
        if 'PRICE_FILTER' in filtersByType:
            ...
            # https://github.com/ccxt_zagrava/ccxt_zagrava/issues/4286
    ...
    async def fetch_balance(self, params={}) -> Balances:
        ...
        :param str [params.subType]: 'linear' or 'inverse'
        :returns dict: a `balance structure <https://docs.ccxt_zagrava.com/#/?id=balance-structure>`
        """
    ...
    async def fetch_order_book(self, symbol: str, limit: Int = None, params={}) -> OrderBook:
        ...
        :param dict [params]: extra parameters specific to the exchange API endpoint
        :returns dict: A dictionary of `order book structures <https://docs.ccxt_zagrava.com/#/?id=order-book-structure>` indexed by market symbols
        """
        await self.load_markets()
    ...
    async def fetch_status(self, params={}):
        ...
        :param dict [params]: extra parameters specific to the exchange API endpoint
        :returns dict: a `status structure <https://docs.ccxt_zagrava.com/#/?id=exchange-status-structure>`
        """
    ...
    async def fetch_ticker(self, symbol: str, params={}) -> Ticker:
        ...
        :returns dict: a `ticker structure <https://docs.ccxt_zagrava.com/#/?id=ticker-structure>`
        """
        await self.load_markets()
        market = self.market(symbol)
        request: dict = {
    ...
    async def fetch_bids_asks(self, symbols: Strings = None, params={}):
        ...
        :param dict [params]: extra parameters specific to the exchange API endpoint
        :param str [params.subType]: "linear" or "inverse"
        :returns dict: a dictionary of `ticker structures <https://docs.ccxt_zagrava.com/#/?id=ticker-structure>`
        """
        await self.load_markets()
    ...
    async def fetch_ohlcv(self, symbol: str, timeframe='1m', since: Int = None, limit: Int = None, params={}) -> List[list]:
        ...
        :param boolean [params.paginate]: default False, when True will automatically paginate by calling self endpoint multiple times. See in the docs all the [available parameters](https://github.com/ccxt_zagrava/ccxt_zagrava/wiki/Manual#pagination-params)
        ...
        if since is not None:
            ...
            # https://github.com/ccxt_zagrava/ccxt_zagrava/issues/8454
            #
            if market['inverse']:
                if since > 0:
                    duration = self.parse_timeframe(timeframe)
    ...
    async def fetch_trades(self, symbol: str, since: Int = None, limit: Int = None, params={}) -> List[Trade]:
        ...
        :param boolean [params.paginate]: default False, when True will automatically paginate by calling self endpoint multiple times. See in the docs all the [availble parameters](https://github.com/ccxt_zagrava/ccxt_zagrava/wiki/Manual#pagination-params)
         *
         * EXCHANGE SPECIFIC PARAMETERS
        :param int [params.fromId]: trade id to fetch from, default gets most recent trades, not used when fetchTradesMethod is 'publicGetTrades', 'fapiPublicGetTrades', 'dapiPublicGetTrades', or 'eapiPublicGetTrades'
        :returns Trade[]: a list of `trade structures <https://docs.ccxt_zagrava.com/#/?id=public-trades>`
        """
        await self.load_markets()
        paginate = False
        ...
        if not market['option']:
            if since is not None:
                request['startTime'] = since
                # https://github.com/ccxt_zagrava/ccxt_zagrava/issues/6400
                # https://github.com/binance-exchange/binance-official-api-docs/blob/master/rest-api.md#compressedaggregate-trades-list
    ...
    async def fetch_orders(self, symbol: Str = None, since: Int = None, limit: Int = None, params={}) -> List[Order]:
        ...
        :returns Order[]: a list of `order structures <https://docs.ccxt_zagrava.com/#/?id=order-structure>`
        """
        if symbol is None:
    ...
    async def fetch_canceled_orders(self, symbol: Str = None, since: Int = None, limit: Int = None, params={}):
        ...
        :param boolean [params.portfolioMargin]: set to True if you would like to fetch orders in a portfolio margin account
        :param boolean [params.stop]: set to True if you would like to fetch portfolio margin account stop or conditional orders
        :returns dict[]: a list of `order structures <https://docs.ccxt_zagrava.com/#/?id=order-structure>`
        """
        if symbol is None:
    ...
    async def cancel_orders(self, ids: List[str], symbol: Str = None, params={}):
        ...
        :returns dict: an list of `order structures <https://docs.ccxt_zagrava.com/#/?id=order-structure>`
        """
        if symbol is None:
    ...
    async def fetch_order_trades(self, id: str, symbol: Str = None, since: Int = None, limit: Int = None, params={}):
        ...
        :param dict [params]: extra parameters specific to the exchange API endpoint
        :returns dict[]: a list of `trade structures <https://docs.ccxt_zagrava.com/#/?id=trade-structure>`
        """
        if symbol is None:
    ...
    async def fetch_my_trades(self, symbol: Str = None, since: Int = None, limit: Int = None, params={}):
        ...
        :returns Trade[]: a list of `trade structures <https://docs.ccxt_zagrava.com/#/?id=trade-structure>`
        """
        await self.load_markets()
        paginate = False
    ...
    async def fetch_deposits(self, code: Str = None, since: Int = None, limit: Int = None, params={}) -> List[Transaction]:
        ...
        if fiatOnly or (code in legalMoney):
            ...
            if since is not None:
                request['startTime'] = since
                # max 3 months range https://github.com/ccxt_zagrava/ccxt_zagrava/issues/6495
    ...
    async def fetch_transfers(self, code: Str = None, since: Int = None, limit: Int = None, params={}) -> TransferEntries:
        ...
        :returns dict[]: a list of `transfer structures <https://docs.ccxt_zagrava.com/#/?id=transfer-structure>`
        """
        await self.load_markets()
    ...
    async def fetch_deposit_address(self, code: str, params={}):
        ...
        :param str code: unified currency code
        :param dict [params]: extra parameters specific to the exchange API endpoint
        :returns dict: an `address structure <https://docs.ccxt_zagrava.com/#/?id=address-structure>`
        """
        await self.load_markets()
        currency = self.currency(code)
        request: dict = {
    ...
    async def fetch_transaction_fees(self, codes: Strings = None, params={}):
        ...
        :param dict [params]: extra parameters specific to the exchange API endpoint
        :returns dict[]: a list of `fee structures <https://docs.ccxt_zagrava.com/#/?id=fee-structure>`
        """
        await self.load_markets()
        response = await self.sapiGetCapitalConfigGetall(params)
        #
    ...
    async def withdraw(self, code: str, amount: float, address: str, tag=None, params={}):
        ...
        :param str tag:
        :param dict [params]: extra parameters specific to the exchange API endpoint
        :returns dict: a `transaction structure <https://docs.ccxt_zagrava.com/#/?id=transaction-structure>`
        """
    ...
    async def fetch_trading_fee(self, symbol: str, params={}) -> TradingFeeInterface:
        ...
        :param str [params.subType]: "linear" or "inverse"
        :returns dict: a `fee structure <https://docs.ccxt_zagrava.com/#/?id=fee-structure>`
        """
        await self.load_markets()
        market = self.market(symbol)
        type = market['type']
    ...
    async def fetch_trading_fees(self, params={}) -> TradingFees:
        ...
        :param dict [params]: extra parameters specific to the exchange API endpoint
        :param str [params.subType]: "linear" or "inverse"
        :returns dict: a dictionary of `fee structures <https://docs.ccxt_zagrava.com/#/?id=fee-structure>` indexed by market symbols
        """
        await self.load_markets()
        type = None
    ...
    async def futures_transfer(self, code: str, amount, type, params={}):
        ...
        :returns dict: a `transfer structure <https://docs.ccxt_zagrava.com/#/?id=futures-transfer-structure>`
        """
        if (type < 1) or (type > 4):
    ...
    async def fetch_funding_rate(self, symbol: str, params={}):
        ...
        :param str symbol: unified market symbol
        :param dict [params]: extra parameters specific to the exchange API endpoint
        :returns dict: a `funding rate structure <https://docs.ccxt_zagrava.com/#/?id=funding-rate-structure>`
        """
        await self.load_markets()
        market = self.market(symbol)
        request: dict = {
    ...
    async def fetch_funding_rate_history(self, symbol: Str = None, since: Int = None, limit: Int = None, params={}):
        ...
        :param int [limit]: the maximum amount of `funding rate structures <https://docs.ccxt_zagrava.com/#/?id=funding-rate-history-structure>` to fetch
        :param dict [params]: extra parameters specific to the exchange API endpoint
        :param int [params.until]: timestamp in ms of the latest funding rate
        :param boolean [params.paginate]: default False, when True will automatically paginate by calling self endpoint multiple times. See in the docs all the [availble parameters](https://github.com/ccxt_zagrava/ccxt_zagrava/wiki/Manual#pagination-params)
        :param str [params.subType]: "linear" or "inverse"
        :returns dict[]: a list of `funding rate structures <https://docs.ccxt_zagrava.com/#/?id=funding-rate-history-structure>`
        """
        await self.load_markets()
        request: dict = {}
        paginate = False
    ...
    async def fetch_funding_rates(self, symbols: Strings = None, params={}):
        ...
        :param dict [params]: extra parameters specific to the exchange API endpoint
        :param str [params.subType]: "linear" or "inverse"
        :returns dict: a dictionary of `funding rates structures <https://docs.ccxt_zagrava.com/#/?id=funding-rates-structure>`, indexe by market symbols
        """
        await self.load_markets()
    ...
    async def fetch_leverage_tiers(self, symbols: Strings = None, params={}) -> LeverageTiers:
        ...
        :param str [params.subType]: "linear" or "inverse"
        :returns dict: a dictionary of `leverage tiers structures <https://docs.ccxt_zagrava.com/#/?id=leverage-tiers-structure>`, indexed by market symbols
        """
        await self.load_markets()
        type = None
    ...
    async def fetch_position(self, symbol: str, params={}):
        ...
        :param dict [params]: extra parameters specific to the exchange API endpoint
        :returns dict: a `position structure <https://docs.ccxt_zagrava.com/#/?id=position-structure>`
        """
        await self.load_markets()
        market = self.market(symbol)
        if not market['option']:
    ...
    async def fetch_positions(self, symbols: Strings = None, params={}):
        ...
        :returns dict[]: a list of `position structure <https://docs.ccxt_zagrava.com/#/?id=position-structure>`
        """
    ...
    async def fetch_funding_history(self, symbol: Str = None, since: Int = None, limit: Int = None, params={}):
        ...
        :param str [params.subType]: "linear" or "inverse"
        :returns dict: a `funding history structure <https://docs.ccxt_zagrava.com/#/?id=funding-history-structure>`
        """
        await self.load_markets()
        market = None
        request: dict = {
    ...
    async def fetch_leverages(self, symbols: Strings = None, params={}) -> Leverages:
        ...
        :param dict [params]: extra parameters specific to the exchange API endpoint
        :param str [params.subType]: "linear" or "inverse"
        :returns dict: a list of `leverage structures <https://docs.ccxt_zagrava.com/#/?id=leverage-structure>`
        """
        await self.load_markets()
        await self.load_leverage_brackets(False, params)
        type = None
    ...
    async def fetch_settlement_history(self, symbol: Str = None, since: Int = None, limit: Int = None, params={}):
        ...
        :returns dict[]: a list of `settlement history objects <https://docs.ccxt_zagrava.com/#/?id=settlement-history-structure>`
        """
        await self.load_markets()
    ...
    async def fetch_ledger(self, code: Str = None, since: Int = None, limit: Int = None, params={}):
        ...
        :param str [params.subType]: "linear" or "inverse"
        :returns dict: a `ledger structure <https://docs.ccxt_zagrava.com/#/?id=ledger-structure>`
        """
        await self.load_markets()
        paginate = False
    ...
    def handle_errors(self, code: int, reason: str, url: str, method: str, headers: dict, body: str, response, requestHeaders, requestBody):
        ...
        if error is not None:
            # https://github.com/ccxt_zagrava/ccxt_zagrava/issues/6501
            # https://github.com/ccxt_zagrava/ccxt_zagrava/issues/7742
    ...
    async def reduce_margin(self, symbol: str, amount: float, params={}) -> MarginModification:
        ...
        :param dict [params]: extra parameters specific to the exchange API endpoint
        :returns dict: a `margin structure <https://docs.ccxt_zagrava.com/#/?id=reduce-margin-structure>`
        """
    ...
    async def add_margin(self, symbol: str, amount: float, params={}) -> MarginModification:
        ...
        :param dict [params]: extra parameters specific to the exchange API endpoint
        :returns dict: a `margin structure <https://docs.ccxt_zagrava.com/#/?id=add-margin-structure>`
        """
    ...
    async def fetch_cross_borrow_rate(self, code: str, params={}) -> CrossBorrowRate:
        ...
        :param str code: unified currency code
        :param dict [params]: extra parameters specific to the exchange API endpoint
        :returns dict: a `borrow rate structure <https://docs.ccxt_zagrava.com/#/?id=borrow-rate-structure>`
        """
        await self.load_markets()
        currency = self.currency(code)
        request: dict = {
    ...
    async def fetch_isolated_borrow_rate(self, symbol: str, params={}) -> IsolatedBorrowRate:
        ...
        :returns dict: an `isolated borrow rate structure <https://docs.ccxt_zagrava.com/#/?id=isolated-borrow-rate-structure>`
        """
        request: dict = {
            'symbol': symbol,
        }
    ...
    async def fetch_borrow_rate_history(self, code: str, since: Int = None, limit: Int = None, params={}):
        ...
        :param int [limit]: the maximum number of `borrow rate structures <https://docs.ccxt_zagrava.com/#/?id=borrow-rate-structure>` to retrieve
        :param dict [params]: extra parameters specific to the exchange API endpoint
        :returns dict[]: an array of `borrow rate structures <https://docs.ccxt_zagrava.com/#/?id=borrow-rate-structure>`
        """
        await self.load_markets()
        if limit is None:
            limit = 93
    ...
    async def fetch_borrow_interest(self, code: Str = None, symbol: Str = None, since: Int = None, limit: Int = None, params={}):
        ...
        :returns dict[]: a list of `borrow interest structures <https://docs.ccxt_zagrava.com/#/?id=borrow-interest-structure>`
        """
        await self.load_markets()
        isPortfolioMargin = None
    ...
    async def repay_cross_margin(self, code: str, amount, params={}):
        ...
        :returns dict: a `margin loan structure <https://docs.ccxt_zagrava.com/#/?id=margin-loan-structure>`
        """
        await self.load_markets()
        currency = self.currency(code)
        request: dict = {
    ...
    async def fetch_open_interest_history(self, symbol: str, timeframe='5m', since: Int = None, limit: Int = None, params={}):
        ...
        :param str symbol: Unified ccxt_zagrava market symbol
        ...
        :param boolean [params.paginate]: default False, when True will automatically paginate by calling self endpoint multiple times. See in the docs all the [availble parameters](https://github.com/ccxt_zagrava/ccxt_zagrava/wiki/Manual#pagination-params)
        :returns dict: an array of `open interest structure <https://docs.ccxt_zagrava.com/#/?id=open-interest-structure>`
        """
        if timeframe == '1m':
    ...
    async def fetch_open_interest(self, symbol: str, params={}):
        ...
        :param str symbol: unified ccxt_zagrava market symbol
        :param dict [params]: exchange specific parameters
        :returns dict} an open interest structure{@link https://docs.ccxt_zagrava.com/#/?id=open-interest-structure:
        """
        await self.load_markets()
        market = self.market(symbol)
        request: dict = {}
    ...
    async def fetch_my_liquidations(self, symbol: Str = None, since: Int = None, limit: Int = None, params={}):
        ...
        :param boolean [params.paginate]: *spot only* default False, when True will automatically paginate by calling self endpoint multiple times. See in the docs all the [available parameters](https://github.com/ccxt_zagrava/ccxt_zagrava/wiki/Manual#pagination-params)
    ...
    async def fetch_greeks(self, symbol: str, params={}) -> Greeks:
        ...
        :param dict [params]: extra parameters specific to the exchange API endpoint
        :returns dict: a `greeks structure <https://docs.ccxt_zagrava.com/#/?id=greeks-structure>`
        """
        await self.load_markets()
        market = self.market(symbol)
        request: dict = {
    ...
    async def fetch_margin_modes(self, symbols: Strings = None, params={}) -> MarginModes:
        ...
        :param dict [params]: extra parameters specific to the exchange API endpoint
        :param str [params.subType]: "linear" or "inverse"
        :returns dict: a list of `margin mode structures <https://docs.ccxt_zagrava.com/#/?id=margin-mode-structure>`
        """
        await self.load_markets()
        market = None
        if symbols is not None:
    ...
    async def fetch_option(self, symbol: str, params={}) -> Option:
        ...
        :param str symbol: unified market symbol
        :param dict [params]: extra parameters specific to the exchange API endpoint
        :returns dict: an `option chain structure <https://docs.ccxt_zagrava.com/#/?id=option-chain-structure>`
        """
        await self.load_markets()
        market = self.market(symbol)
        request: dict = {
    ...
    async def fetch_convert_quote(self, fromCode: str, toCode: str, amount: Num = None, params={}) -> Conversion:
        ...
        :returns dict: a `conversion structure <https://docs.ccxt_zagrava.com/#/?id=conversion-structure>`
        """
        if amount is None:
    ...
    async def fetch_convert_trade_history(self, code: Str = None, since: Int = None, limit: Int = None, params={}) -> List[Conversion]:
        ...
        :returns dict[]: a list of `conversion structures <https://docs.ccxt_zagrava.com/#/?id=conversion-structure>`
        """
        await self.load_markets()
        request: dict = {}
