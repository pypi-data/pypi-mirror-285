...
from ccxt_zagrava.abstract.cex import ImplicitAPI
import hashlib
import json
...
class cex(Exchange, ImplicitAPI):
    ...
    def parse_balance(self, response) -> Balances:
        ...
        for i in range(0, len(currencyIds)):
            ...
            # https://github.com/ccxt_zagrava/ccxt_zagrava/issues/5484
    ...
    def parse_order(self, order: dict, market: Market = None) -> Order:
        ...
        # https://github.com/ccxt_zagrava/ccxt_zagrava/issues/5338
