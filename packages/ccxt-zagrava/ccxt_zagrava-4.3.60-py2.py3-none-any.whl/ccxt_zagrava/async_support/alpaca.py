...
from ccxt_zagrava.abstract.alpaca import ImplicitAPI
from ccxt_zagrava.base.types import Int, Market, Num, Order, OrderBook, OrderSide, OrderType, Str, Trade
...
class alpaca(Exchange, ImplicitAPI):
    ...
    def describe(self):
        return self.deep_extend(super(alpaca, self).describe(), {
            ...
            'options': {
                ...
                'clientOrderId': 'ccxt_zagrava_{id}',
            },
            'exceptions': {
                'exact': {
    ...
    async def fetch_orders(self, symbol: Str = None, since: Int = None, limit: Int = None, params={}) -> List[Order]:
        ...
        #           "client_order_id": "ccxt_zagrava_b36156ae6fd44d098ac9c179bab33efd",
    ...
    def parse_order(self, order: dict, market: Market = None) -> Order:
        ...
        #        "client_order_id":"ccxt_zagrava_1c6ceab0b5e84727b2f1c0394ba17560",
