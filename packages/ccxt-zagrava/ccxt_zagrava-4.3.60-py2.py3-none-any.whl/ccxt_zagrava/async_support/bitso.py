...
from ccxt_zagrava.abstract.bitso import ImplicitAPI
import hashlib
from ccxt_zagrava.base.types import Balances, Currency, Int, Market, Num, Order, OrderBook, OrderSide, OrderType, Str, Strings, Ticker, Trade, TradingFees, Transaction
...
class bitso(Exchange, ImplicitAPI):
    ...
    def parse_order_status(self, status: Str):
        statuses: dict = {
            'partial-fill': 'open',  # self is a common substitution in ccxt_zagrava
