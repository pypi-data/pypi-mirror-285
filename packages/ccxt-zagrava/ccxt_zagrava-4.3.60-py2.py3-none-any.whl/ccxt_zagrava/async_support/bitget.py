...
from ccxt_zagrava.abstract.bitget import ImplicitAPI
import asyncio
import hashlib
import json
from ccxt_zagrava.base.types import Balances, Conversion, CrossBorrowRate, Currencies, Currency, FundingHistory, Int, IsolatedBorrowRate, Leverage, LeverageTier, Liquidation, MarginMode, MarginModification, Market, Num, Order, OrderBook, OrderRequest, OrderSide, OrderType, Position, Str, Strings, Ticker, Tickers, Trade, TradingFeeInterface, TradingFees, Transaction, TransferEntry, TransferEntries
...
class bitget(Exchange, ImplicitAPI):
    ...
    def describe(self):
        return self.deep_extend(super(bitget, self).describe(), {
            ...
            'urls': {
                ...
                'referral': 'https://www.bitget.com/expressly?languageType=0&channelCode=ccxt_zagrava&vipCode=tg9j',
            },
            'api': {
                'public': {
                    'common': {
    ...
    def parse_balance(self, balance) -> Balances:
        ...
        for i in range(0, len(balance)):
            ...
            if borrow is not None:
                ...
                # Use transferable instead of available for swap and margin https://github.com/ccxt_zagrava/ccxt_zagrava/pull/19127
    ...
    async def cancel_orders(self, ids, symbol: Str = None, params={}):
        ...
        :returns dict: an array of `order structures <https://docs.ccxt_zagrava.com/#/?id=order-structure>`
        """
        if symbol is None:
    ...
    async def fetch_funding_history(self, symbol: Str = None, since: Int = None, limit: Int = None, params={}) -> List[FundingHistory]:
        ...
        :param boolean [params.paginate]: default False, when True will automatically paginate by calling self endpoint multiple times. See in the docs all the [available parameters](https://github.com/ccxt_zagrava/ccxt_zagrava/wiki/Manual#pagination-params)
        :returns dict[]: a list of `funding history structures <https://docs.ccxt_zagrava.com/#/?id=funding-history-structure>`
        """
        await self.load_markets()
        if symbol is None:
    ...
    async def transfer(self, code: str, amount: float, fromAccount: str, toAccount: str, params={}) -> TransferEntry:
        ...
        :param dict [params]: extra parameters specific to the exchange API endpoint
        :param str [params.symbol]: unified ccxt_zagrava market symbol, required when transferring to or from an account type that is a leveraged position-by-position account
    ...
    async def fetch_cross_borrow_rate(self, code: str, params={}) -> CrossBorrowRate:
        ...
        :returns dict: a `borrow rate structure <https://github.com/ccxt_zagrava/ccxt_zagrava/wiki/Manual#borrow-rate-structure>`
        """
        await self.load_markets()
        currency = self.currency(code)
        request: dict = {
    ...
    async def fetch_margin_mode(self, symbol: str, params={}) -> MarginMode:
        ...
        :param dict [params]: extra parameters specific to the exchange API endpoint
        :returns dict: a `margin mode structure <https://docs.ccxt_zagrava.com/#/?id=margin-mode-structure>`
        """
        await self.load_markets()
        sandboxMode = self.safe_bool(self.options, 'sandboxMode', False)
        market = None
