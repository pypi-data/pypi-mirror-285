...
from ccxt_zagrava.abstract.krakenfutures import ImplicitAPI
import hashlib
from ccxt_zagrava.base.types import Balances, Currency, Int, Leverage, Leverages, LeverageTier, LeverageTiers, Market, Num, Order, OrderBook, OrderRequest, OrderSide, OrderType, Str, Strings, Ticker, Tickers, Trade, TransferEntry
...
class krakenfutures(Exchange, ImplicitAPI):
    ...
    async def fetch_order_book(self, symbol: str, limit: Int = None, params={}) -> OrderBook:
        ...
        :param dict [params]: exchange specific params
        :returns: An `order book structure <https://docs.ccxt_zagrava.com/#/?id=order-book-structure>`
        """
    ...
    async def fetch_trades(self, symbol: str, since: Int = None, limit: Int = None, params={}) -> List[Trade]:
        ...
        :returns: An array of `trade structures <https://docs.ccxt_zagrava.com/#/?id=trade-structure>`
        """
        await self.load_markets()
        paginate = False
    ...
    async def fetch_open_orders(self, symbol: Str = None, since: Int = None, limit: Int = None, params={}) -> List[Order]:
        ...
        :param str symbol: Unified market symbol
        :param int [since]: Timestamp(ms) of earliest order.(Not used by kraken api but filtered internally by ccxt_zagrava)
        :param int [limit]: How many orders to return.(Not used by kraken api but filtered internally by ccxt_zagrava)
    ...
    async def fetch_balance(self, params={}) -> Balances:
        ...
        :returns: A `balance structure <https://docs.ccxt_zagrava.com/#/?id=balance-structure>`
        """
        await self.load_markets()
    ...
    async def fetch_funding_rates(self, symbols: Strings = None, params={}):
        ...
        :param dict [params]: extra parameters specific to the exchange API endpoint
        :returns Order[]: an array of `funding rate structures <https://docs.ccxt_zagrava.com/#/?id=funding-rate-structure>`
        """
        await self.load_markets()
    ...
    def parse_market_leverage_tiers(self, info, market: Market = None) -> List[LeverageTier]:
         ...
         * @param market ccxt_zagrava market
        """
        #
        #    {
        #        "symbol": "fi_ethusd_180928",
