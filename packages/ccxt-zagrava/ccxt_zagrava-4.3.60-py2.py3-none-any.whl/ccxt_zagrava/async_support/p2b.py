...
from ccxt_zagrava.abstract.p2b import ImplicitAPI
import hashlib
from ccxt_zagrava.base.types import Int, Market, Num, Order, OrderSide, OrderType, Str, Strings, Ticker, Tickers
    ...
    def describe(self):
        return self.deep_extend(super(p2b, self).describe(), {
            ...
            'urls': {
                ...
                'logo': 'https://github.com/ccxt_zagrava/ccxt_zagrava/assets/43336371/8da13a80-1f0a-49be-bb90-ff8b25164755',
                'api': {
