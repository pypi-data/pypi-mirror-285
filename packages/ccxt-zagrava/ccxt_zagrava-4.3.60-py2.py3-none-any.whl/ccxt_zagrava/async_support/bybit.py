...
from ccxt_zagrava.abstract.bybit import ImplicitAPI
import asyncio
import hashlib
from ccxt_zagrava.base.types import Balances, CrossBorrowRate, Currencies, Currency, Greeks, Int, Leverage, LeverageTier, LeverageTiers, Market, MarketInterface, Num, Option, OptionChain, Order, OrderBook, OrderRequest, CancellationRequest, OrderSide, OrderType, Position, Str, Strings, Ticker, Tickers, Trade, TradingFeeInterface, TradingFees, Transaction, TransferEntry, TransferEntries
...
from ccxt_zagrava.base.errors import NoChange
...
class bybit(Exchange, ImplicitAPI):
    ...
    async def fetch_tickers(self, symbols: Strings = None, params={}) -> Tickers:
        ...
        :returns dict: an array of `ticker structures <https://docs.ccxt_zagrava.com/#/?id=ticker-structure>`
        """
        await self.load_markets()
        market = None
        parsedSymbols = None
    ...
    async def fetch_funding_rates(self, symbols: Strings = None, params={}):
        ...
        :param dict [params]: extra parameters specific to the exchange API endpoint
        :returns dict: an array of `funding rate structures <https://docs.ccxt_zagrava.com/#/?id=funding-rate-structure>`
        """
        await self.load_markets()
        market = None
        request: dict = {}
    ...
    def parse_order_status(self, status: Str):
        statuses: dict = {
            ...
            'PENDING_NEW': 'open',
            'REJECTED': 'rejected',
            'PARTIALLY_FILLED_CANCELLED': 'closed',  # context: https://github.com/ccxt_zagrava/ccxt_zagrava/issues/18685
            # v3 contract / unified margin / unified account
            'Created': 'open',
            'New': 'open',
            'Rejected': 'rejected',  # order is triggered but failed upon being placed
            'PartiallyFilled': 'open',
            'PartiallyFilledCanceled': 'closed',  # context: https://github.com/ccxt_zagrava/ccxt_zagrava/issues/18685
            'Filled': 'closed',
            'PendingCancel': 'open',
            'Cancelled': 'canceled',
    ...
    async def fetch_volatility_history(self, code: str, params={}):
        ...
        :returns dict[]: a list of `volatility history objects <https://docs.ccxt_zagrava.com/#/?id=volatility-structure>`
        """
        await self.load_markets()
        currency = self.currency(code)
        request: dict = {
