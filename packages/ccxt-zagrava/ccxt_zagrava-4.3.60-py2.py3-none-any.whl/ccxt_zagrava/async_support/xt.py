...
from ccxt_zagrava.abstract.xt import ImplicitAPI
import asyncio
import hashlib
from ccxt_zagrava.base.types import Currencies, Currency, Int, LeverageTier, MarginModification, Market, Num, Order, OrderSide, OrderType, Str, Tickers, Transaction, TransferEntry
...
class xt(Exchange, ImplicitAPI):
    ...
    async def fetch_order_book(self, symbol: str, limit: Int = None, params={}):
        ...
        :param dict params: extra parameters specific to the xt api endpoint
        :returns dict: A dictionary of `order book structures <https://docs.ccxt_zagrava.com/en/latest/manual.html#order-book-structure>` indexed by market symbols
        """
        await self.load_markets()
        market = self.market(symbol)
        request = {
    ...
    async def fetch_ticker(self, symbol: str, params={}):
        ...
        :param dict params: extra parameters specific to the xt api endpoint
        :returns dict: a `ticker structure <https://docs.ccxt_zagrava.com/en/latest/manual.html#ticker-structure>`
        """
        await self.load_markets()
        market = self.market(symbol)
        request = {
    ...
    async def fetch_tickers(self, symbols: List[str] = None, params={}) -> Tickers:
        ...
        :param dict params: extra parameters specific to the xt api endpoint
        :returns dict: an array of `ticker structures <https://docs.ccxt_zagrava.com/en/latest/manual.html#ticker-structure>`
        """
        await self.load_markets()
        market = None
    ...
    async def fetch_bids_asks(self, symbols: List[str] = None, params={}):
        ...
        :param dict params: extra parameters specific to the xt api endpoint
        :returns dict: a dictionary of `ticker structures <https://docs.ccxt_zagrava.com/en/latest/manual.html#ticker-structure>`
        """
        await self.load_markets()
        symbols = self.market_symbols(symbols)
        request = {}
    ...
    async def fetch_trades(self, symbol: str, since: Int = None, limit: Int = None, params={}):
        ...
        :param dict params: extra parameters specific to the xt api endpoint
        :returns dict[]: a list of `trade structures <https://docs.ccxt_zagrava.com/en/latest/manual.html?#public-trades>`
        """
        await self.load_markets()
        market = self.market(symbol)
        request = {
    ...
    async def fetch_balance(self, params={}):
        ...
        :param dict params: extra parameters specific to the xt api endpoint
        :returns dict: a `balance structure <https://docs.ccxt_zagrava.com/en/latest/manual.html?#balance-structure>`
        """
        await self.load_markets()
        type = None
        subType = None
    ...
    async def create_order(self, symbol: str, type: OrderType, side: OrderSide, amount: float, price: Num = None, params={}):
        ...
        :returns dict: an `order structure <https://docs.ccxt_zagrava.com/en/latest/manual.html#order-structure>`
        """
        await self.load_markets()
        market = self.market(symbol)
        symbol = market['symbol']
    ...
    async def fetch_orders(self, symbol: str = None, since: Int = None, limit: Int = None, params={}):
        ...
        :param dict params: extra parameters specific to the xt api endpoint
        :param bool [params.stop]: if the order is a stop trigger order or not
        :returns dict[]: a list of `order structures <https://docs.ccxt_zagrava.com/en/latest/manual.html#order-structure>`
        """
        await self.load_markets()
        request = {}
        market = None
    ...
    async def fetch_ledger(self, code: str = None, since: Int = None, limit: Int = None, params={}):
        ...
        :param dict params: extra parameters specific to the xt api endpoint
        :returns dict: a `ledger structure <https://docs.ccxt_zagrava.com/en/latest/manual.html#ledger-structure>`
        """
        await self.load_markets()
        request = {}
        currency = None
    ...
    async def fetch_deposit_address(self, code: str, params={}):
        ...
        :returns dict: an `address structure <https://docs.ccxt_zagrava.com/en/latest/manual.html#address-structure>`
        """
        await self.load_markets()
        networkCode = None
    ...
    async def fetch_deposits(self, code: str = None, since: Int = None, limit: Int = None, params={}):
        ...
        :param dict params: extra parameters specific to the xt api endpoint
        :returns dict[]: a list of `transaction structures <https://docs.ccxt_zagrava.com/en/latest/manual.html#transaction-structure>`
        """
        await self.load_markets()
        request = {}
        currency = None
    ...
    async def withdraw(self, code: str, amount: float, address: str, tag=None, params={}):
        ...
        :param str [tag]:
        :param dict params: extra parameters specific to the xt api endpoint
        :returns dict: a `transaction structure <https://docs.ccxt_zagrava.com/en/latest/manual.html#transaction-structure>`
        """
        self.check_address(address)
        await self.load_markets()
        currency = self.currency(code)
    ...
    async def fetch_leverage_tiers(self, symbols: List[str] = None, params={}):
        ...
        :param dict params: extra parameters specific to the xt api endpoint
        :returns dict: a dictionary of `leverage tiers structures <https://docs.ccxt_zagrava.com/#/?id=leverage-tiers-structure>`
        """
        await self.load_markets()
        subType = None
    ...
    async def fetch_funding_rate_history(self, symbol: str = None, since: Int = None, limit: Int = None, params={}):
        ...
        :param dict params: extra parameters specific to the xt api endpoint
        :returns dict[]: a list of `funding rate structures <https://docs.ccxt_zagrava.com/en/latest/manual.html?#funding-rate-history-structure>`
        """
        if symbol is None:
