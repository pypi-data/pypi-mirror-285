...
from ccxt_zagrava.abstract.mexc import ImplicitAPI
import hashlib
from ccxt_zagrava.base.types import Account, Balances, Currencies, Currency, IndexType, Int, Leverage, LeverageTier, LeverageTiers, MarginModification, Market, Num, Order, OrderBook, OrderRequest, OrderSide, OrderType, Position, Str, Strings, Ticker, Tickers, Trade, TradingFees, Transaction, TransferEntry, TransferEntries
...
class mexc(Exchange, ImplicitAPI):
    ...
    async def fetch_funding_rate_history(self, symbol: Str = None, since: Int = None, limit: Int = None, params={}):
        ...
        :param int [since]: not used by mexc, but filtered internally by ccxt_zagrava
        ...
        if section == 'spot' or section == 'broker':
            ...
            if access == 'private':
                ...
                headers = {
                    ...
                    'source': self.safe_string(self.options, 'broker', 'ccxt_zagrava'),
                }
