...
from ccxt_zagrava.base.types import Balances, Int, Order, OrderBook, Str
from ccxt_zagrava.async_support.base.ws.client import Client
from typing import List


class bitrue(ccxt_zagrava.async_support.bitrue):
    ...
    async def watch_orders(self, symbol: Str = None, since: Int = None, limit: Int = None, params={}) -> List[Order]:
        ...
        :param dict [params]: extra parameters specific to the exchange API endpoint
        :returns dict: A dictionary of `order structure <https://docs.ccxt_zagrava.com/#/?id=order-structure>` indexed by market symbols
        """
