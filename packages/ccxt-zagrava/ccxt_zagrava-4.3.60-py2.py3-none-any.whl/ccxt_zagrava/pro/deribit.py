...
class deribit(ccxt_zagrava.async_support.deribit):
    ...
    def handle_authentication_message(self, client: Client, message):
        ...
        #         "result": {
        #             "token_type": "bearer",
        #             "scope": "account:read_write block_trade:read_write connection custody:read_write mainaccount name:ccxt_zagrava trade:read_write wallet:read_write",
