...
import hashlib
from ccxt_zagrava.base.types import Balances, Int, Market, Num, Order, OrderBook, OrderSide, OrderType, Position, Str, Strings, Ticker, Tickers, Trade
...
class oxfun(ccxt_zagrava.async_support.oxfun):
