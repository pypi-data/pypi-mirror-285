...
project_urls = {
    'Homepage': 'https://ccxt_zagrava.com',
    'Documentation': 'https://github.com/ccxt_zagrava/ccxt_zagrava/wiki',
    'Discord': 'https://discord.gg/ccxt_zagrava',
    'Twitter': 'https://twitter.com/ccxt_zagrava_official',
    'Funding': 'https://opencollective.com/ccxt_zagrava',
}
...
setup(
    ...
    packages=find_packages(exclude=['ccxt_zagrava.async_support*'] if is_python_2 else []),
