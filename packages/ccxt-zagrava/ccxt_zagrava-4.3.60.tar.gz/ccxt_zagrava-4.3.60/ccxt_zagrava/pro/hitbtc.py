...
import hashlib
from ccxt_zagrava.base.types import Balances, Int, Num, Order, OrderBook, OrderSide, OrderType, Str, Strings, Ticker, Tickers, Trade
...
class hitbtc(ccxt_zagrava.async_support.hitbtc):
    ...
    async def subscribe_public(self, name: str, messageHashPrefix: str, symbols: Strings = None, params={}):
        ...
        :param str[] [symbols]: unified ccxt_zagrava symbol(s)
    ...
    async def subscribe_private(self, name: str, symbol: Str = None, params={}):
         ...
         * @ignore
        :param str name: websocket endpoint name
        :param str [symbol]: unified ccxt_zagrava symbol
        :param dict [params]: extra parameters specific to the hitbtc api
        """
        await self.load_markets()
    ...
    async def watch_balance(self, params={}) -> Balances:
        ...
        :returns dict[]: a list of `balance structures <https://docs.ccxt_zagrava.com/#/?id=balance-structure>`
        """
        await self.load_markets()
        type = None
