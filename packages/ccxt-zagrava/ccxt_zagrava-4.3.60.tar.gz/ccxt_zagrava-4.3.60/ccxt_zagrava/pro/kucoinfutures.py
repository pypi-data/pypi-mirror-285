...
class kucoinfutures(ccxt_zagrava.async_support.kucoinfutures):
    ...
    async def watch_position(self, symbol: Str = None, params={}) -> Position:
        ...
        :param dict params: extra parameters specific to the exchange API endpoint
        :returns dict: a `position structure <https://docs.ccxt_zagrava.com/en/latest/manual.html#position-structure>`
        """
        if symbol is None:
