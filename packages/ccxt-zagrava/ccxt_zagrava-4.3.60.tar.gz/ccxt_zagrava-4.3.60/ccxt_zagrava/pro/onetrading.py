...
from ccxt_zagrava.async_support.base.ws.cache import ArrayCacheBySymbolById, ArrayCacheByTimestamp
...
class onetrading(ccxt_zagrava.async_support.onetrading):
    ...
    async def watch_tickers(self, symbols: Strings = None, params={}) -> Tickers:
        ...
        :param dict [params]: extra parameters specific to the exchange API endpoint
        :returns dict: an array of `ticker structure <https://docs.ccxt_zagrava.com/#/?id=ticker-structure>`
        """
        await self.load_markets()
