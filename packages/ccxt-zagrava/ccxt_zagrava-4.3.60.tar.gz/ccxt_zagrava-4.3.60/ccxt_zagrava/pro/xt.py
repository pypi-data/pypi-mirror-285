...
from ccxt_zagrava.base.types import Balances, Int, Market, Order, OrderBook, Str, Strings, Ticker, Tickers, Trade
from ccxt_zagrava.async_support.base.ws.client import Client
from typing import List


class xt(ccxt_zagrava.async_support.xt):
    ...
    async def subscribe(self, name: str, access: str, methodName: str, market: Market = None, symbols: List[str] = None, params={}):
        ...
        :param str methodName: the name of the ccxt_zagrava class method
