...
class poloniex(ccxt_zagrava.async_support.poloniex):
    ...
    async def subscribe(self, name: str, messageHash: str, isPrivate: bool, symbols: Strings = None, params={}):
        ...
        :param str[]|None symbols: ccxt_zagrava market symbols
    ...
    async def cancel_order_ws(self, id: str, symbol: Str = None, params={}):
        ...
        :returns dict: an list of `order structures <https://github.com/ccxt_zagrava/ccxt_zagrava/wiki/Manual#order-structure>`
        """
