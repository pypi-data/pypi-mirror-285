...
import hashlib
from ccxt_zagrava.base.types import Balances, Int, Liquidation, Order, OrderBook, Position, Str, Strings, Ticker, Tickers, Trade
...
class bitmex(ccxt_zagrava.async_support.bitmex):
    ...
    def handle_ohlcv(self, client: Client, message):
        ...
        for i in range(0, len(candles)):
            ...
            result = [
                ...
                None,  # set open price to None, see: https://github.com/ccxt_zagrava/ccxt_zagrava/pull/21356#issuecomment-1969565862
