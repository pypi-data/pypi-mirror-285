...
class bitteam(Exchange, ImplicitAPI):
    ...
    def fetch_markets(self, params={}) -> List[Market]:
        ...
        """
        response = self.publicGetTradeApiccxt_zagravaPairs(params)
        #
        #     {
        #         "ok": True,
        #         "result": {
    ...
    def fetch_orders(self, symbol: Str = None, since: Int = None, limit: Int = None, params={}) -> List[Order]:
        ...
        if limit is not None:
            request['limit'] = limit
        response = self.privateGetTradeApiccxt_zagravaOrdersOfUser(self.extend(request, params))
        #
        #     {
        #         "ok": True,
        #         "result": {
    ...
    def fetch_order(self, id: str, symbol: Str = None, params={}) -> Order:
        ...
        if symbol is not None:
            market = self.market(symbol)
        response = self.privateGetTradeApiccxt_zagravaOrderId(self.extend(request, params))
        #
        #     {
        #         "ok": True,
        #         "result": {
    ...
    def create_order(self, symbol: str, type: OrderType, side: OrderSide, amount: float, price: Num = None, params={}):
        ...
        response = self.privatePostTradeApiccxt_zagravaOrdercreate(self.extend(request, params))
        #
        #     {
        #         "ok": True,
        #         "result": {
    ...
    def cancel_order(self, id: str, symbol: Str = None, params={}):
        ...
        response = self.privatePostTradeApiccxt_zagravaCancelorder(self.extend(request, params))
        #
        #     {
        #         "ok": True,
        #         "result": {
    ...
    def cancel_all_orders(self, symbol: Str = None, params={}):
        ...
        response = self.privatePostTradeApiccxt_zagravaCancelAllOrder(self.extend(request, params))
        #
        #     {
        #         "ok": True,
        #         "result": {
    ...
    def fetch_my_trades(self, symbol: Str = None, since: Int = None, limit: Int = None, params={}):
        ...
        if limit is not None:
            request['limit'] = limit
        response = self.privateGetTradeApiccxt_zagravaTradesOfUser(self.extend(request, params))
        #
        #     {
        #         "ok": True,
        #         "result": {
    ...
    def fetch_balance(self, params={}) -> Balances:
        ...
        """
        self.load_markets()
        response = self.privateGetTradeApiccxt_zagravaBalance(params)
