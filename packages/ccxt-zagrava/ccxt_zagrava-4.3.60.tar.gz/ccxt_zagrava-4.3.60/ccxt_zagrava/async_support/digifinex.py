...
from ccxt_zagrava.abstract.digifinex import ImplicitAPI
import asyncio
import hashlib
import json
from ccxt_zagrava.base.types import Balances, CrossBorrowRate, CrossBorrowRates, Currencies, Currency, Int, LeverageTier, LeverageTiers, MarginModification, Market, Num, Order, OrderBook, OrderRequest, OrderSide, OrderType, Str, Strings, Ticker, Tickers, Trade, TradingFeeInterface, Transaction, TransferEntry, TransferEntries
...
class digifinex(Exchange, ImplicitAPI):
    ...
    async def add_margin(self, symbol: str, amount: float, params={}) -> MarginModification:
        ...
        :returns dict: a `margin structure <https://docs.ccxt_zagrava.com/#/?id=margin-structure>`
        """
        side = self.safe_string(params, 'side')
