...
from ccxt_zagrava.abstract.bitrue import ImplicitAPI
import asyncio
import hashlib
import json
from ccxt_zagrava.base.types import Balances, Currencies, Currency, Int, MarginModification, Market, Num, Order, OrderBook, OrderSide, OrderType, Str, Strings, Ticker, Tickers, Trade, Transaction, TransferEntry, TransferEntries
...
class bitrue(Exchange, ImplicitAPI):
    ...
    async def fetch_tickers(self, symbols: Strings = None, params={}) -> Tickers:
        ...
        # https://github.com/ccxt_zagrava/ccxt_zagrava/issues/13856
        tickers: dict = {}
    ...
    async def fetch_transfers(self, code: Str = None, since: Int = None, limit: Int = None, params={}) -> TransferEntries:
        ...
        :returns dict[]: a list of `transfer structures <https://github.com/ccxt_zagrava/ccxt_zagrava/wiki/Manual#transfer-structure>`
        """
        await self.load_markets()
    ...
    async def transfer(self, code: str, amount: float, fromAccount: str, toAccount: str, params={}) -> TransferEntry:
        ...
        :param dict [params]: extra parameters specific to the exchange API endpoint
        :returns dict: a `transfer structure <https://github.com/ccxt_zagrava/ccxt_zagrava/wiki/Manual#transfer-structure>`
        """
        await self.load_markets()
        currency = self.currency(code)
