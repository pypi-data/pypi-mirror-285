...
from ccxt_zagrava.abstract.bitvavo import ImplicitAPI
import hashlib
from ccxt_zagrava.base.types import Balances, Currencies, Currency, Int, Market, Num, Order, OrderBook, OrderSide, OrderType, Str, Strings, Ticker, Tickers, Trade, TradingFees, Transaction
...
class bitvavo(Exchange, ImplicitAPI):
    ...
    def describe(self):
        return self.deep_extend(super(bitvavo, self).describe(), {
            ...
            'commonCurrencies': {
                'MIOTA': 'IOTA',  # https://github.com/ccxt_zagrava/ccxt_zagrava/issues/7487
            },
        })
    ...
    def fetch_ohlcv_request(self, symbol: Str, timeframe='1m', since: Int = None, limit: Int = None, params={}):
        ...
        if since is not None:
            # https://github.com/ccxt_zagrava/ccxt_zagrava/issues/9227
    ...
    def parse_order_status(self, status: Str):
        statuses: dict = {
            ...
            'expired': 'canceled',
            'rejected': 'canceled',
            'awaitingTrigger': 'open',  # https://github.com/ccxt_zagrava/ccxt_zagrava/issues/8489
        }
    ...
    def parse_order(self, order: dict, market: Market = None) -> Order:
        ...
        # https://github.com/ccxt_zagrava/ccxt_zagrava/issues/8489
