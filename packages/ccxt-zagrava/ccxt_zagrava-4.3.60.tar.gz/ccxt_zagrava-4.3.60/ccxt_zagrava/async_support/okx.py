...
from ccxt_zagrava.abstract.okx import ImplicitAPI
import asyncio
import hashlib
from ccxt_zagrava.base.types import Account, Balances, Conversion, CrossBorrowRate, CrossBorrowRates, Currencies, Currency, Greeks, Int, Leverage, LeverageTier, MarginModification, Market, MarketInterface, Num, Option, OptionChain, Order, OrderBook, OrderRequest, CancellationRequest, OrderSide, OrderType, Position, Str, Strings, Ticker, Tickers, Trade, TradingFeeInterface, Transaction, TransferEntry, TransferEntries
...
from ccxt_zagrava.base.errors import AccountNotEnabled
...
from ccxt_zagrava.base.errors import ContractUnavailable
...
from ccxt_zagrava.base.errors import CancelPending
...
class okx(Exchange, ImplicitAPI):
        ...
        return self.deep_extend(super(okx, self).describe(), {
            ...
            'urls': {
                ...
                'referral': {
                    ...
                    # new reflink 20% discount https://www.okx.com/join/ccxt_zagrava2023
                    'url': 'https://www.okx.com/join/ccxt_zagrava2023',
                    'discount': 0.2,
                },
                'test': {
                    'rest': 'https://{hostname}',
            ...
            'httpExceptions': {
                '429': ExchangeNotAvailable,  # https://github.com/ccxt_zagrava/ccxt_zagrava/issues/9612
            },
            ...
            'commonCurrencies': {
                ...
                'AE': 'AET',  # https://github.com/ccxt_zagrava/ccxt_zagrava/issues/4981
                'WIN': 'WINTOKEN',  # https://github.com/ccxt_zagrava/ccxt_zagrava/issues/5701
            },
        })
    ...
    async def fetch_accounts(self, params={}) -> List[Account]:
        ...
        :param dict [params]: extra parameters specific to the exchange API endpoint
        :returns dict: a dictionary of `account structures <https://docs.ccxt_zagrava.com/#/?id=account-structure>` indexed by the account type
        """
    ...
    async def fetch_order(self, id: str, symbol: Str = None, params={}):
        ...
        :returns: `an order structure <https://docs.ccxt_zagrava.com/#/?id=order-structure>`
        """
        if symbol is None:
    ...
    async def fetch_deposit_addresses_by_network(self, code: str, params={}):
        ...
        :param dict [params]: extra parameters specific to the exchange API endpoint
        :returns dict: a dictionary of `address structures <https://docs.ccxt_zagrava.com/#/?id=address-structure>` indexed by the network
        """
        await self.load_markets()
        currency = self.currency(code)
        request: dict = {
    ...
    async def fetch_leverage(self, symbol: str, params={}) -> Leverage:
        ...
        :param dict [params]: extra parameters specific to the exchange API endpoint
        :param str [params.marginMode]: 'cross' or 'isolated'
        :returns dict: a `leverage structure <https://docs.ccxt_zagrava.com/#/?id=leverage-structure>`
        """
        await self.load_markets()
        marginMode = None
    ...
    async def fetch_cross_borrow_rates(self, params={}) -> CrossBorrowRates:
        ...
        :param dict [params]: extra parameters specific to the exchange API endpoint
        :returns dict: a list of `borrow rate structures <https://docs.ccxt_zagrava.com/#/?id=borrow-rate-structure>`
        """
        await self.load_markets()
    ...
    async def fetch_borrow_rate_histories(self, codes=None, since: Int = None, limit: Int = None, params={}):
        ...
        :param dict [params]: extra parameters specific to the exchange API endpoint
        :returns dict: a dictionary of `borrow rate structures <https://docs.ccxt_zagrava.com/#/?id=borrow-rate-structure>` indexed by the market symbol
        """
        await self.load_markets()
        request: dict = {
            # 'ccy': currency['id'],
    ...
    async def fetch_market_leverage_tiers(self, symbol: str, params={}) -> List[LeverageTier]:
        ...
        :param dict [params]: extra parameters specific to the exchange API endpoint
        :param str [params.marginMode]: 'cross' or 'isolated'
        :returns dict: a `leverage tiers structure <https://docs.ccxt_zagrava.com/#/?id=leverage-tiers-structure>`
        """
        await self.load_markets()
        market = self.market(symbol)
    ...
    async def fetch_borrow_interest(self, code: Str = None, symbol: Str = None, since: Int = None, limit: Int = None, params={}):
        ...
        :param int [limit]: the number of `borrow interest structures <https://docs.ccxt_zagrava.com/#/?id=borrow-interest-structure>` to retrieve
        :param dict [params]: exchange specific parameters
        :param int [params.type]: Loan type 1 - VIP loans 2 - Market loans *Default is Market loans*
        :param str [params.marginMode]: 'cross' or 'isolated'
        :returns dict[]: An list of `borrow interest structures <https://docs.ccxt_zagrava.com/#/?id=borrow-interest-structure>`
        """
        await self.load_markets()
        marginMode = None
    ...
    async def fetch_open_interest_history(self, symbol: str, timeframe='1d', since: Int = None, limit: Int = None, params={}):
        ...
        :param str symbol: Unified ccxt_zagrava currency code or unified symbol
        ...
        :param int [limit]: Not used by okx, but parsed internally by ccxt_zagrava
        :param dict [params]: Exchange specific parameters
        :param int [params.until]: The time in ms of the latest record to retrieve unix timestamp
        :returns: An array of `open interest structures <https://docs.ccxt_zagrava.com/#/?id=open-interest-structure>`
        """
    ...
    async def fetch_deposit_withdraw_fees(self, codes: Strings = None, params={}):
        ...
        :param dict [params]: extra parameters specific to the exchange API endpoint
        :returns dict[]: a list of `fees structures <https://docs.ccxt_zagrava.com/#/?id=fee-structure>`
        """
        await self.load_markets()
        response = await self.privateGetAssetCurrencies(params)
        #
    ...
    async def fetch_underlying_assets(self, params={}):
        ...
        :returns dict[]: a list of `underlying assets <https://docs.ccxt_zagrava.com/#/?id=underlying-assets-structure>`
        """
        await self.load_markets()
        marketType = None
    ...
    async def fetch_option_chain(self, code: str, params={}) -> OptionChain:
        ...
        :returns dict: a list of `option chain structures <https://docs.ccxt_zagrava.com/#/?id=option-chain-structure>`
        """
        await self.load_markets()
        currency = self.currency(code)
        request: dict = {
