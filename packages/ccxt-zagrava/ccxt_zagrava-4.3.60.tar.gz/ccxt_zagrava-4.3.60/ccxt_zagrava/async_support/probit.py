...
from ccxt_zagrava.abstract.probit import ImplicitAPI
import math
...
class probit(Exchange, ImplicitAPI):
    ...
    def describe(self):
        return self.deep_extend(super(probit, self).describe(), {
            ...
            'commonCurrencies': {
                ...
                'DKT': 'DAKOTA',
                'EGC': 'EcoG9coin',
                'EPS': 'Epanus',  # conflict with EPS Ellipsis https://github.com/ccxt_zagrava/ccxt_zagrava/issues/8909
                'FX': 'Fanzy',
                'GM': 'GM Holding',
                'GOGOL': 'GOL',
                'GOL': 'Goldofir',
    ...
    async def fetch_deposit_addresses(self, codes: Strings = None, params={}):
        ...
        :param dict [params]: extra parameters specific to the exchange API endpoint
        :returns dict: a list of `address structures <https://docs.ccxt_zagrava.com/#/?id=address-structure>`
        """
        await self.load_markets()
        request: dict = {}
        if codes:
