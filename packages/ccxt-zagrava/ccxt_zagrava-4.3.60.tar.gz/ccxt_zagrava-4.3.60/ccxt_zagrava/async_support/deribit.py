...
from ccxt_zagrava.abstract.deribit import ImplicitAPI
import hashlib
from ccxt_zagrava.base.types import Account, Balances, Currencies, Currency, Greeks, Int, Market, MarketInterface, Num, Option, OptionChain, Order, OrderBook, OrderSide, OrderType, Str, Strings, Ticker, Tickers, Trade, TradingFees, Transaction, TransferEntry, TransferEntries
...
class deribit(Exchange, ImplicitAPI):
    ...
    def parse_trade(self, trade: dict, market: Market = None) -> Trade:
        ...
        # Amount for inverse perpetual and futures is in USD which in ccxt_zagrava is the cost
    ...
    def parse_order(self, order: dict, market: Market = None) -> Order:
        ...
        # Inverse contracts amount is in USD which in ccxt_zagrava is the cost
    ...
    async def fetch_positions(self, symbols: Strings = None, params={}):
        ...
        if symbols is None:
            ...
            code = symbols
            symbols = None  # fix https://github.com/ccxt_zagrava/ccxt_zagrava/issues/13961
        else:
