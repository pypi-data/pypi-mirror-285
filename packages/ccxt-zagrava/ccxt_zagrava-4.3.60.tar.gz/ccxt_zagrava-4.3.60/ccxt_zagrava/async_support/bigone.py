...
from ccxt_zagrava.abstract.bigone import ImplicitAPI
import asyncio
from ccxt_zagrava.base.types import Balances, Bool, Currencies, Currency, Int, Market, Num, Order, OrderBook, OrderSide, OrderType, Str, Strings, Ticker, Tickers, Trade, Transaction, TransferEntry
...
class bigone(Exchange, ImplicitAPI):
    ...
    def sign(self, path, api='public', method='GET', params={}, headers=None, body=None):
        ...
        headers['User-Agent'] = 'ccxt_zagrava/' + self.id + '-' + self.version
