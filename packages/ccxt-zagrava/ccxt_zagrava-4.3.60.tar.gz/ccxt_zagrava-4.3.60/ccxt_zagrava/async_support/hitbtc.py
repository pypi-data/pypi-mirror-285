...
from ccxt_zagrava.abstract.hitbtc import ImplicitAPI
import hashlib
from ccxt_zagrava.base.types import Balances, Currencies, Currency, Int, Leverage, MarginMode, MarginModes, MarginModification, Market, Num, Order, OrderBook, OrderSide, OrderType, Str, Strings, Ticker, Tickers, Trade, TradingFeeInterface, TradingFees, Transaction, TransferEntry
...
class hitbtc(Exchange, ImplicitAPI):
    ...
    def describe(self):
        return self.deep_extend(super(hitbtc, self).describe(), {
            ...
            'commonCurrencies': {
                ...
                'BIT': 'BitRewards',
                'BOX': 'BOX Token',
                'CPT': 'Cryptaur',  # conflict with CPT = Contents Protocol https://github.com/ccxt_zagrava/ccxt_zagrava/issues/4920 and https://github.com/ccxt_zagrava/ccxt_zagrava/issues/6081
                'GET': 'Themis',
                'GMT': 'GMT Token',
                'HSR': 'HC',
                'IQ': 'IQ.Cash',
    ...
    def parse_trade(self, trade: dict, market: Market = None) -> Trade:
        ...
        # explained here: https://github.com/ccxt_zagrava/ccxt_zagrava/issues/5674
    ...
    async def fetch_order_books(self, symbols: Strings = None, limit: Int = None, params={}):
        ...
        :param dict [params]: extra parameters specific to the exchange API endpoint
        :returns dict: a dictionary of `order book structures <https://docs.ccxt_zagrava.com/#/?id=order-book-structure>` indexed by market symbol
        """
        await self.load_markets()
        request: dict = {}
        if symbols is not None:
    ...
    async def fetch_open_interest(self, symbol: str, params={}):
        ...
        :returns dict} an open interest structure{@link https://docs.ccxt_zagrava.com/#/?id=interest-history-structure:
        """
        await self.load_markets()
        market = self.market(symbol)
        if not market['swap']:
