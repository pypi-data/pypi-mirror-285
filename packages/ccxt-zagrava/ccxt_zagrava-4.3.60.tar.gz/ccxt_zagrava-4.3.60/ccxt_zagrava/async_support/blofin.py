...
from ccxt_zagrava.abstract.blofin import ImplicitAPI
import hashlib
from ccxt_zagrava.base.types import Balances, Currency, Int, Leverage, Leverages, MarginMode, Market, Num, Order, OrderBook, OrderRequest, OrderSide, OrderType, Position, Str, Strings, Ticker, Tickers, Trade, TradingFeeInterface, Transaction, TransferEntry
...
class blofin(Exchange, ImplicitAPI):
    ...
    def describe(self):
        return self.deep_extend(super(blofin, self).describe(), {
            ...
            'urls': {
                'logo': 'https://github.com/ccxt_zagrava/ccxt_zagrava/assets/43336371/255a7b29-341f-4d20-8342-fbfae4932807',
                'api': {
