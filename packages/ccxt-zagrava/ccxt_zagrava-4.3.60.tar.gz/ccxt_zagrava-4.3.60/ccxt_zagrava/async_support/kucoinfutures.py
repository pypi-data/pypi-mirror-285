...
from ccxt_zagrava.async_support.kucoin import kucoin
from ccxt_zagrava.abstract.kucoinfutures import ImplicitAPI
from ccxt_zagrava.base.types import Balances, Currency, Int, LeverageTier, MarginModification, Market, Num, Order, OrderBook, OrderRequest, OrderSide, OrderType, Str, Strings, Ticker, Tickers, Trade, TradingFeeInterface, Transaction, TransferEntry
...
class kucoinfutures(kucoin, ImplicitAPI):
    ...
    def describe(self):
        return self.deep_extend(super(kucoinfutures, self).describe(), {
            ...
            'commonCurrencies': {
                'HOT': 'HOTNOW',
                'EDGE': 'DADI',  # https://github.com/ccxt_zagrava/ccxt_zagrava/issues/5756
                'WAX': 'WAXP',
                'TRY': 'Trias',
                'VAI': 'VAIOT',
                'XBT': 'BTC',
