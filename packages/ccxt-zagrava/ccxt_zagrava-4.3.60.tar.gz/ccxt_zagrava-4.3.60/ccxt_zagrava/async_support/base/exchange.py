...
from ccxt_zagrava.base.types import Int, Str, Num, Strings

# -----------------------------------------------------------------------------

from ccxt_zagrava.async_support.base.throttler import Throttler

# -----------------------------------------------------------------------------

from ccxt_zagrava.base.errors import BaseError, NetworkError, BadSymbol, BadRequest, BadResponse, ExchangeError, ExchangeNotAvailable, RequestTimeout, NotSupported, NullResponse, InvalidAddress, RateLimitExceeded
from ccxt_zagrava.base.types import OrderType, OrderSide, OrderRequest, CancellationRequest

# -----------------------------------------------------------------------------

from ccxt_zagrava.base.exchange import Exchange as BaseExchange, ArgumentsRequired

# -----------------------------------------------------------------------------

from ccxt_zagrava.async_support.base.ws.functions import inflate, inflate64, gunzip
from ccxt_zagrava.async_support.base.ws.fast_client import FastClient
from ccxt_zagrava.async_support.base.ws.future import Future
from ccxt_zagrava.async_support.base.ws.order_book import OrderBook, IndexedOrderBook, CountedOrderBook
    ...
    async def fetch(self, url, method='GET', headers=None, body=None):
        ...
        if httpProxy:
            ...
            if ProxyConnector is None:
                raise NotSupported(self.id + ' - to use SOCKS proxy with ccxt_zagrava, you need "aiohttp_socks" module that can be installed by "pip install aiohttp_socks"')
            # Create our SSL context object with our CA cert file
