...
from ccxt_zagrava.abstract.hyperliquid import ImplicitAPI
import asyncio
from ccxt_zagrava.base.types import Balances, Currencies, Currency, Int, MarginModification, Market, Num, Order, OrderBook, OrderRequest, CancellationRequest, OrderSide, OrderType, Str, Strings, Trade, TradingFeeInterface, Transaction, TransferEntry
...
class hyperliquid(Exchange, ImplicitAPI):
    ...
    def describe(self):
        return self.deep_extend(super(hyperliquid, self).describe(), {
            ...
            'urls': {
                'logo': 'https://github.com/ccxt_zagrava/ccxt_zagrava/assets/43336371/b371bc6c-4a8c-489f-87f4-20a913dd8d4b',
                'api': {
