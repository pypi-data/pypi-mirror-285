...
from ccxt_zagrava.abstract.novadax import ImplicitAPI
import hashlib
from ccxt_zagrava.base.types import Account, Balances, Currency, Int, Market, Num, Order, OrderBook, OrderSide, OrderType, Str, Strings, Ticker, Tickers, Trade, Transaction, TransferEntry
    ...
    def describe(self):
        return self.deep_extend(super(novadax, self).describe(), {
            ...
            'urls': {
                ...
                'referral': 'https://www.novadax.com.br/?s=ccxt_zagrava',
            },
            'api': {
                'public': {
                    'get': {
