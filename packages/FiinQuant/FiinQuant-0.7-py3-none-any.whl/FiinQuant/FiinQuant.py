...
class FiinSession:
    ...
    def SubscribeForRealTime(self, ticker: str, callback: None):
        access_token = self.get_access_token() 
...
class FiinIndicator:
    ...
    def macd_diff(self, col: pd.Series, window_slow: int = 26, window_fast: int = 12, window_sign: int = 9):
        ...
        macd_diff_line = self.macd(col, window_slow, window_fast) - self.macd_signal(window_sign)
...
class SubscribeForRealTime:
    def __init__(self, access_token = None, ticker=None, callback=None):
