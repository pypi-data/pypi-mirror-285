...
def client(request: FixtureRequest) -> Iterator[DeeporiginData]:
    ...
    with DeeporiginData(base_url=base_url, _strict_response_validation=strict) as client:
        yield client
...
async def async_client(request: FixtureRequest) -> AsyncIterator[AsyncDeeporiginData]:
    ...
    async with AsyncDeeporiginData(base_url=base_url, _strict_response_validation=strict) as client:
        yield client
