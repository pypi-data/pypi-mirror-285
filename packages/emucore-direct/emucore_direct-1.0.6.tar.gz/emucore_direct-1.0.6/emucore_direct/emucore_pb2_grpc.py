...
class EmuCoreServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.reservoir_reset = channel.unary_unary(
                ...
                request_serializer=emucore__pb2.reset_message.SerializeToString,
                response_deserializer=emucore__pb2.status_message.FromString,
                )
        self.rc_config = channel.unary_unary(
                '/EmuCore.EmuCoreService/rc_config',
                request_serializer=emucore__pb2.rc_config_message.SerializeToString,
                response_deserializer=emucore__pb2.status_message.FromString,
                )
        self.rc_run = channel.unary_unary(
                '/EmuCore.EmuCoreService/rc_run',
                request_serializer=emucore__pb2.rc_run_message.SerializeToString,
                response_deserializer=emucore__pb2.rc_response_message.FromString,
                )
        self.acquire_lock = channel.unary_unary(
                '/EmuCore.EmuCoreService/acquire_lock',
                request_serializer=emucore__pb2.empty_message.SerializeToString,
                response_deserializer=emucore__pb2.lock_output.FromString,
                )
        self.release_lock = channel.unary_unary(
                '/EmuCore.EmuCoreService/release_lock',
                request_serializer=emucore__pb2.lock_message.SerializeToString,
                response_deserializer=emucore__pb2.status_message.FromString,
                )
        self.system_info = channel.unary_unary(
                '/EmuCore.EmuCoreService/system_info',
                request_serializer=emucore__pb2.empty_message.SerializeToString,
                response_deserializer=emucore__pb2.system_info_message.FromString,
                )
...
def add_EmuCoreServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'reservoir_reset': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=emucore__pb2.reset_message.FromString,
                    response_serializer=emucore__pb2.status_message.SerializeToString,
            ),
            'rc_config': grpc.unary_unary_rpc_method_handler(
                    servicer.rc_config,
                    request_deserializer=emucore__pb2.rc_config_message.FromString,
                    response_serializer=emucore__pb2.status_message.SerializeToString,
            ),
            'rc_run': grpc.unary_unary_rpc_method_handler(
                    servicer.rc_run,
                    request_deserializer=emucore__pb2.rc_run_message.FromString,
                    response_serializer=emucore__pb2.rc_response_message.SerializeToString,
            ),
            'acquire_lock': grpc.unary_unary_rpc_method_handler(
                    servicer.acquire_lock,
                    request_deserializer=emucore__pb2.empty_message.FromString,
                    response_serializer=emucore__pb2.lock_output.SerializeToString,
            ),
            'release_lock': grpc.unary_unary_rpc_method_handler(
                    servicer.release_lock,
                    request_deserializer=emucore__pb2.lock_message.FromString,
                    response_serializer=emucore__pb2.status_message.SerializeToString,
            ),
            'system_info': grpc.unary_unary_rpc_method_handler(
                    servicer.system_info,
                    request_deserializer=emucore__pb2.empty_message.FromString,
                    response_serializer=emucore__pb2.system_info_message.SerializeToString,
            ),
...
class EmuCoreService(object):
    ...
    def reservoir_reset(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/EmuCore.EmuCoreService/reservoir_reset',
            emucore__pb2.reset_message.SerializeToString,
            emucore__pb2.status_message.FromString,
    ...
    def rc_config(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/EmuCore.EmuCoreService/rc_config',
            emucore__pb2.rc_config_message.SerializeToString,
            emucore__pb2.status_message.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def rc_run(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/EmuCore.EmuCoreService/rc_run',
            emucore__pb2.rc_run_message.SerializeToString,
            emucore__pb2.rc_response_message.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def acquire_lock(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/EmuCore.EmuCoreService/acquire_lock',
            emucore__pb2.empty_message.SerializeToString,
            emucore__pb2.lock_output.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def release_lock(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/EmuCore.EmuCoreService/release_lock',
            emucore__pb2.lock_message.SerializeToString,
            emucore__pb2.status_message.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def system_info(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/EmuCore.EmuCoreService/system_info',
            emucore__pb2.empty_message.SerializeToString,
            emucore__pb2.system_info_message.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
