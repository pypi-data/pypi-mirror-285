...
class GoogleContacts(GoogleAccountLocal, metaclass=MetaLogger,
    ...
    def _insert_contact_details_to_db(self, contact_dict: dict, user_external_id: int,
        ...
        try:
            ...
            GoogleContacts._insert_link_contact_notes_and_text_blocks(contact_dict=contact_dict)
    ...
    def _insert_organization_profile(self, contact_dict: dict, ) -> list:
        ...
        if len(groups) > 0:
            ...
            for linked_group_result in linked_groups_results_list:
                ...
                if job_title_id is not None:
                    ...
                    job_titile_profile_id = linked_group_result.get("job_title_profile_id")
                    for organization_job_title_info_dict in organizations_job_titles_dicts_list:
                        if (linked_group_result.get("organization_id") == organization_job_title_info_dict.get("organization_id") and
                                organization_job_title_info_dict.get("job_title_id") is None):
                            organization_job_title_info_dict["job_title_id"] = job_title_id
                            organization_job_title_info_dict["job_title_ml_id"] = job_titile_ml_id
                            organization_job_title_info_dict["group_job_title_id"] = group_job_title_id
                            organization_job_title_info_dict["job_title_profile_id"] = job_titile_profile_id
    ...
    def _insert_importer(self, contact_id: int, location_id: int, user_external_id: int,
