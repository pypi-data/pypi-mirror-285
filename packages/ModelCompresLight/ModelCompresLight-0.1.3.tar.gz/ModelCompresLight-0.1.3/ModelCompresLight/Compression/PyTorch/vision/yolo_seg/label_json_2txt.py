...
if __name__ == "__main__":
    ...
    jsonfilePath = "/datasjson"  # 要转换的json文件所在目录
    resultDirPath = "label"  # 要生成的txt文件夹
    labelme2yolov2Seg(jsonfilePath=jsonfilePath, resultDirPath=resultDirPath, classList=["0","1","2","3"])  # 更改为自己的类别名
