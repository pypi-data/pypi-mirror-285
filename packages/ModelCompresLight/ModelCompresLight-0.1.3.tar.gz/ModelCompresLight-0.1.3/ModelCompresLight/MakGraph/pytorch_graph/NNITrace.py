...
class TorchModuleGraph(TorchGraph):
    ...
    def __init__(self, model=None, dummy_input=None, traced_model=None):
        ...
        self.global_count = 0
        self.name_to_node, self.input_to_node = self._build_graph()
    ...
    def _build_index(self, nodes_op):
        ...
        return name_to_node, input_to_node
...
if __name__=="__main__":
    ...
    AutoGraph_ = TorchModuleGraph(model,data) #TorchModuleGraph
    weiname=AutoGraph_.name_to_node
