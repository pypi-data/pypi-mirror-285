...
class DotMaker():
    ...
    def OpPath2Conv(self,para_name):
        ...
        for str_bot in sta_bottom:
            if self.Nodes[str_bot].ops in ['ThnnConv2DBackward', 'MkldnnConvolutionBackward','CudnnConvolutionBackward']:
                sta_conv_id = str_bot
            else:
            ...
            if dyn_layer_ids[0] not in deal_layer:
                ...
                if len(find_bottom_is) >= 1:
                    ...
                    for e_fw in find_bottom_is:
                        if self.Nodes[e_fw].ops in ['ThnnConv2DBackward', 'MkldnnConvolutionBackward','CudnnConvolutionBackward']:
                        ...
                        elif self.Nodes[e_fw].ops in ['CatBackward','CatBackward0']:
                ...
                if len(layer_s_bottom) >= 1:
                    ...
                    for e_up in layer_s_bottom:
                        if self.Nodes[e_up].ops in ['ThnnConv2DBackward', 'MkldnnConvolutionBackward','CudnnConvolutionBackward']:
                        ...
                        elif self.Nodes[e_up].ops in ['AddBackward0','AddBackward']:

                            dyn_layer_ids.append(e_up)

                        elif self.Nodes[e_up].ops in ['CatBackward','CatBackward0']:
                            dyn_layer_ids.append(e_up)
