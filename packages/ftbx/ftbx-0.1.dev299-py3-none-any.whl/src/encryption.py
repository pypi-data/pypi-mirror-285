...
def encrypt_pwd(pwd: str, key_path: str = os.path.join(os.path.expanduser('~'), '.ftbx', 'key')):
    """
    Encrypt pwd
...
def decrypt_pwd(pwd: str, key_path: str = os.path.join(os.path.expanduser('~'), '.ftbx', 'key')):
    """
    Decrypt pwd
