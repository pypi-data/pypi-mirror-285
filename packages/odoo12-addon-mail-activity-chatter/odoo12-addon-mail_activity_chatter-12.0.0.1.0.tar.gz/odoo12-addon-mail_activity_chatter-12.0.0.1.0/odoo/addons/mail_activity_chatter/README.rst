...
This module allows to leave notes and send messages in mail activity model instances, adding the chatter functionallity
...
Use chatter as usual (leave notes, answer them...) in any model that inherits from mail.thread and shows the view class oe_chatter
