...
@njit
def get_indices_dict_of_sorted_array(a: np.ndarray) -> Dict:
    """
    get dict {0: index of smallest element, 1: index of next smallest elements}
    :param a:
    :return:
    """
...
def run_unit_test(unit_test: UnitTests):
    ...
    if unit_test == UnitTests.SHIFT_TEST:
        ...
        this = get_indices_dict_of_sorted_array(a=a)
        print(this)
