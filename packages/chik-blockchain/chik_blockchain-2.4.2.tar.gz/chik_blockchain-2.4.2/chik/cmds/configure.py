    ...
    with lock_and_load_config(root_path, config_yaml, fill_missing_services=True) as config:
        ...
        if testnet:
            if testnet == "true" or testnet == "t":
                ...
                testnet_port = "59678"
                testnet_introducer = "introducer-testnet11.chiknetwork.com"
                testnet_dns_introducer = "dns-introducer-testnet11.chiknetwork.com"
                bootstrap_peers = ["testnet11-node-us-west-2.chiknetwork.com"]
                testnet = "testnet11"
