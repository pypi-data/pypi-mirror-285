...
npx electron-builder build --win --x64 --config.productName="Chik" --dir --config ../../../build_scripts/electron-builder.json
...
npx electron-builder build --win --x64 --config.productName="Chik" --pd ".\dist\win-unpacked" --config ../../../build_scripts/electron-builder.json
Write-Output "   ---"
