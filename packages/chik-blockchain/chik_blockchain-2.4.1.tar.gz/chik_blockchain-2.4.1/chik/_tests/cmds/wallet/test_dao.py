...
from chik._tests.cmds.wallet.test_consts import FINGERPRINT_ARG
from chik.types.blockchain_format.sized_bytes import bytes32
from chik.util.bech32m import encode_puzzle_hash
from chik.util.ints import uint8, uint32, uint64
from chik.wallet.conditions import parse_timelock_info
...
def test_dao_proposals(capsys: object, get_test_cli_clients: Tuple[TestRpcClients, Path]) -> None:
    ...
    parse_mint_asserts = [
        ...
        "Address: {}".format(encode_puzzle_hash(bytes32(b"x" * 32), "xck")),
    ]
