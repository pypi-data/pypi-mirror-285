...
def test_chik_installed() -> None:
    """This checks that the in-memory chik package was loaded from an installed copy
    ...
    """
    assert "venv" in pathlib.Path(chik.__file__).parts
