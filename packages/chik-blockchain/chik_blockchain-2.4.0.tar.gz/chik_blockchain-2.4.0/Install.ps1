...
venv\scripts\pip install --extra-index-url https://pypi.chiknetwork.com/simple/ miniupnpc==2.2.2
& venv\scripts\pip install @pip_parameters --extra-index-url https://pypi.chiknetwork.com/simple/
