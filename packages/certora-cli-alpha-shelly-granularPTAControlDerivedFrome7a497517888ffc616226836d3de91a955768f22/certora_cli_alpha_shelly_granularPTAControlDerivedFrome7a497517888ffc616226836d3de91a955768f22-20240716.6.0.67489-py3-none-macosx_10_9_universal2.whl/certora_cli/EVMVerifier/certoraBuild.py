    ...
    def _handle_optimize(self, contract_file_path: str, settings_dict: Dict[str, Any],
        ...
        if self.context.solc_optimize_map:
            ...
            if self.context.finder_friendly_optimizer:
                ...
                "peulxa[rul]xa[r]cLgvifCTUca[r]LSsTFOtfDnca[r]Iulc]jmul[jul]VcTOculjmul"  # replace gvif with gvf
                solc0_8_12 = "dhfoDgvulfnTUtnIf[xa[r]EscLMcCTUtTOntnfDIulLculVcul[j]T"
                "peulxa[rul]xa[r]cLgvifCTUca[r]LsTFOtfDnca[r]Iulc]jmul[jul]VcTOculjmul"  # replace gvif with gvf
                ...
                "peulxarulrulxarrcLgvifCTUcarrLsTFOtfDncarrIulc]jmuljuljulVcTOculjmul"  # replace gvif with gvf
                ...
                "peulxarulrulxarrcLgvifCTUcarrLsTFOtfDncarrIulc]jmuljuljulVcTOculjmulN"  # replace gvif with gvf
                solc0_6_7_to_0_7_1 = "dhfoDgvulfnTUtnIf[xarrscLMcCTUtTOntnfDIulLculVculjj"
                "eulxarulrulxarrcLgvifCTUcarrLsTFOtfDncarrIulc]jmuljuljulVcTOculjmul"  # replace gvif with gvf

                def standard_replacement(optimizer_steps: str) -> str:
                    return optimizer_steps.replace("gvif", "gvf")
