...
def get_days_of_the_current_month(str_or_datetime='str'):
    ...
    guan.get_date_array_of_the_current_month(str_or_datetime=str_or_datetime)
...
def get_days_of_the_last_month(str_or_datetime='str'):
    ...
    guan.get_date_array_of_the_last_month(str_or_datetime=str_or_datetime)
...
def get_days_of_the_month_before_last(str_or_datetime='str'):
    ...
    guan.get_date_array_of_the_month_before_last(str_or_datetime=str_or_datetime)