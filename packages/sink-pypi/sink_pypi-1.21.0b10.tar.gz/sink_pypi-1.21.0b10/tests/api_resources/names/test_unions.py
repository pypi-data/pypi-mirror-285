...
from sink_sdk.types import ObjectWithUnionProperties
...
class TestAsyncUnions:
    ...
    async def test_streaming_response_variants_object_with_union_properties(self, async_client: AsyncSink) -> None:
        async with async_client.names.unions.with_streaming_response.variants_object_with_union_properties() as response:
            assert not response.is_closed
