...
from sink_sdk.types.shared import SimpleObject
...
class TestAsyncResponses:
    ...
    async def test_streaming_response_additional_properties_nested_model_reference(
        ...
        async with async_client.responses.with_streaming_response.additional_properties_nested_model_reference() as http_response:
            assert not http_response.is_closed
    ...
    async def test_streaming_response_object_with_additional_properties_prop(self, async_client: AsyncSink) -> None:
        async with async_client.responses.with_streaming_response.object_with_additional_properties_prop() as http_response:
            assert not http_response.is_closed
