...
from sink_sdk.types.types import ArrayFloatItemsResponse, ArrayObjectItemsResponse
...
class TestArrays:
    ...
    @parametrize
    def test_method_nested_in_params_with_all_params(self, client: Sink) -> None:
        array = client.types.arrays.nested_in_params(
            array_param={},
        )
        assert array is None
...
class TestAsyncArrays:
    ...
    @parametrize
    async def test_method_nested_in_params_with_all_params(self, async_client: AsyncSink) -> None:
        array = await async_client.types.arrays.nested_in_params(
            array_param={},
        )
        assert array is None
