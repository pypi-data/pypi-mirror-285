...
from sink_sdk import Sink, AsyncSink, APIResponseValidationError
from sink_sdk._models import BaseModel, FinalRequestOptions
from sink_sdk._constants import RAW_RESPONSE_HEADER
from sink_sdk._streaming import Stream, AsyncStream
from sink_sdk._exceptions import APIStatusError, APITimeoutError, APIResponseValidationError
from sink_sdk._base_client import (
    DEFAULT_TIMEOUT,
...
class TestSink:
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "sink_sdk/_legacy_response.py",
                        "sink_sdk/_response.py",
    ...
    @mock.patch("sink_sdk._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
