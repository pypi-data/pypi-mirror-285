...
import numpy as np
from test_utils_mop.base_model_wrapper import BaseModelWrapper, MopInferenceInput
from test_utils_mop.constant import CM_MODEL_WRAPPER_NAME
    ...
    if is_models_folder:
        for child in p.iterdir():
            if child.is_dir():
                ...
                wrapper = MOPInferenceWrapper(base_model_wrapper)
