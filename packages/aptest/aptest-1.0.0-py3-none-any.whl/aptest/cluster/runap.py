...
def printresult():
	...
	with open('tmp/c2members'+str(var2value['k']),'w') as f1:
		json.dump(c2members,f1)
	with open('tmp/c2size'+str(var2value['k']),'w') as f2:
		json.dump(c2size,f2)
	with open('tmp/c2sim'+str(var2value['k']),'w') as f3:
		json.dump(c2sim,f3)
