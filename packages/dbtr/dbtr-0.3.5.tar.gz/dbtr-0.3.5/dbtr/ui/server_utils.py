...
from dbtr.ui import CLOUD_PROVIDER
from dbtr.common.remote_server import DbtServer

if CLOUD_PROVIDER == "google":
    from dbtr.cli.cloud_providers.gcp import get_auth_token
elif CLOUD_PROVIDER == "azure":
    from dbtr.cli.cloud_providers.az import get_auth_token
elif CLOUD_PROVIDER == "local":
    from dbtr.cli.cloud_providers.local import get_auth_token
