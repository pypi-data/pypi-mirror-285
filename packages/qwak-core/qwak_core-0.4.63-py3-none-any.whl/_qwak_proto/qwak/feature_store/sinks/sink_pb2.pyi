...
class StreamingSink(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["attachment_point", b"attachment_point", "kafka_sink", b"kafka_sink", "sink_type", b"sink_type"]) -> None: ...
...
class KafkaSink(google.protobuf.message.Message):
    ...
    the realtion of sink-by-fs-type:conrete-sink-type is a many:many relation
