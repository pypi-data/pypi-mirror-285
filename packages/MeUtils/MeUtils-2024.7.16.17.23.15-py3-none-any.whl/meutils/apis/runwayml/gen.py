...
async def submit_task(request: Union[RunwayRequest, dict], token: Optional[str] = None):
    token = token or await get_next_token_for_polling(FEISHU_URL)
...
if __name__ == '__main__':
    ...
    print(arun(submit_task(EXAMPLES[0])))
    # print(arun(submit_task(RunwayRequest(**text2video_payload))))
