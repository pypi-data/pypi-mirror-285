...
def formatted_iaar_msg(msg, level, class_name="", func_name="", line_num="", track_id="", local_ip='',
...
class IaarLoguru:
    def __init__(self, deep=1, log_file="", local_ip='', pod_name='', module=''):
        """
    ...
    def method_timecost(self, method_timecost):
        self.method_timecost = method_timecost
        return self
