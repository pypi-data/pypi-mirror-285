...
conf = asdk_plugin_platform.agraph.platform.identity.user.v1.UserAPI.Configuration(
...
conf = asdk_plugin_platform.agraph.platform.identity.user.v1.UserAPI.Configuration(
    ...
    def __init__(self, host=None,
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("asdk_plugin_platform.agraph.platform.identity.user.v1.UserAPI")
