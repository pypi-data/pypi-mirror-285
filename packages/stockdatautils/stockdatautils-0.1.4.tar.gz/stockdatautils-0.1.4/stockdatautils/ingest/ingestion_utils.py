...
from stockdatautils.ingest.utils import get_utc_date, convert_keys_to_snake_case, convert_values
...
def process_json(json_data, d):
    ...
    Parameters:
    json_data (dict): The original JSON data.
    d (datetime): datetime to add to json.
    ...
    json_data_with_timestamp = add_utc_timestamp_to_beginning(json_data, d)
