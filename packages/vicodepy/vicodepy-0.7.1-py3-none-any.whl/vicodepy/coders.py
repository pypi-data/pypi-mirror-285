...
class Coders:
    ...
    def set_current(self):
        ...
        while True:
            ...
            buttonbox.button(QDialogButtonBox.StandardButton.Apply).setText("Edit")
            buttonbox.button(
                QDialogButtonBox.StandardButton.Apply).clicked.connect(
                    self.edit_coder
                )
            buttonbox.button(QDialogButtonBox.StandardButton.Open).setText("New")
            buttonbox.button(
