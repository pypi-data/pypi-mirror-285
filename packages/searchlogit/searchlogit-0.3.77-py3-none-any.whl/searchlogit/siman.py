...
# {
    ...
    # {
        ...
        if self.current_sol == None:
            ...
            print("Current SA solution - not defined")
    ...
    # {
        ...
        print(f"#Exception={self.exception}", file=self.results_file)
        print(f"#LocalImpr={self.local_impr}", file=self.results_file)
    # }
    ...
    ####################################################################################
    # New & Untested!!!!
    def SearchLatent(self, param, ctrl, max_classes=5):
    # {
        init_sol = None
        ...
        # {
            self.param.latent_class = False if q == 1 else True
            self.param.num_classes = q
            solver_q = SA(param, ctrl, init_sol, idnum=q)
...
# {
    ...
    # {
        ...
        self.solvers = [SA(param, ctrl, init_sol, idnum=i) for i in range(nthrds)]
