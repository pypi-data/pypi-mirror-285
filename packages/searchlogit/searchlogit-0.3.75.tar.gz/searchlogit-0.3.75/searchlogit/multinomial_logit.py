...
# {
    ...
    def setup(self, X, y, varnames=None, alts=None, isvars=None, transvars=None,
        ...
        ftol=1e-6, gtol=1e-6, return_grad=True, return_hess=True, verbose=1,
    ...
    # {
        ...
        self.verbose, self.method = verbose, method
    ...
    def fit(self):
    # {
        args = (self.betas, self.X, self.y, self.weights, self.avail,
        ...
        self.post_process(result, self.Xnames, sample_size, verbose=self.verbose)
    # }
