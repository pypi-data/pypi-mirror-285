...
def AddLabels(builder, labels): builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(labels), 0)
...
def AddUuidCameraintrinsics(builder, uuidCameraintrinsics): builder.PrependUOffsetTRelativeSlot(8, flatbuffers.number_types.UOffsetTFlags.py_type(uuidCameraintrinsics), 0)
