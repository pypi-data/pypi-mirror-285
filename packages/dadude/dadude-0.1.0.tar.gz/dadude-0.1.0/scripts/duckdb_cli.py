...
if __name__ == "__main__":
    ...
    USE_SSL false,
    URL_STYLE 'path',
    ENDPOINT 'http://192.168.18.206:9000'
);""")
    delta_table_path = "s3://test/property"
    print(quack._sql(
        "select * from read_parquet('s3://test/property/0-733054a2-a87a-4a26-91f7-aa86a2f501cd-0.parquet')"
    ))
