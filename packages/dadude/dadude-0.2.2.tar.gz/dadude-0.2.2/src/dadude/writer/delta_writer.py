...
def write_json_table(local_json_file_path: str):
    writer = DeltaWriter()
    writer.write_json(local_json_file_path)


def write_nljson_table(local_json_file_path: str):
    writer = DeltaWriter()
    writer.write_json(local_json_file_path, lines=True)