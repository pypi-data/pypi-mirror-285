...
"""Usage:
  ...
  tenzir-platform admin update-workspace <workspace_id> [--name=<workspace_name>] [--icon_url=<icon_url>] [--owner-namespace=<namespace>] [--owner-id=<owner_id>] [--category=<workspace_category>]
...
Options:
  ...
  --icon_url=<icon_url>             The image to be used for this workspace in the frontend.
...
def update_workspace(
    ...
    resp = client.post(
        ...
        json={
            ...
            "owner_id": owner_id,
            "display_name": workspace_category,
        },
    )
    resp.raise_for_status()
