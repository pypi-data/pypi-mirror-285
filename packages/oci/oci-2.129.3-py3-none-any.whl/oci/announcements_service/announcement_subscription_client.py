...
class AnnouncementSubscriptionClient(object):
    ...
    def change_announcement_subscription_compartment(self, announcement_subscription_id, change_announcement_subscription_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.3/announcementsservice/change_announcement_subscription_compartment.py.html>`__ to see an example of how to use change_announcement_subscription_compartment API.
        """
    ...
    def create_announcement_subscription(self, create_announcement_subscription_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.3/announcementsservice/create_announcement_subscription.py.html>`__ to see an example of how to use create_announcement_subscription API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def create_filter_group(self, announcement_subscription_id, create_filter_group_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.3/announcementsservice/create_filter_group.py.html>`__ to see an example of how to use create_filter_group API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['announcementSubscriptionId']
    ...
    def delete_announcement_subscription(self, announcement_subscription_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.3/announcementsservice/delete_announcement_subscription.py.html>`__ to see an example of how to use delete_announcement_subscription API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['announcementSubscriptionId']
    ...
    def delete_filter_group(self, announcement_subscription_id, filter_group_name, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.3/announcementsservice/delete_filter_group.py.html>`__ to see an example of how to use delete_filter_group API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def get_announcement_subscription(self, announcement_subscription_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.3/announcementsservice/get_announcement_subscription.py.html>`__ to see an example of how to use get_announcement_subscription API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['announcementSubscriptionId']
        resource_path = "/announcementSubscriptions/{announcementSubscriptionId}"
    ...
    def list_announcement_subscriptions(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.3/announcementsservice/list_announcement_subscriptions.py.html>`__ to see an example of how to use list_announcement_subscriptions API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def update_announcement_subscription(self, announcement_subscription_id, update_announcement_subscription_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.3/announcementsservice/update_announcement_subscription.py.html>`__ to see an example of how to use update_announcement_subscription API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['announcementSubscriptionId']
        resource_path = "/announcementSubscriptions/{announcementSubscriptionId}"
    ...
    def update_filter_group(self, announcement_subscription_id, filter_group_name, update_filter_group_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.3/announcementsservice/update_filter_group.py.html>`__ to see an example of how to use update_filter_group API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['announcementSubscriptionId', 'filterGroupName']
        resource_path = "/announcementSubscriptions/{announcementSubscriptionId}/filterGroups/{filterGroupName}"
