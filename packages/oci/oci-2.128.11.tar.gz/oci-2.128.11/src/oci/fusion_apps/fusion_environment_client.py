...
class FusionEnvironmentClient(object):
    ...
    def change_fusion_environment_compartment(self, fusion_environment_id, change_fusion_environment_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.128.11/fusionapps/change_fusion_environment_compartment.py.html>`__ to see an example of how to use change_fusion_environment_compartment API.
        """
    ...
    def create_fusion_environment(self, create_fusion_environment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.128.11/fusionapps/create_fusion_environment.py.html>`__ to see an example of how to use create_fusion_environment API.
        """
    ...
    def create_fusion_environment_admin_user(self, create_fusion_environment_admin_user_details, fusion_environment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.128.11/fusionapps/create_fusion_environment_admin_user.py.html>`__ to see an example of how to use create_fusion_environment_admin_user API.
        """
    ...
    def delete_fusion_environment(self, fusion_environment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.128.11/fusionapps/delete_fusion_environment.py.html>`__ to see an example of how to use delete_fusion_environment API.
        """
    ...
    def delete_fusion_environment_admin_user(self, admin_username, fusion_environment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.128.11/fusionapps/delete_fusion_environment_admin_user.py.html>`__ to see an example of how to use delete_fusion_environment_admin_user API.
        """
    ...
    def get_fusion_environment(self, fusion_environment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.128.11/fusionapps/get_fusion_environment.py.html>`__ to see an example of how to use get_fusion_environment API.
        """
        resource_path = "/fusionEnvironments/{fusionEnvironmentId}"
        method = "GET"
    ...
    def get_fusion_environment_status(self, fusion_environment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.128.11/fusionapps/get_fusion_environment_status.py.html>`__ to see an example of how to use get_fusion_environment_status API.
        """
    ...
    def get_work_request(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.128.11/fusionapps/get_work_request.py.html>`__ to see an example of how to use get_work_request API.
        """
    ...
    def list_admin_users(self, fusion_environment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.128.11/fusionapps/list_admin_users.py.html>`__ to see an example of how to use list_admin_users API.
        """
        resource_path = "/fusionEnvironments/{fusionEnvironmentId}/adminUsers"
        method = "GET"
    ...
    def list_fusion_environments(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.128.11/fusionapps/list_fusion_environments.py.html>`__ to see an example of how to use list_fusion_environments API.
        """
        resource_path = "/fusionEnvironments"
        method = "GET"
    ...
    def list_work_request_errors(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.128.11/fusionapps/list_work_request_errors.py.html>`__ to see an example of how to use list_work_request_errors API.
        """
    ...
    def list_work_request_logs(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.128.11/fusionapps/list_work_request_logs.py.html>`__ to see an example of how to use list_work_request_logs API.
        """
    ...
    def list_work_requests(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.128.11/fusionapps/list_work_requests.py.html>`__ to see an example of how to use list_work_requests API.
        """
    ...
    def reset_fusion_environment_password(self, reset_fusion_environment_password_details, fusion_environment_id, admin_username, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.128.11/fusionapps/reset_fusion_environment_password.py.html>`__ to see an example of how to use reset_fusion_environment_password API.
        """
    ...
    def update_fusion_environment(self, fusion_environment_id, update_fusion_environment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.128.11/fusionapps/update_fusion_environment.py.html>`__ to see an example of how to use update_fusion_environment API.
        """
        resource_path = "/fusionEnvironments/{fusionEnvironmentId}"
        method = "PUT"
