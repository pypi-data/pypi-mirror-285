...
async def descartes(task):
    ...
    try:
        ...
        try:
            window_busca_representante = pyautogui.locateOnScreen(ASSETS_BASE_PATH + "window_busca_representante.png", confidence=0.85, grayscale=True)
        except:
        ...
        try:
            model_selected = pyautogui.locateOnScreen(ASSETS_BASE_PATH + "field_model_select_model_077.png", confidence=0.99, grayscale=True)
        except:
            model_selected = None
            
        if model_selected is None:
            try:
                field_modelo_faturamento = pyautogui.locateOnScreen(ASSETS_BASE_PATH + "field_modelo_faturamento2.png", confidence=0.95, grayscale=True)
            except:      
