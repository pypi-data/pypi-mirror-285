...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, repository=None, content_guard=None, pulp_labels=None, name=None, pulp_href=None, base_path=None, pulp_created=None, pulp_last_updated=None, hidden=False, repository_version=None, registry_path=None, remote=None, namespace=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
