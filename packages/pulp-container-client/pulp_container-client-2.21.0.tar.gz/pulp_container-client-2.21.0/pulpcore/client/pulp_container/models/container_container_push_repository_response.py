...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, pulp_labels=None, name=None, description=None, pulp_href=None, versions_href=None, latest_version_href=None, pulp_created=None, pulp_last_updated=None, manifest_signing_service=None, retain_repo_versions=None, local_vars_configuration=None):  # noqa: E501
