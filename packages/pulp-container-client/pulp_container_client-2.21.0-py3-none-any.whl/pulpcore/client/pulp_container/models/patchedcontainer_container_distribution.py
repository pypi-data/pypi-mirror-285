...
class PatchedcontainerContainerDistribution(object):
    ...
    def __init__(self, repository=None, content_guard=None, pulp_labels=None, name=None, base_path=None, hidden=False, repository_version=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
