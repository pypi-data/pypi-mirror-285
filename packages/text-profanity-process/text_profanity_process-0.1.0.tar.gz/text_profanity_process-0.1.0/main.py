import text_profanity_process as x
...
def call_api(message):
  ...
  try:
    ...
    processed_message_content = x.process(message_content)
    response = requests.post(url, json={"comment": processed_message_content})
