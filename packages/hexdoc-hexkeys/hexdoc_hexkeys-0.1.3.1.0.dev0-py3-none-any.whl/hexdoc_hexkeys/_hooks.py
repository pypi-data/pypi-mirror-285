...
import hexdoc_hexkeys

from .__gradle_version__ import FULL_VERSION, GRADLE_VERSION
from .__version__ import PY_VERSION


class HexkeysPlugin(ModPluginImpl):
    @staticmethod
    @hookimpl
    def hexdoc_mod_plugin(branch: str) -> ModPlugin:
        return HexkeysModPlugin(branch=branch)


class HexkeysModPlugin(ModPluginWithBook):
    @property
    @override
    def modid(self) -> str:
        return "hexkeys"
    ...
    def jinja_template_root(self) -> tuple[Package, str]:
        return hexdoc_hexkeys, "_templates"
