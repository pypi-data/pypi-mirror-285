...
class EdgeStatistics(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "vertex_type_pair_statistics": [VertexTypePairStatistics.from_dict(_item) for _item in obj["vertex_type_pair_statistics"]] if obj.get("vertex_type_pair_statistics") is not None else None
        })
        return _obj
