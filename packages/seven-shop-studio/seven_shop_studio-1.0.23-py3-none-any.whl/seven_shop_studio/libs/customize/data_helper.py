...
:LastEditTime: 2024-07-08 11:29:25
...
class DataHelper:
    ...
    def get_shop_data(self,shop_id,begin_time,end_time):
        ...
        ret_data["total_price"] = round(order_conn.get_dict(where="shop_id = %s and pay_time > 0",params=shop_id,field="ifnull(sum(real_pay_price),0) as total_price")["total_price"],2)
