...
class GoodsInfoHandler(SevenBaseHandler):
    ...
    def get_async(self):
        ...
        goods_model = GoodsModel(context=self).get_dict(where="id = %s and shop_id = %s",params=[goods_id,shop_id],field="id,series_id,goods_main_images,goods_detail_images,goods_long_name,goods_short_name,goods_remark,goods_parameter,goods_service,original_price,price,goods_code,sort,status")
