...
def getValues(data, task_attrs):
    ...
    while not commands_handle.isDone():
        ...
        # argv_handle = commands_handle.inputValue().child(
        #     task_attrs["commandsArgv"]
        # ).asArrayDataHandle()
        
        
        # print("Got argv_handle")
        # print(argv_array_handle)
        # print("Element count", argv_array_handle.elementCount())
