...
class IncidentDetailDto(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, criticality, id, issue_no, last_occurred_date, name, number_of_failures, owners, status, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, criticality, id, issue_no, last_occurred_date, name, number_of_failures, owners, status, *args, **kwargs):  # noqa: E501
        """IncidentDetailDto - a model defined in OpenAPI
