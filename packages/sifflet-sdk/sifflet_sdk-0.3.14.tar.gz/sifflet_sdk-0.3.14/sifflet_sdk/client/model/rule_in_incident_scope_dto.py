...
class RuleInIncidentScopeDto(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, datasets, id, name, number_of_failures, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, datasets, id, name, number_of_failures, *args, **kwargs):  # noqa: E501
        """RuleInIncidentScopeDto - a model defined in OpenAPI
