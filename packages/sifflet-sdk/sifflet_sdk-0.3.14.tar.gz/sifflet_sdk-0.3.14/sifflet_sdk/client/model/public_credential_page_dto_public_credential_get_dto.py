...
def lazy_import():
    ...
    globals()['PublicCredentialGetDto'] = PublicCredentialGetDto


class PublicCredentialPageDtoPublicCredentialGetDto(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': ([PublicCredentialGetDto],),  # noqa: E501
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """PublicCredentialPageDtoPublicCredentialGetDto - a model defined in OpenAPI

        Args:
            data ([PublicCredentialGetDto]):
