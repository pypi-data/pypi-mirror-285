...
class DashboardWithIncidentsDto(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, datasource_id, datasource_name, datasource_type, favorite_count, incidents, owners, source_dashboard_id, tags, terms, title, type, urn, view_count, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, datasource_id, datasource_name, datasource_type, favorite_count, incidents, owners, source_dashboard_id, tags, terms, title, type, urn, view_count, *args, **kwargs):  # noqa: E501
        """DashboardWithIncidentsDto - a model defined in OpenAPI
