...
from sifflet_sdk.client.model.event_dto import EventDto
...
from sifflet_sdk.client.model.search_collection_event_dto import SearchCollectionEventDto
...
class IncidentApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_incident_events_by_issue_number_endpoint = _Endpoint(
            settings={
                'response_type': (SearchCollectionEventDto,),
                'auth': [
                    'JWT'
                ],
                'endpoint_path': '/ui/v1/incidents/{issueNo}/events',
    ...
    def get_all_incident(
        ...
        **kwargs
        ...
        Keyword Args:
            ...
            status ([str]): Filter on given statuses. [optional]
            ...
            incident ([str]): Filter on given incident ids. [optional]
    ...
    def link_rules_to_incident(
        ...
        **kwargs
        ...
        kwargs['id'] = \
            id
        kwargs['link_incident_rules_dto'] = \
            link_incident_rules_dto
