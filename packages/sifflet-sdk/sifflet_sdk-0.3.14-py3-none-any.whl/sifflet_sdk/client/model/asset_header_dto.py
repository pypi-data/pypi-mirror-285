...
class AssetHeaderDto(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, displayed_type, entity_type, has_quality, id, lineage_platform, lineage_platform_label, name, quality_status, urn, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, displayed_type, entity_type, has_quality, id, lineage_platform, lineage_platform_label, name, quality_status, urn, *args, **kwargs):  # noqa: E501
        """AssetHeaderDto - a model defined in OpenAPI
