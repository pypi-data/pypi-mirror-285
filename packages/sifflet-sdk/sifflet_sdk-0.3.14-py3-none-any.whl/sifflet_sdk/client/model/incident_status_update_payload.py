...
def lazy_import():
    from sifflet_sdk.client.model.event_payload import EventPayload
    from sifflet_sdk.client.model.incident_status_update_payload_all_of import IncidentStatusUpdatePayloadAllOf
