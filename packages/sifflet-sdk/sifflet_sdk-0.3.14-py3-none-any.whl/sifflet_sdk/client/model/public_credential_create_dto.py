...
class PublicCredentialCreateDto(ModelNormal):
    ...
    def _from_openapi_data(cls, name, value, *args, **kwargs):  # noqa: E501
        """PublicCredentialCreateDto - a model defined in OpenAPI

        Args:
            name (str): Name of the credential
            value (str): Value of the credential. Double quotes must be escaped with a backslash.
