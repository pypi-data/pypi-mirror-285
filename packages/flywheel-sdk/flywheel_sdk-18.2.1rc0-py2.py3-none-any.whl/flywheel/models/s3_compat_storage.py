...
class S3CompatStorage(object):
    ...
    def __init__(self, region=None, bucket=None, path='', endpoint_url=None, verify_certs=False, signed_urls=False, config_type=None, config_class=None, addressing_style=None):  # noqa: E501
