...
from olangfuse.utils import handle_jsonerror, COOKIE_AUTH


class OpenTraceClient(TraceClient):
    def __init__(self, **kwargs):
        super().__init__(**kwargs)
        self._next_auth = f"__Secure-next-auth.session-token={COOKIE_AUTH.get('__Secure-next-auth.session-token', '')}"
