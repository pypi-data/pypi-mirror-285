...
from schemon.notification.ado import create_pr_thread_ado
...
def validate_cli(
    ...
    if notification == "pr":
        if platform == "ado":
            ...
            response = create_pr_thread_ado(org, project, repo_id, pr_id, pat, report)
...
def get_new_version(session: Session, validation_result_items: list[ValidationResult], entity_name: str, stage: str, env: str) -> Tuple[str, str]:  # type: ignore
    """
