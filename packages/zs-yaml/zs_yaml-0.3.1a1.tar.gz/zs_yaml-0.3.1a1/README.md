...
Some zserio types require additional arguments during deserialization. To support these types, you can specify deserialization arguments in the `_meta` section of your YAML file:

```yaml
_meta:
  schema_module: <module_name>
  schema_type: <type_name>
  deserialization_args:
    - <arg1>
    - <arg2>
    # ... more arguments as needed
```

These arguments will be passed to the `zserio.deserialize_from_file` function when converting from binary to YAML. For example:
...
In this example, `0xAB` and `42` will be passed as additional arguments to the deserialization function.
