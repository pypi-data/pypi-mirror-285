...
def bin_to_yaml(bin_input_path, yaml_output_path):
    ...
    deserialization_args = meta.get('_meta', {}).get('deserialization_args', [])
    ...
    zserio_object = zserio.deserialize_from_file(ImportedType, bin_input_path, *deserialization_args)
