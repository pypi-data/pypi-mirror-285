...
class aws(object):
    def __init__(self, profile=None, region="us-east-1", cache=120, config=None, session=None, cache_folder="~/.cache/pinkboto"):
        """
        Create connection.
        ...
        self.cache = pinkboto.Cache(lifetime=cache, folder=cache_folder)
