...
:LastEditTime: 2024-07-17 11:17:21
...
class RefundListHandler(SevenBaseHandler):
    ...
    def get_async(self):
        ...
        refund_order_list,is_next = OrderRefundModel().get_dict_page_list(where="user_code = %s and act_id = %s and shop_id = %s",params=[user_code,shop_id],page_index=page_index,page_size=page_size,field="order_id,refund_order_id,status,goods_refund_price,real_refund_price,postage",order_by="id desc",page_count_mode="next")
