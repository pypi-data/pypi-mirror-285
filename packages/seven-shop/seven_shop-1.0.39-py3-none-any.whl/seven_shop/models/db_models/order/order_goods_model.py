...
class OrderGoods:
    ...
    def get_field_list(self):
        return ['id', 'order_id', 'goods_id', 'sku_id', 'sku_name', 'goods_picture', 'user_code', 'goods_name', 'buy_count', 'price', 'real_pay_price', 'coupon_id', 'coupon_price', 'add_time', 'goods_code']
