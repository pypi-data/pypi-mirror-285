...
def run_script(script_path, env_vars, base_path):
    ...
    env_vars['ENV'] = env_vars['ENVIRONMENT']  # Ensure ENV is available as an alias for ENVIRONMENT
    try:
...
def deploy(service_type, action, service_name):
    ...
    os.environ['ENV'] = environment  # Ensure ENV is available as an alias for ENVIRONMENT
