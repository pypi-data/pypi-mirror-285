...
if __name__ == '__main__':
    ...
    parser.add_argument('--voc-dir', type=str, default=r'C:\Users\Administrator\Desktop\transport\DatasetsF-train\DatasetsF-train\train\voc')
    parser.add_argument('--save-dir', type=str, default=r'C:\Users\Administrator\Desktop\transport\DatasetsF-train\DatasetsF-train\train\yolo')
    ...
    if len(sys.argv) > 1:
        ...
        voc_dir = r'C:\Users\Administrator\Desktop\transport\DatasetsF-train\DatasetsF-train\train\voc'
        save_dir = r'C:\Users\Administrator\Desktop\transport\DatasetsF-train\DatasetsF-train\train\yolo'
