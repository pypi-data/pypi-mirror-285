...
register(options.PathOption('qemu.download.dir',
                            default=os.path.expanduser('~/.cache/byov/images'),
...
register(options.PathOption('qemu.uefi.vars.path',
                            default='{qemu.image}-OVMF_VARS.fd',
                            help_string='''\
...
'byovm setup' command).
'''))
# FIXME: Provide a lxd.idmap option as a file containing the `raw.idmap` lxc
# config key (as opposed to using the lxd.user_mounts.*.*id options)
# -- vila 2023-12-08
register(options.PathOption('lxd.idmap.path',
                            help_string='''\
The path describing the id map provided to lxd.
