...
class ProtectionJob(object):
    ...
    def from_dictionary(cls,
        ...
        task_timeouts = None
        if dictionary.get('taskTimeouts') != None:
            task_timeouts = list()
            for structure in dictionary.get('taskTimeouts'):
                task_timeouts.append(cohesity_management_sdk.models.cancellation_timeout_params.CancellationTimeout.from_dictionary(structure))
