...
class _BaseLogger:
    class Formatter(_logging.Formatter):
        ...
        @classmethod
        def Factory(cls, useUTCTime=True, includeTime=True, includeLevel=True, includeFile=True, includeProcessID=True, includeThreadID=False):
            '''Styling: "{Time} {Level} [PID={ProcessID},TID={ThreadID},FILE={moduleName}:{lineNo}]: <Message>"'''
            ...
            if(includeFile):
                subFmt.append('FILE=%(module)s:%(lineno)s')
            if(len(subFmt) > 0):
                subfmt = ','.join(subFmt)
                fmt.append(f'[{subfmt}]')
...
class RotatingFileLogger:
    ...
    def GetLogger(cls, 
                  ...
                  fmt_includeTime=True, fmt_includeLevel=True, fmt_includeFile=True, 
                  fmt_includeProcessID=True, fmt_includeThreadID=False):
        
        logger = _logging.getLogger(f"__ROTATINGFILELOGGER_{hash((filepath,minimumLogLevel,maxBytes,maxRotations,useUTCTime,fmt_includeTime,fmt_includeLevel,fmt_includeFile,fmt_includeProcessID,fmt_includeThreadID))}")
        ...
        logger.addHandler(cls.CreateHandler(
            ...
            fmt_includeTime=fmt_includeTime, fmt_includeLevel=fmt_includeLevel, fmt_includeFile=fmt_includeFile,
    ...
    @classmethod
    def CreateHandler(cls, filepath:str,
                  maxBytes=_ByteEnum.MegaByte.value * 100, maxRotations=10, 
                  useUTCTime=True, registerGlobalUnhandledExceptions=False,
                  fmt_includeTime=True, fmt_includeLevel=True, fmt_includeFile=True, 
                  fmt_includeProcessID=True, fmt_includeThreadID=False):
            ...
            handler.setFormatter(_BaseLogger.Formatter.Factory(
                ...
                includeFile=fmt_includeFile, includeProcessID=fmt_includeProcessID, 
...
class FileLogger:
    ...
    def GetLogger(cls, 
                  ...
                  fmt_includeTime=True, fmt_includeLevel=True, fmt_includeFile=True, 
                  fmt_includeProcessID=True, fmt_includeThreadID=False):
        logger = _logging.getLogger(f"__FILELOGGER_{hash((filepath,minimumLogLevel,useUTCTime,fmt_includeTime,fmt_includeLevel,fmt_includeFile,fmt_includeProcessID,fmt_includeThreadID))}")
        if(registerGlobalUnhandledExceptions):
            _BaseLogger.RegisterAsUnhandledExceptionHandler(logger)
        if(logger.hasHandlers()):
            return logger
    ...
    @classmethod
    def CreateHandler(cls, filepath:str, useUTCTime=False, fmt_includeTime=True, fmt_includeLevel=True, fmt_includeFile=False, fmt_includeProcessID=False, fmt_includeThreadID=False):
...
class StreamLogger:
    ...
    def GetLogger(cls, 
                  ...
                  fmt_includeTime=True, fmt_includeLevel=True, fmt_includeFile=False, 
                  fmt_includeProcessID=False, fmt_includeThreadID=False):
        stdoutLogger = _logging.getLogger(f"__STDOUTLOGGER__{hash((minimumLogLevel,useUTCTime,fmt_includeTime,fmt_includeLevel,fmt_includeFile,fmt_includeProcessID,fmt_includeThreadID,stream))}")
        if(registerGlobalUnhandledExceptions):
    ...
    @staticmethod
    def CreateHandler(stream=_sys.stdout, useUTCTime=False, fmt_includeTime=True, fmt_includeLevel=True, fmt_includeFile=False, fmt_includeProcessID=False, fmt_includeThreadID=False):
        """
        A handler that can be supplied into a logger
        >>> logger.addHandler(StreamLogger.CreateHandler())
        """
        handler = _logging.StreamHandler(stream)
        handler.setFormatter(_BaseLogger.Formatter.Factory(useUTCTime=useUTCTime, includeTime=fmt_includeTime, includeLevel=fmt_includeLevel, includeFile=fmt_includeFile, includeProcessID=fmt_includeProcessID, includeThreadID=fmt_includeThreadID))
        return handler
