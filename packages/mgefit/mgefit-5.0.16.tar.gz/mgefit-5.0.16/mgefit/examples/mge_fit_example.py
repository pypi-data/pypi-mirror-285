...
"""
    ...
    V1.4.0: Use new keyword `minlevel` in `mge_print_contours`.
...
def fit_m32():
    ...
    package_dir = Path(mgefit.__file__).parent  # path of mgefit
...
def fit_ngc4342():
    ...
    plt.subplot(122)
    mge_print_contours(img, f.theta, f.xmed, f.ymed, m.sol, scale=scale, 
