    ...
    def select_processing(
        ...
        if processing_step_link is not None:
            if not isinstance(processing_step_link, ProcessingStepLink):
                raise Exception('Instance passed to "processing_step_link" is not of type "ProcessingStepLink"')
            ...
            if not isinstance(function_name, str):
                raise Exception('Instance passed to "function_name" is not of type "str"')
