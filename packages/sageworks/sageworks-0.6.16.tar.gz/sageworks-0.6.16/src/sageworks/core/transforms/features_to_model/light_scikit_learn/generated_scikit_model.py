...
if __name__ == "__main__":
    ...
    model_metrics_s3_path = "s3://sandbox-sageworks-artifacts/models/training/abalone-knn-reg"
    train_all_data = "True"
    ...
    # Initialize our Sckit-Learn model
    model = model_class()
    ...
    if model_type == "classifier":
        ...
        probs = model.predict_proba(df_val[feature_list])
