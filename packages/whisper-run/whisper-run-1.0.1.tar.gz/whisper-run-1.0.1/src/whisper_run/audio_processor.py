...
class AudioProcessor:
    def __init__(self, file_path: str, device: str, hf_auth_token: str, model_name: str) -> None:
        ...
        self.pyannote_model_name = "path_to_your_onnx_model.onnx"  # Update this with the actual model path
    ...
    def process(self) -> Dict[str, List[Dict[str, float]]]:
        ...
        diarization_pipeline = DiarizationPipeline(self.pyannote_model_name, self.device)
