...
class ProjectMLAPI:
    ...
    def create_project(self, project_name):
        ...
        return requests.post(f"{self.service_uri}/project", json=body, headers={"Content-Type": "application/json", **self.authorization_token})
    ...
    def deploy_script(
        ...
        response = requests.post(
            f"{self.service_uri}/deploy", json=body, headers={"Content-Type": "application/json", **self.authorization_token}
        )
    ...
    def create_cluster(self, project_name: str, cluster_size: int):
        ...
        response = requests.post(
            f"{self.service_uri}/cluster", json=body, headers={"Content-Type": "application/json", **self.authorization_token}
        )
    ...
    def run_pipeline(self, project_name: str):
        body = {"project_name": project_name}
        response = requests.post(
            f"{self.service_uri}/cluster/run", json=body, headers={"Content-Type": "application/json", **self.authorization_token}
        )
    ...
    def remove_schedule(self, project_name: str):
        response = requests.delete(
            f"{self.service_uri}/cluster/schedule/{project_name}", headers=self.authorization_token
        )
    ...
    def create_schedule(self, project_name: str, schedule_interval: str):
        ...
        response = requests.post(
            f"{self.service_uri}/cluster/schedule", json=body, headers={"Content-Type": "application/json", **self.authorization_token}
        )
