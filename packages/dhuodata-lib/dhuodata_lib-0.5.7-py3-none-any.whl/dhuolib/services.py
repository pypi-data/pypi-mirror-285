...
class ProjectMLAPI:
    ...
    def deploy_script(
        ...
        response = requests.post(
            f"{self.service_uri}/deploy", json=body, headers=self.headers
        )
    ...
    def create_cluster(self, project_name: str, cluster_size: int):
        ...
        response = requests.post(
            f"{self.service_uri}/cluster", json=body, headers=self.headers
        )
    ...
    def remove_schedule(self, project_name: str):
        response = requests.delete(
            f"{self.service_uri}/cluster/schedule/{project_name}", headers=self.headers
        )
    ...
    def create_schedule(self, project_name: str, schedule_interval: str):
        ...
        response = requests.post(
            f"{self.service_uri}/cluster/schedule", json=body, headers=self.headers
        )
