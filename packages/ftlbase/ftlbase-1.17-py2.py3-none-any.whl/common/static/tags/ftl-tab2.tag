<!-- Somente uma ajuda para a thaís numa msg de pesquisa de informação - 2024-06-14 -->
<ftl-tabs>
  <div if={ !routes.length } id="pesquisa-satisfacao" style="display: flex; justify-content: center; align-items: center;"><div style="display: flex; flex-direction: column; width: 50%; justify-content: center; align-items: center;"><h2 style="text-align: center;">Dê sua opinião sobre os nossos serviços e colabore com a melhoria de nossos processos.</h2><h4 style="text-align: center;">Participe da nossa Pesquisa de Satisfação clicando abaixo</h4><a style="padding: 8px; background-color: #b20000; color: white; border-radius: 8px;" target="_blank" href="https://forms.office.com/pages/responsepage.aspx?id=M-o7KWnmzEan1B2gh9KBwFq8pgr8eKtEjKmeLg-R5vJUOTkxMjNZMjdPRFNBNk4yRTFKU0tJVU1XUi4u">Pesquisa de Satisfação</a></div></div>
