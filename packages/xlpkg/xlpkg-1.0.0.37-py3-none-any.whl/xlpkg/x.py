...
def f_conn(p_dbname):
    try:
        conn = pymysql.connect(host='127.0.0.1', port=3306, user='root', password='000000', database=p_dbname,
                               charset='utf8')
        return (conn)
    except Exception as e:
        logging.error(e)
...
def f_conn181(p_dbname):
    try:
        conn = pymysql.connect(host='192.168.2.181', port=3306, user='root', password='000000', database=p_dbname,
                               charset='utf8')
        return (conn)
    except Exception as e:
        logging.error(e)
...
def f_conn41_33062():
    try:
        conn = pymysql.connect(host='192.168.2.40', port=33062, user='root', password='123456', database='runfast',
                               charset='utf8')
        return (conn)
    except Exception as e:
        logging.error(e)
...
def f_conn41_33066():
    try:
        conn = pymysql.connect(host='192.168.2.40', port=33066, user='root', password='123456',
                               database='runfast_history', charset='utf8')
        return (conn)
    except Exception as e:
        loggig.error(e)
    pass
...
def f_conn41_33069():
    try:
        conn = pymysql.connect(host='192.168.2.40', port=33069, user='root', password='123456',
                               database='runfast_trade', charset='utf8')
        return (conn)
    except Exception as e:
        logging(e)
    pass
...
def f_conn51():
    try:
        conn = pymysql.connect(host='192.168.2.51', port=3306, user='root', password='wd2021@gxptkc51',
                               database='runfast', charset='utf8')
        return (conn)
    except Exception as e:
        logging.error(e)
    pass
...
def f_conn54():
    try:
        conn = pymysql.connect(host='192.168.2.54', port=3306, user='root', password='123456', database='runfast',
                               charset='utf8')
        return (conn)
    except Exception as e:
        logging.error(e)
