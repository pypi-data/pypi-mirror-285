...
class DSPConfigResponseAllOf(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DSPConfigResponseAllOf:
        """Create an instance of DSPConfigResponseAllOf from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DSPConfigResponseAllOf:
        """Create an instance of DSPConfigResponseAllOf from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return DSPConfigResponseAllOf.construct(**obj)

        _obj = DSPConfigResponseAllOf.construct(**{
