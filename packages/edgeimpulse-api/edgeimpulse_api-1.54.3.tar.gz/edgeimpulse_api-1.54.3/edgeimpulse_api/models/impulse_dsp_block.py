...
class ImpulseDspBlock(BaseModel):
    ...
    __properties = ["id", "type", "name", "axes", "title", "valuesPerAxis", "input", "primaryVersion", "baseBlockId", "tunerBaseBlockId", "tunerTemplateId", "tunerPrimary", "clonedFromBlockId", "mutated", "enabled", "db", "description", "createdBy", "createdAt", "implementationVersion", "organization", "customUrl", "namedAxes"]
