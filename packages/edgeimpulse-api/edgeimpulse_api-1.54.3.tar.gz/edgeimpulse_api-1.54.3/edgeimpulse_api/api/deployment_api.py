...
class DeploymentApi(object):
    ...
    @validate_arguments
    def find_syntiant_posterior(self, project_id : Annotated[StrictInt, Field(..., description="Project ID")], target_words : List[StrictStr], reference_set : StrictStr, wav_file : Optional[StrictStr] = None, meta_csv_file : Optional[StrictStr] = None, deployment_target : Optional[StrictStr] = None, **kwargs) -> StartJobResponse:  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self._find_syntiant_posterior_with_http_info(project_id, target_words, reference_set, wav_file, meta_csv_file, deployment_target, **kwargs)  # noqa: E501

    @validate_arguments
    def _find_syntiant_posterior_with_http_info(self, project_id : Annotated[StrictInt, Field(..., description="Project ID")], target_words : List[StrictStr], reference_set : StrictStr, wav_file : Optional[StrictStr] = None, meta_csv_file : Optional[StrictStr] = None, deployment_target : Optional[StrictStr] = None, **kwargs):  # noqa: E501
        """Find Syntiant posterior parameters 
    ...
    def get_deployment(self, project_id : Annotated[StrictInt, Field(..., description="Project ID")], type : Annotated[StrictStr, Field(..., description="The name of the built target. You can find this by listing all deployment targets through `listDeploymentTargetsForProject` (via `GET /v1/api/{projectId}/deployment/targets`) and see the `format` type.")], model_type : Annotated[Optional[KerasModelTypeEnum], Field(description="Optional model type of the build (if not, it uses the settings in the Keras block)")] = None, engine : Annotated[Optional[DeploymentTargetEngine], Field(description="Optional engine for the build (if not, it uses the default engine for the deployment target)")] = None, **kwargs) -> GetDeploymentResponse:  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self._get_deployment_with_http_info(project_id, type, model_type, engine, **kwargs)  # noqa: E501
    ...
    @validate_arguments
    def get_evaluate_job_result(self, project_id : Annotated[StrictInt, Field(..., description="Project ID")], **kwargs) -> EvaluateJobResponse:  # noqa: E501
        """Evaluate job result
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self._get_evaluate_job_result_with_http_info(project_id, **kwargs)  # noqa: E501

    @validate_arguments
    def _get_evaluate_job_result_with_http_info(self, project_id : Annotated[StrictInt, Field(..., description="Project ID")], **kwargs):  # noqa: E501
        """Evaluate job result 
    ...
    @validate_arguments
    def get_evaluate_job_result_cache(self, project_id : Annotated[StrictInt, Field(..., description="Project ID")], **kwargs) -> EvaluateJobResponse:  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self._get_evaluate_job_result_cache_with_http_info(project_id, **kwargs)  # noqa: E501

    @validate_arguments
    def _get_evaluate_job_result_cache_with_http_info(self, project_id : Annotated[StrictInt, Field(..., description="Project ID")], **kwargs):  # noqa: E501
        """Check evaluate job result (cache) 
    ...
    @validate_arguments
    def get_last_deployment_build(self, project_id : Annotated[StrictInt, Field(..., description="Project ID")], **kwargs) -> GetLastDeploymentBuildResponse:  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self._get_last_deployment_build_with_http_info(project_id, **kwargs)  # noqa: E501

    @validate_arguments
    def _get_last_deployment_build_with_http_info(self, project_id : Annotated[StrictInt, Field(..., description="Project ID")], **kwargs):  # noqa: E501
        """Get information on the last deployment build 
    ...
    @validate_arguments
    def get_syntiant_posterior(self, project_id : Annotated[StrictInt, Field(..., description="Project ID")], **kwargs) -> GetSyntiantPosteriorResponse:  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self._get_syntiant_posterior_with_http_info(project_id, **kwargs)  # noqa: E501

    @validate_arguments
    def _get_syntiant_posterior_with_http_info(self, project_id : Annotated[StrictInt, Field(..., description="Project ID")], **kwargs):  # noqa: E501
        """Get Syntiant posterior parameters 
    ...
    @validate_arguments
    def set_syntiant_posterior(self, project_id : Annotated[StrictInt, Field(..., description="Project ID")], set_syntiant_posterior_request : SetSyntiantPosteriorRequest, **kwargs) -> GenericApiResponse:  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self._set_syntiant_posterior_with_http_info(project_id, set_syntiant_posterior_request, **kwargs)  # noqa: E501

    @validate_arguments
    def _set_syntiant_posterior_with_http_info(self, project_id : Annotated[StrictInt, Field(..., description="Project ID")], set_syntiant_posterior_request : SetSyntiantPosteriorRequest, **kwargs):  # noqa: E501
        """Set Syntiant posterior parameters 
