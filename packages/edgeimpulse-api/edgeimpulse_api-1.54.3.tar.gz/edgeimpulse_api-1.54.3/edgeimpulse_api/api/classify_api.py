...
class ClassifyApi(object):
    ...
    def classify_sample_v2(self, project_id : Annotated[StrictInt, Field(..., description="Project ID")], sample_id : Annotated[StrictInt, Field(..., description="Sample ID")], include_debug_info : Annotated[Optional[StrictBool], Field(description="Whether to return the debug information from FOMO classification.")] = None, variant : Annotated[Optional[KerasModelVariantEnum], Field(description="Keras model variant")] = None, **kwargs) -> ClassifySampleV2200Response:  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self._classify_sample_v2_with_http_info(project_id, sample_id, include_debug_info, variant, **kwargs)  # noqa: E501
    ...
    def get_classify_job_result(self, project_id : Annotated[StrictInt, Field(..., description="Project ID")], feature_explorer_only : Annotated[Optional[StrictBool], Field(description="Whether to get only the classification results relevant to the feature explorer.")] = None, variant : Annotated[Optional[KerasModelVariantEnum], Field(description="Keras model variant")] = None, **kwargs) -> ClassifyJobResponse:  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self._get_classify_job_result_with_http_info(project_id, feature_explorer_only, variant, **kwargs)  # noqa: E501
    ...
    def get_classify_job_result_page(self, project_id : Annotated[StrictInt, Field(..., description="Project ID")], limit : Annotated[Optional[StrictInt], Field(description="Maximum number of results")] = None, offset : Annotated[Optional[StrictInt], Field(description="Offset in results, can be used in conjunction with LimitResultsParameter to implement paging.")] = None, variant : Annotated[Optional[KerasModelVariantEnum], Field(description="Keras model variant")] = None, **kwargs) -> ClassifyJobResponsePage:  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self._get_classify_job_result_page_with_http_info(project_id, limit, offset, variant, **kwargs)  # noqa: E501
    ...
    @validate_arguments
    def get_classify_metrics_all_variants(self, project_id : Annotated[StrictInt, Field(..., description="Project ID")], **kwargs) -> MetricsAllVariantsResponse:  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: MetricsAllVariantsResponse
        """
        kwargs['_return_http_data_only'] = True
        return self._get_classify_metrics_all_variants_with_http_info(project_id, **kwargs)  # noqa: E501

    @validate_arguments
    def _get_classify_metrics_all_variants_with_http_info(self, project_id : Annotated[StrictInt, Field(..., description="Project ID")], **kwargs):  # noqa: E501
        """Get metrics for all available model variants 
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(MetricsAllVariantsResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_classify_metrics_all_variants" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "MetricsAllVariantsResponse",
        }

        return self.api_client.call_api(
            '/api/{projectId}/classify/all/metrics', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def get_sample_window_from_cache(self, project_id : Annotated[StrictInt, Field(..., description="Project ID")], sample_id : Annotated[StrictInt, Field(..., description="Sample ID")], window_index : Annotated[StrictInt, Field(..., description="Sample window index")], **kwargs) -> GetSampleResponse:  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self._get_sample_window_from_cache_with_http_info(project_id, sample_id, window_index, **kwargs)  # noqa: E501

    @validate_arguments
    def _get_sample_window_from_cache_with_http_info(self, project_id : Annotated[StrictInt, Field(..., description="Project ID")], sample_id : Annotated[StrictInt, Field(..., description="Sample ID")], window_index : Annotated[StrictInt, Field(..., description="Sample window index")], **kwargs):  # noqa: E501
        """Get a window of raw sample features from cache, after a live classification job has completed. 
