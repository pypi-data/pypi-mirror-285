...
class PerformanceCalibrationApi(object):
    ...
    @validate_arguments
    def clear_performance_calibration_state(self, project_id : Annotated[StrictInt, Field(..., description="Project ID")], **kwargs) -> GenericApiResponse:  # noqa: E501
        ...
        return self._clear_performance_calibration_state_with_http_info(project_id, **kwargs)  # noqa: E501

    @validate_arguments
    def _clear_performance_calibration_state_with_http_info(self, project_id : Annotated[StrictInt, Field(..., description="Project ID")], **kwargs):  # noqa: E501
        """Clear Performance Calibration state 
    ...
    @validate_arguments
    def delete_performance_calibration_saved_parameters(self, project_id : Annotated[StrictInt, Field(..., description="Project ID")], **kwargs) -> GenericApiResponse:  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self._delete_performance_calibration_saved_parameters_with_http_info(project_id, **kwargs)  # noqa: E501

    @validate_arguments
    def _delete_performance_calibration_saved_parameters_with_http_info(self, project_id : Annotated[StrictInt, Field(..., description="Project ID")], **kwargs):  # noqa: E501
        """Clear performance calibration parameters 
    ...
    @validate_arguments
    def set_performance_calibration_saved_parameters(self, project_id : Annotated[StrictInt, Field(..., description="Project ID")], performance_calibration_save_parameter_set_request : PerformanceCalibrationSaveParameterSetRequest, **kwargs) -> GenericApiResponse:  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self._set_performance_calibration_saved_parameters_with_http_info(project_id, performance_calibration_save_parameter_set_request, **kwargs)  # noqa: E501

    @validate_arguments
    def _set_performance_calibration_saved_parameters_with_http_info(self, project_id : Annotated[StrictInt, Field(..., description="Project ID")], performance_calibration_save_parameter_set_request : PerformanceCalibrationSaveParameterSetRequest, **kwargs):  # noqa: E501
        """Save performance calibration parameters 
    ...
    @validate_arguments
    def upload_labeled_audio(self, project_id : Annotated[StrictInt, Field(..., description="Project ID")], zip : StrictStr, **kwargs) -> PerformanceCalibrationUploadLabeledAudioResponse:  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self._upload_labeled_audio_with_http_info(project_id, zip, **kwargs)  # noqa: E501

    @validate_arguments
    def _upload_labeled_audio_with_http_info(self, project_id : Annotated[StrictInt, Field(..., description="Project ID")], zip : StrictStr, **kwargs):  # noqa: E501
        """Upload Performance Calibration Audio files 
