...
class AnomalyModelMetadataAllOf(BaseModel):
    ...
    clusters: List[AnomalyModelMetadataAllOfClusters] = Field(..., description="Trained K-means clusters")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AnomalyModelMetadataAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AnomalyModelMetadataAllOf:
        """Create an instance of AnomalyModelMetadataAllOf from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return AnomalyModelMetadataAllOf.construct(**obj)

        _obj = AnomalyModelMetadataAllOf.construct(**{
            "created": obj.get("created"),
            "scale": obj.get("scale"),
            "mean": obj.get("mean"),
            "clusters": [AnomalyModelMetadataAllOfClusters.from_dict(_item) for _item in obj.get("clusters")] if obj.get("clusters") is not None else None,
            "axes": obj.get("axes"),
