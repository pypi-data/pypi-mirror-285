...
class WindowQuerySize:
    ...
    def __init__(self, timeout:Union[int,float]=30) -> None:
        """
            params:
    ...
    def mediaQuery(self, mediaMatchQ:str=None, on_change=None, key=None):
        """
        ...
        # while value["status"] == None:
        
        #     if type(value["status"]) == True:
        #         break
        #     time.sleep(0.25)
