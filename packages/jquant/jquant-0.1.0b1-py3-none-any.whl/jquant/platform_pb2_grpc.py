...
class StreamServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Subscribe = channel.stream_stream(
            "/ctp.api.v1.StreamService/Subscribe",
...
def add_StreamServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
        "ctp.api.v1.StreamService", rpc_method_handlers
    )
...
class ExchangeServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetTicker = channel.unary_unary(
            "/ctp.api.v1.ExchangeService/GetTicker",
        ...
        self.GetTickers = channel.unary_unary(
            "/ctp.api.v1.ExchangeService/GetTickers",
        ...
        self.GetOrderBook = channel.unary_unary(
            "/ctp.api.v1.ExchangeService/GetOrderBook",
        ...
        self.GetKline = channel.unary_unary(
            "/ctp.api.v1.ExchangeService/GetKline",
        ...
        self.Cancel = channel.unary_unary(
            "/ctp.api.v1.ExchangeService/Cancel",
        ...
        self.Buy = channel.unary_unary(
            "/ctp.api.v1.ExchangeService/Buy",
        ...
        self.Sell = channel.unary_unary(
            "/ctp.api.v1.ExchangeService/Sell",
        ...
        self.CloseBuy = channel.unary_unary(
            "/ctp.api.v1.ExchangeService/CloseBuy",
        ...
        self.CloseSell = channel.unary_unary(
            "/ctp.api.v1.ExchangeService/CloseSell",
        ...
        self.GetOrder = channel.unary_unary(
            "/ctp.api.v1.ExchangeService/GetOrder",
        ...
        self.GetOrders = channel.unary_unary(
            "/ctp.api.v1.ExchangeService/GetOrders",
        ...
        self.SetLeverage = channel.unary_unary(
            "/ctp.api.v1.ExchangeService/SetLeverage",
        ...
        self.GetPosition = channel.unary_unary(
            "/ctp.api.v1.ExchangeService/GetPosition",
...
def add_ExchangeServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
        "ctp.api.v1.ExchangeService", rpc_method_handlers
    )
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers(
        "ctp.api.v1.ExchangeService", rpc_method_handlers
