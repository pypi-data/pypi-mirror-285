...
class module(Namespace):
    file_handle: io.IOBase = None  # Value of None will set the output to stdout
...
def _log_level_to_int(level: str) -> int:
    ...
    return level_to_int.get(level, level_to_int.get("INFO"))
...
def init_structlog(
    log_level: str, log_file: Union[TextIO, str, None], progname: str
) -> None:
    """
