...
def apply_server_settings(
    ...
    logger.debug(
        ...
        config=server_features.common_config(),
        protect_enabled=server_features.protect_enabled,
        assess_enabled=server_features.assess_enabled,
        sampling=server_features.sampling,
    )
    ...
    if settings:
        settings.update_sampling(server_features)
