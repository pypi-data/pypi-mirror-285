...
if carbatpy.TREND["TREND_INSTALLED"]:
    trend_dll = carbatpy.TREND["TREND_DLL"]
...
_fl_properties_names = ("Temperature", "Pressure", "spec_Enthalpy",
                        ...
                        "spec_internal_Energy", "speed_of_sound", "viscosity", "thermal_conductivity",
                        "Prandtl_number", "k_viscosity",
...
class FluidState:
    ...
    def __init__(self, state):  # "T;P;H;V;S;QMASS;E;W;CP"
...
class FluidStateTV:
    """
    Temperature and specific volume of an incompressible  fluid is stored here
...
class FluidStateTransport(FluidState):
    """
    The thermodynamic state and transport properties of a fluid is stored here
    """

    def __init__(self, state):
        super().__init__(state)
        if state[5] > 0 and state_[5] < 1:
            two_phase = True
...
if __name__ == "__main__":
    ...
    quality = 0.25       # is interpreted by carbatpy as mol/mol to calculate state
