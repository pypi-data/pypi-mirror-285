...
def convert_number_to_decimal(
    ...
    try:
        ...
        numeric_conversion_error = f"Could not convert: {value}, make sure that numbers do not have more than 20 digits before and 8 digits after the decimal point"
        raise ValueError(numeric_conversion_error) from exp
