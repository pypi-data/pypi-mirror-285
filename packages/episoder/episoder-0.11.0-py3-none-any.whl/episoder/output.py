...
class ConsoleRenderer(FormattingRenderer):
    ...
    def __repr__(self):
        ...
        return f'ConsoleRenderer("{self._format}", "{self._dateformat}", <..>)'

    def _render_color(self, text, col):

        self._dest.write(f"{col}{text}{ConsoleRenderer.GREY}\n")

    def _render_no_color(self, string, _):

        self._dest.write(f"{string}\n")
