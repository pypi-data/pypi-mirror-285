...
class ConfirmWindow(QWidget):
    ...
    def layout_ModuleQC(self):
        ...
        self.add_info(
            Form_layout,
            "Operator name :",
            self.parent.result_dict["localDB"]["results"]["property"]["Operator_name"],
        )
        self.add_info(
            Form_layout,
        ...
        self.add_info(
            Form_layout,
            "Bond program :",
            self.parent.test_result_dict["results"]["summary"]["property"][
                "Bond_program_path"
            ],
        )
        self.add_info(
            Form_layout,
            "Bonding jig :",
            self.parent.result_dict["localDB"]["results"]["property"]["Bonding_jig"],
        )

        temp = (
            str(self.parent.result_dict["localDB"]["results"]["Temperature"])
            + " "
        ...
        self.add_info(Form_layout, "Temperature :", temp)
