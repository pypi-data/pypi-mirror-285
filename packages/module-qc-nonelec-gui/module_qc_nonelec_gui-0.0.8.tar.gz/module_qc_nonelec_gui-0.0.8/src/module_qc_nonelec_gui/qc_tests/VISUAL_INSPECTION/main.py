...
class TestWindow(QMainWindow):
    ...
    def make_result(self):
        ...
        self.parent.testRun["results"]["Metadata"][f"{self.mode}_defects"] = (
            self.anomaly_dic
        )
        self.parent.testRun["results"]["Metadata"][f"{self.mode}_comments"] = (
            self.comment_dic
        )
        self.parent.testRun["results"]["Metadata"][f"{self.mode}_image"] = oid_target
        self.parent.testRun["results"]["Metadata"][f"{self.mode}_defect_images"] = (
            self.img_dic
        )
