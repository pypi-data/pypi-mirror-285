...
from afeng_tools.weixin_min_program import weixin_mp_settings
from afeng_tools.weixin_min_program.core.weixin_mp_models import TokenResult, Jscode2sessionResult, CheckResult, \
    GenerateUrlLink
from afeng_tools.weixin_min_program.model.weixin_mp_enums import WeixinMpConfigKeyEnum


@auto_retry(max_retries=3)
def request_jscode2session(mp_app_id: str, js_code: str) -> Jscode2sessionResult:
    """
...
def request_token(mp_app_id: str) -> TokenResult:
    """
