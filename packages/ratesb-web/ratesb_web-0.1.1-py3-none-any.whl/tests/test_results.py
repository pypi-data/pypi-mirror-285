...
class TestResults(unittest.TestCase):
    ...
    def test_add_message(self):
        ...
        self.assertEqual(self.results._results, {"reaction_name": [{"code": 1, "message": "message", "is_warning": True}]})
        self.results.add_message("reaction_name", 2, "message", is_warning=False)
        self.assertEqual(self.results.count_errors(), 1)
        self.assertEqual(self.results.count_warnings(), 1)
        self.assertEqual(self.results._results, {"reaction_name": [{"code": 1, "message": "message", "is_warning": True}, {"code": 2, "message": "message", "is_warning": False}]})
    ...
    def test_get_warnings(self):
        self.results.add_message("reaction_name", 1, "message")
        self.results.add_message("reaction_name", 2, "message", is_warning=False)
        self.assertEqual(self.results.get_all_warnings(), {"reaction_name": [{"code": 1, "message": "message", "is_warning": True}]})
    
    def test_get_errors(self):
        self.results.add_message("reaction_name", 1, "message")
        self.results.add_message("reaction_name", 2, "message", is_warning=False)
        self.assertEqual(self.results.get_all_errors(), {"reaction_name": [{"code": 2, "message": "message", "is_warning": False}]})
