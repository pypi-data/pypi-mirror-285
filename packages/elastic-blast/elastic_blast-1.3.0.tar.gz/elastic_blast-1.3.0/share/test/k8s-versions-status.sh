#!/bin/bash
# share/test/k8s-versions-status.sh: Test various versions of kubectl client
# and server with ElasticBLAST for GCP
#
# Author: Christiam Camacho (camacho@ncbi.nlm.nih.gov)
# Created: Thu 27 Apr 2023 12:45:08 PM EDT
...
EOF
    ...
    ls -l `which kubectl`
    time elastic-blast status --cfg $CFG --logfile elastic-blast-k8s-client-${suffix}.log
