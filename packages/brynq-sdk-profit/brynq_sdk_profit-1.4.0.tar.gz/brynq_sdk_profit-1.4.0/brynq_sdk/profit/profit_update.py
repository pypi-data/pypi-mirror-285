...
class UpdateConnector(BrynQ):
    ...
    def update_creditor(self, method: str, data: dict, overload_fields: dict = None) -> requests.Response:
        ...
        :return: status code for request and optional error message
        """
        allowed_fields_base = ['creditor_id', 'collective_account', 'preferred_delivery_method', 'automatic_payment', 'compact', 'payment_specification', 'remark', 'preferred_provisioning',
        ...
        allowed_fields_person = ['person_id', 'internal_id', 'match_person_on', 'log_birthname_seperately', 'gender', 'salutation', 'correspondence', 'email', 'mobile_phone',
                                 'give_access_to_portal', 'email_portal', 'auto_number', 'postal_address_applied', 'first_name', 'middle_name', 'last_name']
        ...
        fields_to_update.update({"AddToPortal": data['give_access_to_portal']}) if 'give_access_to_portal' in data else fields_to_update
        fields_to_update.update({"EmailPortal": data['email_portal']}) if 'email_portal' in data else fields_to_update
        fields_to_update.update(overload_fields) if overload_fields is not None else ''
        ...
        base_body['KnPurchaseRelationPer']['Element']['Objects']['KnPerson']['Element']['Objects'][0]['KnBasicAddressAdr']['Element']['Fields'].update(fields_to_update)
        ...
        base_body['KnPurchaseRelationPer']['Element']['Objects']['KnPerson']['Element']['Objects'][0]['KnBankAccount']['Element']['Fields'].update(fields_to_update)
