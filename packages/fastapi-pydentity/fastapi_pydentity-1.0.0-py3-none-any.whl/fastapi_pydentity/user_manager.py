...
from fastapi_pydentity.abc.stores import (
    IUserStore,
...
from fastapi_pydentity.exc import (
...
from fastapi_pydentity.resources import Resources
from fastapi_pydentity.security.claims import ClaimsPrincipal, Claim, ClaimTypes
from fastapi_pydentity.types import TUser
from fastapi_pydentity.user_login_info import UserLoginInfo
...
class UserManager(Generic[TUser]):
    ...
    def __init__(
        ...
        from fastapi_pydentity import PasswordValidator, UserValidator, UpperLookupNormalizer
