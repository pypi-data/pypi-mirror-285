...
from fastapi_pydentity.lookup_normalizer import ILookupNormalizer
from fastapi_pydentity.role_validator import IRoleValidator
from fastapi_pydentity.abc.stores import IRoleStore
...
class RoleManager(Generic[TRole]):
    ...
    def __init__(
        ...
        from fastapi_pydentity import RoleValidator, UpperLookupNormalizer
