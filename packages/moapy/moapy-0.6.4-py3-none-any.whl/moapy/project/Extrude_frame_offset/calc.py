...
@dataclass
class ExtrudeFrameOffset:
    """
    Extrude Frame Offset Input Class
    """
    local_axis: str = dataclass_field(default="+y", metadata={"description": "local axis"})
    extrude_length: str = dataclass_field(default="4@1", metadata={"description": "extrude length"})
    matl_id: int = dataclass_field(default=1, metadata={"description": "matl_id"})
    sect_id: int = dataclass_field(default=1, metadata={"description": "sect_id"})
...
# Test
return_message = extrude_frame_offset(ExtrudeFrameOffset())
