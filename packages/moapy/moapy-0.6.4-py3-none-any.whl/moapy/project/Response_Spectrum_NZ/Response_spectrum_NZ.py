...
@dataclass
class RS_NZ_input:
    func_name: str = dataclass_field(default="RS_NZ", metadata={"description": "Input Function Name"})
    soilClass: str = dataclass_field(default="A", metadata={"description": "Site sub soil class name"})
    rf: float = dataclass_field(default=1.0, metadata={"description": "return period factor"})
    hf: float = dataclass_field(default=1.0, metadata={"description": "hazard factor"})
    dist: float = dataclass_field(default=0.0, metadata={"description": "distance from nearest major fault"})
    df: float = dataclass_field(default=1.0, metadata={"description": "ductility factor"})
    max_period: float = dataclass_field(default=1.0, metadata={"description": "max_period(sec)"})
