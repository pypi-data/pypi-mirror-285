...
@dataclass
class CreateGroupPile:
    """
    Create Group Pile Input Class
    """
    pile_matl_ID: int = dataclass_field(default=3, metadata={"description": "pile material ID"})
    pile_sect_ID: int = dataclass_field(default=6, metadata={"description": "pile section ID"})
    cap_matl_ID: int = dataclass_field(default=3, metadata={"description": "cap material ID"})
    cap_sect_ID: int = dataclass_field(default=5, metadata={"description": "cap section ID"})
    pile_start_nb: int = dataclass_field(default=1000, metadata={"description": "pile start node number"})
    cap_start_nb: int = dataclass_field(default=100, metadata={"description": "cap start node number"})
    pile_array_long: int = dataclass_field(default=2, metadata={"description": "pile array long"})
    pile_array_tran: int = dataclass_field(default=3, metadata={"description": "pile array tran"})
    pile_spacing_long: float = dataclass_field(default=2.5, metadata={"description": "pile spacing long"})
    pile_spacing_tran: float = dataclass_field(default=2.5, metadata={"description": "pile spacing tran"})
    cap_edge_spacing_long: float = dataclass_field(default=1.25, metadata={"description": "cap edge spacing long"})
    cap_edge_spacing_tran: float = dataclass_field(default=1.25, metadata={"description": "cap edge spacing tran"})
    spacing_style_int: int = dataclass_field(default=1, metadata={"description": "spacing style int"})
    pile_dia: float = dataclass_field(default=1.2, metadata={"description": "pile diameter"})
    pile_length: float = dataclass_field(default=15.5, metadata={"description": "pile length"})
    cap_height: float = dataclass_field(default=2, metadata={"description": "cap height"})
    cap_modeling: str = dataclass_field(default="true", metadata={"description": "cap modeling"})
    grup_ID: int = dataclass_field(default=5, metadata={"description": "group ID"})
    bngr_ID: int = dataclass_field(default=2, metadata={"description": "boundary group ID"})
