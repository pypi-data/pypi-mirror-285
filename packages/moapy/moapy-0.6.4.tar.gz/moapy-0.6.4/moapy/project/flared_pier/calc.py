...
class CreatePier:
    ...
    """
    column_sect_ID: int = dataclass_field(default=2, metadata={"description": "column section ID"})
    cap_bot_sect_ID: int = dataclass_field(default=4, metadata={"description": "cap bottom section ID"})
    cap_top_sect_ID: int = dataclass_field(default=3, metadata={"description": "cap top section ID"})
    column_matl_ID: int = dataclass_field(default=2, metadata={"description": "column material ID"})
    cap_bot_matl_ID: int = dataclass_field(default=2, metadata={"description": "cap bottom material ID"})
    cap_top_matl_ID: int = dataclass_field(default=2, metadata={"description": "cap top material ID"})
    start_node_nb: int = dataclass_field(default=10000, metadata={"description": "start node number"})
    column_len: float = dataclass_field(default=12, metadata={"description": "column length"})
    cap_bot_len: float = dataclass_field(default=1.2, metadata={"description": "cap bottom length"})
    cap_top_len: float = dataclass_field(default=0.5, metadata={"description": "cap top length"})
    grup_ID: int = dataclass_field(default=4, metadata={"description": "group ID"})
    bngr_ID: int = dataclass_field(default=1, metadata={"description": "boundary group ID"})
