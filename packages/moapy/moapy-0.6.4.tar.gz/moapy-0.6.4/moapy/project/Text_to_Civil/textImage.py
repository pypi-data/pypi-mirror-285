...
@dataclass
class TextToPlateMeshInput:
	"""
	The input data for the text to plate mesh conversion.
	"""
	text: str = dataclass_field(default="Example", metadata={"description": "The text to convert"})
	insert: str = dataclass_field(default="0,0,0", metadata={"description": "The insert point of the text (lower left corner)"})
	height: str = dataclass_field(default="1", metadata={"description": "The height of the text"})
	color: PrintColor = dataclass_field(default_factory=PrintColor, metadata={"description": "The color of the text RGB, [0~255, 0~255, 0~255]"})
