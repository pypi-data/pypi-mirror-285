...
class Checker:
    ...
    def get_availability(self) -> pd.DataFrame:
        ...
        for column in self.columns_to_check:
            ...
            try:
                complete_calculation.append(checker_plugins[column]())
            ...
            print(f"Time to calculate the availability for {column}: {round(end_calculation_time - start_calculation_time, 2)}s")
        ...
        availability.to_csv("full_data.csv", index=False)
        return availability
