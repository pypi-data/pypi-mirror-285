"""
After giving a `FPT_` command to [transport.globalTransport()](https://il-group.github.io/FL-Studio-API-Stubs/midi_controller_scripting/transport/position#transport.__position.globalTransport),
