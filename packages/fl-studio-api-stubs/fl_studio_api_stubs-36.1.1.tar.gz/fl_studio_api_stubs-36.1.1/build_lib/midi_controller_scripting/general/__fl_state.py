...
def getVersion() -> int:
    ...
    To get the version of FL Studio, use [ui.getVersion()](https://il-group.github.io/FL-Studio-API-Stubs/midi_controller_scripting/ui/fl_state#ui.__fl_state.getVersion) instead.
