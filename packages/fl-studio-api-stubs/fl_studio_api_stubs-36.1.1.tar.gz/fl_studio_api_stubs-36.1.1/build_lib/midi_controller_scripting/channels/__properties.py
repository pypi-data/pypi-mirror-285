...
def getChannelVolume(
    ...
    for channels is defined in [midi.ChannelDefaultVolume](https://il-group.github.io/FL-Studio-API-Stubs/midi_controller_scripting/midi#midi.ChannelDefaultVolume).
