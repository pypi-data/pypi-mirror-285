...
def snapMode(value: int) -> int:
    ...
    a snapping mode. To select a value directly, use [ui.setSnapMode()](https://il-group.github.io/FL-Studio-API-Stubs/midi_controller_scripting/ui/fl_state#ui.__fl_state.setSnapMode).
...
def setSnapMode(value: int) -> None:
    ...
    modes. To increment or decrement the value, use [ui.snapMode()](https://il-group.github.io/FL-Studio-API-Stubs/midi_controller_scripting/ui/fl_state#ui.__fl_state.snapMode).
...
def showNotification(notificationId: int):
    ...
    [ui.setHintMsg()](https://il-group.github.io/FL-Studio-API-Stubs/midi_controller_scripting/ui/fl_state#ui.__fl_state.setHintMsg), except with less customization. Currently
