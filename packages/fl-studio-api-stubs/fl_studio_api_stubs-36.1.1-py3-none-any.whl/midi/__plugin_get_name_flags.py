"""
These values are provided to [plugins.getName()](https://il-group.github.io/FL-Studio-API-Stubs/midi_controller_scripting/plugins/plugins#plugins.__plugins.getName) to control the
