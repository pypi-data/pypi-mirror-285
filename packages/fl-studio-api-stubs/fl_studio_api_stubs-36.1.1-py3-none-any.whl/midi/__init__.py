...
* [`globalTransport` commands](https://il-group.github.io/FL-Studio-API-Stubs/midi_controller_scripting/midi/gt commands):
  command flags passed to [transport.globalTransport()](https://il-group.github.io/FL-Studio-API-Stubs/midi_controller_scripting/transport/position#transport.__position.globalTransport).

* [`globalTransport` flags](https://il-group.github.io/FL-Studio-API-Stubs/midi_controller_scripting/midi/gt flags):
  response flags returned by [transport.globalTransport()](https://il-group.github.io/FL-Studio-API-Stubs/midi_controller_scripting/transport/position#transport.__position.globalTransport).
