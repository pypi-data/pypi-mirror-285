"""
Song time flags are used by functions such as [transport.getSongPos()](https://il-group.github.io/FL-Studio-API-Stubs/midi_controller_scripting/transport/state#transport.__state.getSongPos)
