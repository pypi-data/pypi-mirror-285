...
def main():
    ...
    parser.add_argument("-c", "--call", help="To invoke calling feature otherwise it will read log file", action="store_true")
    clid_args = parser.parse_args()

    call = Call(clid_args.dialer)
