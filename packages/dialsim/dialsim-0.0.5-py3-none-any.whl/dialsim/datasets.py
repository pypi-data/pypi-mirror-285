...
def load_data(root, script_name:str="friends")->tuple:
    ...
    if not os.path.exists(f"{root}/data"):
        os.system('wget "https://www.dropbox.com/scl/fi/ifrk3ky2hhhzeiudth8iu/dialsim_v1.1.zip?rlkey=702lyvg7ew15btb3bn8qulu28&st=b6f2tcjj&dl=1" -O dialsim_v1.1.zip')
        ...
        os.system(f"mv {root}/*.txt {root}/prompt")
