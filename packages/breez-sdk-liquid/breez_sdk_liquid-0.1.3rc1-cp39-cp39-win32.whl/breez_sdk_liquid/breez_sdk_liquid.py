...
class Payment:
    ...
    @typing.no_type_check
    def __init__(self, *, timestamp: "int", amount_sat: "int", fees_sat: "int", payment_type: "PaymentType", status: "PaymentState", tx_id: "typing.Optional[str]" = _DEFAULT, swap_id: "typing.Optional[str]" = _DEFAULT, preimage: "typing.Optional[str]" = _DEFAULT, bolt11: "typing.Optional[str]" = _DEFAULT, refund_tx_id: "typing.Optional[str]" = _DEFAULT, refund_tx_amount_sat: "typing.Optional[int]" = _DEFAULT):
        self.timestamp = timestamp
        self.amount_sat = amount_sat
    ...
    def __str__(self):
        return "Payment(timestamp={}, amount_sat={}, fees_sat={}, payment_type={}, status={}, tx_id={}, swap_id={}, preimage={}, bolt11={}, refund_tx_id={}, refund_tx_amount_sat={})".format(self.timestamp, self.amount_sat, self.fees_sat, self.payment_type, self.status, self.tx_id, self.swap_id, self.preimage, self.bolt11, self.refund_tx_id, self.refund_tx_amount_sat)
...
class PreparePayOnchainRequest:
    ...
    @typing.no_type_check
    def __init__(self, *, receiver_amount_sat: "int", sat_per_vbyte: "typing.Optional[int]"):
