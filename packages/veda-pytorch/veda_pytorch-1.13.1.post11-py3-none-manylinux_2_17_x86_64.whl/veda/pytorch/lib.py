...
if not "1.13.1" in torch.__version__:
	raise Exception(f"The NEC SX-Aurora TSUBASA can only be used with PyTorch v1.13.1 but you are using {torch.__version__}")
