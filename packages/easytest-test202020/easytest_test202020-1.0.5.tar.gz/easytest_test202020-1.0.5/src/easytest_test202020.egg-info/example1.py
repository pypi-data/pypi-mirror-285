...
# 填充文本类型的列
df['employment_type'].fillna('Employment not available',
                             inplace=True)  # 填充 'employment_type' 列的空值为 'Employment not available'
df['required_experience'].fillna('Experience not available',
                                 inplace=True)  # 填充 'required_experience' 列的空值为 'Experience not available'
...
# 划分训练集和测试集
X = filtered_df[
    ['description', 'required_experience', 'employment_type', 'telecommuting', 'has_company_logo', 'has_questions'
        , 'benefits', 'requirements', 'company_profile', 'title', 'location', 'department', 'salary_range',
     'required_education'
        , 'industry', 'function']]
...
# 填充文本类型的列
df_results['employment_type'].fillna('Employment not available',
                                     inplace=True)  # 填充 'employment_type' 列的空值为 'Employment not available'
df_results['required_experience'].fillna('Experience not available',
                                         inplace=True)  # 填充 'required_experience' 列的空值为 'Experience not available'
...
# 获取模型训练时的特征列名
expected_columns = ['description', 'required_experience', 'employment_type', 'telecommuting', 'has_company_logo',
                    'has_questions'
    , 'benefits', 'requirements', 'company_profile', 'title', 'location', 'department', 'salary_range',
                    'required_education'
    , 'industry', 'function']
