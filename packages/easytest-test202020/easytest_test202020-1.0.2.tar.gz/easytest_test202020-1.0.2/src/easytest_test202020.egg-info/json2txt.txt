...
if __name__ == "__main__":
    jsonfilePath = r"C:/Users/Administrator/Desktop/mengxiangji/新建文件夹/json"  # 要转换的json文件所在目录
    resultDirPath = r"C:/Users/Administrator/Desktop/mengxiangji/新建文件夹/json3"  # 要生成的txt文件夹
    labelme2yolov2Seg(jsonfilePath=jsonfilePath, resultDirPath=resultDirPath,
                      classList=['kouzhao'])  # 更改为自己的类别名