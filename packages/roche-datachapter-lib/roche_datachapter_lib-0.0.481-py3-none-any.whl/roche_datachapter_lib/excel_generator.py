...
class ExcelFile:
    ...
    def __init__(self, destination_path: str = None):
        if destination_path is None:
            file_name = f'AutoGeneratedExcelFile_{datetime.now().strftime("%d-%m-%Y_%H-%M-%S")}.xlsx'
    ...
    def save(self):
        ...
        try:
            if not self.destination_path.endswith('.xlsx') and not self.destination_path.endswith('.xls'):
                self.destination_path += '.xlsx'
