...
def concatenate_videos(input_file_path1, input_file_path2, output_file_path):
    ...
    try:
        subprocess.run(['ffmpeg', '-f', 'concat', '-safe', '0', '-i', temp_file_path, '-c', 'copy', output_file_path], check=True)
