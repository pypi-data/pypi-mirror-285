...
class VideoClip:
    ...
    def __init__(self, videoClipID = 0, fileID = 0, tSFileID = 0, videoClipParameters = '', localFilePath = '', height = 0, width = 0, framesPerSecond: float = 0, bitrate = 0, audioStatus = 0, startTime = 0, startTimeMs = 0, endTime = 0, endTimeMs = 0, clipLengthInSeconds: float = 0):
