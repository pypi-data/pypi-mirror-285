...
setup(
    name="vpdbz",  # 包名为"vpdb"
    version="1.1.0",  # 包的版本号为1.1.0
    author="Devin zhang",  # 作者名为Devin Zhang
    author_email="devinzhang1994@gmail.com",  # 作者的电子邮件地址
    # url="Reference：https://github.com/silverbulletmdc/vpdb",  # 包的主页，这里用了"Reference："前缀，可能有误，通常直接写URL
    ...
    long_description="项目参考：https://github.com/silverbulletmdc/vpdb",  # 包的长描述，这行被注释掉了
