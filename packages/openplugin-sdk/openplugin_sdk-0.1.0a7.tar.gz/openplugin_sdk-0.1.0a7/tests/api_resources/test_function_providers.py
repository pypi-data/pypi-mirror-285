...
class TestFunctionProviders:
    ...
    def test_method_list(self, client: Openplugin) -> None:
        function_provider = client.function_providers.list()
        assert_matches_type(FunctionProviderListResponse, function_provider, path=["response"])
    ...
    def test_raw_response_list(self, client: Openplugin) -> None:
        response = client.function_providers.with_raw_response.list()
    ...
    def test_streaming_response_list(self, client: Openplugin) -> None:
        with client.function_providers.with_streaming_response.list() as response:
...
class TestAsyncFunctionProviders:
    ...
    async def test_method_list(self, async_client: AsyncOpenplugin) -> None:
        function_provider = await async_client.function_providers.list()
        assert_matches_type(FunctionProviderListResponse, function_provider, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncOpenplugin) -> None:
        response = await async_client.function_providers.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncOpenplugin) -> None:
        async with async_client.function_providers.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
