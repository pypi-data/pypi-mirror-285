...
class Recipient:
    ...
    def get_user_external(self, system_id: int) -> dict:
        ...
        if custom_condition == f"system_id = {system_id}":
            return {}
        usernames = user_external_generic_crud.select_multi_value_by_where(schema_name="user_external",
                                                                           view_table_name="user_external_general_view",
                                                                           select_clause_value="username",
                                                                           where=custom_condition)
        ids = user_external_generic_crud.select_multi_value_by_where(schema_name="user_external",
                                                                     view_table_name="user_external_general_view",
                                                                     select_clause_value="user_external_id",
                                                                     where=custom_condition)

        return {"usernames": list(usernames), "ids": list(ids)}
